...
Partial Class WalletActivationReport
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        End Try
    End Sub
    Private Sub FillFranchisee()
        Try
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_FillFranchisee")
            DDlFranchisee.DataSource = Ds.Tables(0)
            DDlFranchisee.DataValueField = "PartyCode"
            DDlFranchisee.DataTextField = "PartyName"
    ...
    Public Sub BindData(ByVal PageIndex As Integer)
        Try
            ...
            Dim endDate As Date
            If CmbKit.SelectedItem.Text = "By Franchisee" Then
                userid = DDlFranchisee.SelectedItem.Text
            Else
                If txtMemberId.Text <> "" Then
                    userid = txtMemberId.Text.Trim
                Else
                    userid = "0"
            ...
            prms(0) = New SqlParameter("@Idno", Convert.ToString(userid).ToLower())
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "Sp_IdActivationWalletReport", prms)
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Try
            ...
            prms(7) = New SqlParameter("@Type", Convert.ToString(CmbKit.SelectedValue))
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "Sp_IdActivationWalletReport", prms)
            ' Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetIssuedEpinValueDetail", prms)
    ...
    Private Sub ExportExcel()
        ...
        Using wb As New XLWorkbook()
            wb.Worksheets.Add(dt, "WalletActivationReport")
            Response.Clear()
            Response.Buffer = True
            Response.Charset = ""
            Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
            Response.AddHeader("content-disposition", "attachment;filename=WalletActivationReport.xlsx")
    ...
    Protected Sub CmbKit_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CmbKit.SelectedIndexChanged
        If CmbKit.SelectedValue = "By Franchisee" Then
