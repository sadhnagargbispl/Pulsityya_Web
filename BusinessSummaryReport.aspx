<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="BusinessSummaryReport.aspx.vb" Inherits="App_UI_Application_Pages_BusinessSummaryReport"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="background-color: White ">
        <table width="100%" cellspacing="10px" align="left" style="margin: 20px; padding: 0px;">
                ...
                <tr>
                <td style ="width :100px"> Date Wise:</td>
    ...
    <div style=" margin-top: 20px; margin-bottom: 20px; overflow:scroll ">
