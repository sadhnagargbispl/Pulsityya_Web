<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Addpin.aspx.vb" Inherits="App_UI_Application_Pages_Addpin" %>
...
<body>
  ...
  <div class="col-md-12" style="padding:1%"><div class="col-md-2">
     Remarks :&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp </div>
      <div class="col-md-2">  
    <asp:TextBox ID="txtRemarks" class="form-control"  runat="server"></asp:TextBox></div><div class="col-md-8"> </div></div>
    <div class="col-md-12" style="padding:10px"><div class="col-md-4">
  Status : </div>
  <div class="col-md-6"> 
   ...
   <div class="col-md-12" style="padding-left:32%"><div class="col-md-4">
