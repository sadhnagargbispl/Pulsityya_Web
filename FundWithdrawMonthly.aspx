<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="FundWithdrawMonthly.aspx.vb" Inherits="App_UI_Application_Pages_FundWithdrawMonthly" %>
                    ...
                    <div class="panel-body">
                        ...
                        <div style="background-color: White">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-2">
                                    <asp:CheckBox ID="CheckBox2" runat="server" Text="Date Wise :" Font-Bold="true" Checked="true" />
                            ...
                            <div class="col-md-12" style="padding: 10px">
                                ...
                                <div class="col-md-2">
                                    <asp:Button ID="BtnApproveAll" runat="server" Text="ApproveAll" class="btn btn-primary" /></div>
                                <div class="col-md-2">
                                    <asp:Button ID="btnRejectAll" runat="server" Text="RejectAll" class="btn btn-primary" /></div>
                                <div class="col-md-2">
