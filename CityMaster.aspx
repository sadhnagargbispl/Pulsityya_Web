<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false" CodeFile="CityMaster.aspx.vb" Inherits="CityMaster" title="Untitled Page" %>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6" style="display:flex; padding :1%">
                                    <asp:DropDownList ID="ddlSearchFields" runat="server" class="form-control" Style="width: 28%; padding:0px; border-radius:5px;  display: inline">
                                        ...
                                        <asp:ListItem Value="StateName">City Name</asp:ListItem>
                            ...
                            <div class="col-md-12">
                                ...
                                <a href="AddCityNew.aspx" onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 350,marginTop : 0 } )">
                                 <asp:Button ID="BtnAddNew" runat="server" class="btn btn-primary" Text="Add City" /></a>
               ...
               OnSorting="GvData_Sorting" PageSize="10" EmptyDataText="No data to display.">
                                    <Columns>
                                        <asp:TemplateField HeaderText="CityCode" Visible="false" SortExpression="CityCode">
                                            <ItemTemplate>
                                                <asp:Label ID="LblGrpID" runat="server" Text='<%# Eval("CityCode") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                       ...
                                       <asp:label Id="LblStatus" runat="server" Text='<%# Eval("Status") %>' class='<%# Eval("StatusClass") %>'></asp:label>
                                        ...
                                        <asp:TemplateField HeaderText="Modify" HeaderStyle-Width="85px" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                              <a href='<%# "AddCityNew.aspx?CityCode=" & Crypto.Encrypt(Eval("CityCode"))  %>'
