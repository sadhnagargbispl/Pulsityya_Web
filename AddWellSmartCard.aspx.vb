...
Partial Class AddWellSmartCard
    ...
    Private Sub BindData()
        Dim sql As String = "select * from trnwellsmartcoupon where Voucherno='" & KitIdQS & "' AND Isused='N'"
        Dt = New DataTable
        Dt = objDAL.GetData(sql)
        Dim Dat1 As String
        If Dt.Rows.Count > 0 Then
    ...
    Protected Sub BtnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        Sql = "Update trnwellsmartcoupon set Isused='Y',UsedDate='" & TxtDate.Text & "' where Voucherno='" & Request("CouponNo") & "'"
