<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="Patientdetails.aspx.vb" Inherits="App_UI_Application_Pages_Patientdetails" %>
                                    ...
                                    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="IDNo" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="LblGrpID" runat="server" Text='<%# Eval("Id") %>' Visible="false"></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="Patient Detail" ItemStyle-HorizontalAlign="left">
                                                <ItemTemplate>
                                                    <a href='<%# "viewPatient.aspx?VId=" & Eval("Id") %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width:1050,height:380, } )">
                                                        <asp:Label ID="LblViewcourse" runat="server" Text="View" Style="color: Blue; text-align: left;" />
                                                    </a>
                                                    <br />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="PDF">
                                                <ItemTemplate>
                                                    <a href='<%# Eval("MedicalPDF") %>' target="_blank">
                                                        <asp:Label ID="LblViewPDF" runat="server" Text="View PDF" Style="color: Blue; text-align: left;" />
                                                    </a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
