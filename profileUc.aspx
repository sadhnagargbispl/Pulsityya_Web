<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="profileUc.aspx.vb" Inherits="profileUc" %>
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div id="divDetailSection" runat="server" style="margin-bottom: 30px; margin-right: 20px;">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:TextBox ID="TxtPackage" CssClass="form-control"
                                                        runat="server" ForeColor="black" Font-Bold="true" Font-Size="12px" ReadOnly="true" ></asp:TextBox>
                                                ...
                                                <div class="col-md-4">
                                                    <asp:TextBox ID="TxtStatus" runat="server"  CssClass="form-control"
                                                        ForeColor="black" Font-Bold="true" Font-Size="12px" ReadOnly="true" ></asp:TextBox></div>
                                            </div>
                                            
                                            <div class="col-md-12" id="divdetail" runat="server" visible ="false">
                                                <div class="col-md-3">
                                                </div>
                                                <div class="col-md-6">
                                                    <h5 style="color: Black">
                                                        <strong>Presenter Detail </strong>
                                                    </h5>
                                                </div>
                                                <div class="col-md-3">
                                                </div>
                                            </div>
                                            <div class="col-md-12" id="divpresenter" runat="server" visible ="false" >
                                                <br />
                                                <div class="col-md-2">
                                                    Presenter Id :<span class="red">*</span>
                                                </div>
                                                <div class="col-md-4">
                                                    <asp:TextBox ID="txtpresenterid" CssClass="form-control"
                                                        runat="server" ForeColor="black" Font-Bold="true" Font-Size="12px" ReadOnly="true" ></asp:TextBox>
                                                ...
                                                <div class="col-md-4">
                                                    <asp:TextBox ID="txtpresentername" runat="server"  CssClass="form-control"
                                                        ForeColor="black" Font-Bold="true" Font-Size="12px" ReadOnly="true" ></asp:TextBox></div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <br />
                                                <div class="col-md-2">
                                                    Member First Name :<span class="red">*</span>
                                                </div>
                                                ...
                                                <div class="col-md-2" style="  display : none ">
                                                    Member Last Name :<span class="red">*</span>
                                                </div>
                                               
                                                <div class="col-md-4"  style="  display : none ">
                                                    <asp:TextBox ID="txtmemlastname" CssClass="form-control validate[required,custom[onlyLetterNumberChar]]"
                                                        runat="server" ForeColor="black" Font-Bold="true" Font-Size="12px" TabIndex="8"></asp:TextBox>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:TextBox ID="txtPinCode" CssClass="form-control validate[custom[pincode]]" TabIndex="15"
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-4">
                                                      <%--  <asp:TextBox ID="TxtIdProofNo" CssClass="form-control validate[custom[onlyLetterNumberChar]]"
                                                            TabIndex="22" runat="server" MaxLength="16"></asp:TextBox>--%>
                                                              <asp:TextBox ID="TxtIdProofNo" CssClass="form-control"
                                                            TabIndex="22" runat="server" MaxLength="16"></asp:TextBox>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="Enter Valid Address proof"
                                                            ControlToValidate="TxtIdProofNo" ValidationGroup="Save"  ValidationExpression="^[a-zA-Z0-9,.#/]*$"></asp:RegularExpressionValidator>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-2">
                                                        E-Mail ID:</div>
                                                    <div class="col-md-4">
                                                        <asp:TextBox ID="TxtEmailID" CssClass="form-control validate[custom[email]]" TabIndex="25"
                                                            runat="server"></asp:TextBox>
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Enter Valid Email id"
                                                            ControlToValidate="TxtEmailID" ValidationGroup="Save"  ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                                                            </div>
                                                ...
                                                <div class="col-md-12" id="accounttype" runat="server" >
                                                    <div class="col-md-2">
                                                        Account Type.:</div>
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-2">
                                                        Account No.:</div>
                                                    <div class="col-md-4">
                                                        <asp:TextBox ID="TxtAccountNo" class="form-control" TabIndex="29" runat="server" MaxLength="14" ></asp:TextBox></div>
                                                </div>
                                                <div class="col-md-12">
                                                    <br />
                                                    <div class="col-md-2">
