Imports System.Data
Partial Class App_UI_Application_Pages_LegShiftOl
    ...
    Private Sub Leg_Shift()
        Try
            ...
            Sql = "Begin Transaction Exec LegShift_OGlobal  '" & Val(TxtFormNo.Text) & "','" & Val(TxtFormNos.Text) & "' Commit Transaction"
