<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="Visitverified.aspx.vb" Inherits="App_UI_Application_Pages_Visitverified" %>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <asp:DropDownList ID="DDlVerify" runat="server" class="form-control">
                                            ...
                                            <asp:ListItem Text="APPROVAL DUE" Value="N"></asp:ListItem>
                                    ...
                                    <%--<div class="col-md-2">
                                        <asp:Button runat="server" ID="BtnExport" class="btn btn-primary" Text="Export To Excel"
                                            Enabled="false" /></div>--%>
                                    <div class="col-md-1">
                                        <asp:Button ID="BtnVerifiy" runat="server" Text="Approve" class="btn btn-primary"
                                            Enabled="false" />
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="IDNo" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="LblGrpID" runat="server" Text='<%# Eval("VId") %>' Visible ="false" ></asp:Label>
                                            ...
                                            <asp:BoundField DataField ="Rectimestamp" HeaderText ="Submission Date" />
                                             <asp:BoundField DataField ="TotalMember" HeaderText ="Total Visiting Member" />
                                            <asp:TemplateField HeaderText="Member Detail" ItemStyle-HorizontalAlign="Center" >
                                                    <ItemTemplate>
                                                         <a href='<%# "viemember.aspx?VId=" & Eval("VId") %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width:650,height:380, } )">
                                                     <asp:Label ID="LblViewcourse" runat="server" Text="View" style=" color :Blue" />
                                                </a>
                                                        <br />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
