<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="MemberProfile.aspx.vb" Inherits="App_UI_Application_Pages_MemberProfile"
                                                ...
                                                <div id="gvContainer" runat="server" class="table table-bordered" style="overflow: scroll;">
                                                    ...
                                                    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="PV" HeaderText="BV" SortExpression="Pv" />
                                                    ...
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                <asp:Label ID="lblValue" runat="server" Text='<%# Eval("BV") %>'></asp:Label>
                                                            ...
                                                            <%--   <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblPV" runat="server" Text='<%# Eval("PV") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>--%>
                                                            <asp:BoundField DataField="Status" HeaderText="Status" SortExpression="Status" />
                                                    ...
                                                    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                                        GridLines="Both" AllowPaging="False" class="table table-bordered" HeaderStyle-CssClass="bg-primary"
                                                        ShowHeader="true" AllowSorting="true" OnSorting="GvData_Sorting" PageSize="10"
                                                        EmptyDataText="No data to display." ForeColor="black" HeaderStyle-ForeColor="white"
                                                        OnRowCreated="GridView1_RowCreated">
