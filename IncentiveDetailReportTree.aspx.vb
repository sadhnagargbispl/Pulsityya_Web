...
Partial Class App_UI_Application_Pages_IncentiveDetailReportTree
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Session("AStatus") = "OK" Then
            Session("PageName") = "Report  / Downline Weekly Incentive Report"
        Else
    ...
    Private Function GetFormno(ByVal IDno As String) As Integer
        Try
            ...
            Dim Str As String = "Select Formno From M_MemberMAster Where Upper(IDno) = '" & IDno.ToString().Trim().ToUpper() & "'"
            ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), CommandType.Text, Str)
            If (ds.Tables(0).Rows.Count > 0) Then
                _OutPut = Val(ds.Tables(0).Rows(0)("Formno"))
            Else
                _OutPut = 0
            End If
            Return _OutPut
    ...
    Private Sub IncentiveDetail(ByVal Sessid As Integer, ByVal PageIndex As Integer)
        Try
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetWeeklyPayoutDetailTree", prms)
    ...
    Private Sub ExportExcel()
        ...
        Using wb As New XLWorkbook()
            ...
            Response.AddHeader("content-disposition", "attachment;filename=DownlineIncentiveDetail.xlsx")
