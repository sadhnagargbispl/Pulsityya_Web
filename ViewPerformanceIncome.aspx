<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewPerformanceIncome.aspx.vb" Inherits="ViewPerformanceIncome" %>
    ...
    <div style="margin-bottom: 10px; padding-right: 20px; padding-top: 20px">
        <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="5px"
            ...
            <Columns>
               ...
               <%-- <asp:BoundField DataField="Roi" HeaderText="ROI"></asp:BoundField>--%>
