<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="WalletTransactionReportMenual.aspx.vb" Inherits="App_UI_Application_Pages_WalletTransactionReportMenual"
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>
                            Wallet Transaction Report Menual</h2>
                        <div class="clearfix">
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        <div style="background-color: White">
                            ...
                            <div class="col-md-12" style="padding: 5px">
                                ...
                                <div class="col-md-2">
                                    <asp:Button ID="btnPrintCurrent" runat="server" Text="Print Current Page" class="btn btn-primary" Visible="false" /></div>
                                <div class="col-md-2">
                                    <asp:Button ID="btnPrintAll" runat="server" Text="Print All Pages" class="btn btn-primary" Visible="false" /></div>
                                <div class="col-md-2">
                        ...
                        <div id="gvContainer" runat="server" style="overflow: scroll; margin-top: 25px; margin-left: 25px;
                            ...
                            <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="true" RowStyle-Height="25px"
                                ...
                                PageSize="10" EmptyDataText="No data to display." AllowSorting="true"
