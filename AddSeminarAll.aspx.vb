...
Partial Class App_UI_Application_Pages_AddSeminarAll
    ...
    "ContactPerson=@ContactPerson,Remarks=@Remarks,Program=@Program,ActiveStatus='" & RbStatus.SelectedValue & "' WHERE MeetingID='" & Val(TxtMeetingID.Text) & "'"
            Else
                strQuery = "INSERT INTO M_MeetingMaster (MeetingID,Speaker,MeetingTime,CityCode,CityName,DistrictCode,DistrictName,StateCode,Address,ContactNo,ContactPerson,Remarks,ActiveStatus,UserType,UserID,Program)" & _
          ...
          "'" & CityCode & "',@CityName,'" & DistCode & "',@DistName,'" & Val(CmbState.SelectedValue) & "',@Address,@ContactNo,@ContactPerson,@Remarks,'" & RbStatus.SelectedValue & "','A','" & Val(Session("UserID")) & "',@Program FROM M_MeetingMaster;"
            End If
