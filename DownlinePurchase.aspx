<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="DownLinePurchase.aspx.vb" Inherits="DownLinePurchase" %>
                ...
                <div class="x_panel">
                    ...
                    <div style="background-color: White">
                        <div class="col-md-12" style="padding: 1%">
                            ...
                            <div class="col-md-2">
                                <asp:CheckBox runat="server" ID="ChkDate" Text="Choose From Date : " /></div>
                            <div class="col-md-2">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-5">
                                <asp:RadioButtonList ID="RbtRequestType" runat="server" RepeatColumns="3" RepeatDirection="Horizontal">
                                    <asp:ListItem Text="Both" Value="0" Selected="True"></asp:ListItem>
                                    <asp:ListItem Text="Joining" Value="T"></asp:ListItem>
                    ...
                    <asp:GridView ID="GrdDirects" Width="100%" runat="server" AllowPaging="false" GridLines="Both"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="LegNo" HeaderText="Group"></asp:BoundField>
                            ...
                            <asp:BoundField DataField="BV" HeaderText="Repurchase Bv"></asp:BoundField>
