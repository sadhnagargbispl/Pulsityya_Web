...
Partial Class BVPoint
    ...
    Public Sub BindData()
        Dim sql As String = "select  Cast(A.BID as varchar)as BID,a.Sessid,b.Idno,(b.MemFirstName+' '+b.memLastName)as MemberName, " & _
        " Case when a.LegNo=1 Then 'Left' else 'Right' end as LegNo, a.BV,a.PV,a.Remark,Case when a.ActiveStatus='Y' then 'Active' else 'Deactive' " & _
        " end as Status from TrnBV as a,M_memberMaster as b where a.Formno=b.Formno Order By a.Sessid Desc,a.Formno Desc"
    ...
    Protected Sub GvData_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GvData.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If Val(Sessid) = Val(Session("CurrentSessn")) Then
                GrpId = DirectCast(e.Row.Cells(8).FindControl("LBDelete"), LinkButton)
                If String.Equals(e.Row.Cells(7).Text.ToLower(), "deactive") = True Then
                    GrpId.Visible = False
                Else
                    GrpId.Visible = True
                End If
    ...
    Protected Sub DeleteGroup(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim str As String = "Select * from TrnBv where BId='" & Val(BankCode.ToString()) & "' and Sessid='" & Val(Session("CurrentSessn")) & "'"
        dt = New DataTable
