...
Partial Class App_UI_Application_Pages_IncentiveDetailReportUCM
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Session("AStatus") = "OK" Then
            Session("PageName") = "Report  / New Weekly Incentive Report"
        Else
    ...
    Public Sub BindSession()
        Try
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_NewGetMonthlySession")
