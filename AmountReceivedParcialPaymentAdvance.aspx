<%@ Page Title="" Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false" CodeFile="AmountReceivedParcialPaymentAdvance.aspx.vb" Inherits="AmountReceivedParcialPaymentAdvance" %>
...
<script type="text/javascript" language="javascript">
        ...
        <div class="row">
            ...
            <div class="x_title">
                        <h2>
                       Amount Received Partial Payment Report
                        </h2>
                        <div class="clearfix">
                        </div>
