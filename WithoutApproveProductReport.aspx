<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false"
    CodeFile="WithoutApproveProductReport.aspx.vb" Inherits="WithoutApproveProductReport"
    Title="" %>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        ...
                                        <asp:DropDownList ID="RbReqStatus" runat="server" RepeatDirection="Horizontal" RepeatLayout="Table"
                                            ...
                                            <asp:ListItem Text="Dispatched" Value="C"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        Select:
                                        <asp:DropDownList ID="DDlByWalletSelect" runat="server" RepeatDirection="Horizontal"
                                            RepeatLayout="Table" class="form-control" AutoPostBack="true">
                                            <asp:ListItem Text="Without Wallet" Value="Y" Selected></asp:ListItem>
                                            <asp:ListItem Text="By Wallet" Value="N"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                        ...
                                        <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Print Receipt">
                                                    <ItemTemplate>
                                                        <%--  col2 = " <a href=""https://cpanel.solfit.in/invoiceSolfit.aspx?orderno=" & Base64Encode(Dr("d")) & ""
                            col2 &= """ target=""_blank"" >" & Dr("OrderNo") & " </a> "--%>
                                                        <a href='<%# "invoiceSolfit.aspx?orderno=" & Eval("orderno") & "&FormNo=" & Eval("FormNo") %>'
                                                            target="_blank">
                                                            <asp:Label ID="LblOrderNo1aaaa" runat="server" Text="Print Receipt" ForeColor="blue"></asp:Label>
                                                        </a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Dispatch">
                                                    <ItemTemplate>
                                                        <a href='<%# "DispatchStatus.aspx?OrderID=" & Eval("orderno") & "&type=WR" %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 854,height: 339,marginTop : 0 } )">
