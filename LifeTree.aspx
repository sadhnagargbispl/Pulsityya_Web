<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LifeTree.aspx.vb" Inherits="LifeTree" %>
          ...
          <div>
             ...
             <table cellpadding="0" cellspacing="1" border="0" width="350px" style="vertical-align: top;">
                    <tr style="font-weight: bold; font-size: 10px; font-family: Verdana;">
                        ...
                        <td style="padding: 1%">
                            <asp:Button ID="cmdBack" runat="server" Text="Home" class="btn btn-primary" />
                        </td>
                        <td style="padding: 1%">
                            <asp:Button ID="BtnStepAbove" runat="server" Text="1 Step Above" class="btn btn-primary" />
                        </td>
                        <td style="padding: 1%">
                            <asp:Button ID="btnhomeTree" runat="server" Text="Back" class="btn btn-primary" Visible="false" />
                        </td>
                    </tr>
                </table>
                <%--<table cellpadding="0" cellspacing="1" border="0" width="350px" style="vertical-align:top">
