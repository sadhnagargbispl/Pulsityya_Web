...
Partial Class PairCutReportW
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        Try
            If Session("AStatus") = "OK" Then
                Session("PageName") = "Report / Pair Cut Report Weekly"
            Else
    ...
    Public Sub BindData(ByVal PageIndex As Integer)
        ...
        Try
            ...
            prms(1) = New SqlParameter("@Sessid", FromSessid)
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_PairCutDetailW", prms)
