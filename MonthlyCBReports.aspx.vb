...
Partial Class MonthlyCBReports
    ...
    Dim Ds As DataSet
    Dim constr As String = ConfigurationManager.ConnectionStrings("sconstr").ConnectionString
    ...
    Public Sub BindData(ByVal PageIndex As Integer)
        ...
        If Session("compid") = "1081" Then
            Try
                ...
                Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetDailyPayoutDetail_zaraUpdate", prms)
        ...
        Else
            Try
                ...
                Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetDailyPayoutDetail_zara", prms)
                GrdTotal.DataSource = Ds.Tables(0)
                GrdTotal.DataBind()
                Dim recordCount As Integer = Ds.Tables(1).Rows(0)("RecordCount")
                Session("GData") = Ds.Tables(0)
    ...
    Private Sub ExportExcel()
        ...
        Using wb As New XLWorkbook()
            ...
            Response.AddHeader("content-disposition", "attachment;filename=MonthlycashbackReport.xlsx")
