<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false"
    CodeFile="SeminarMasterAll.aspx.vb" Inherits="App_UI_Application_Pages_SeminarMasterAll"
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            <div align="center">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <a href="AddSeminarAll.aspx" onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 420,height: 480,marginTop : 0 } )">
                                    ...
                                    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Modify" HeaderStyle-Width="85px" ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <a href='<%# "AddSeminarAll.aspx?MeetingID=" & Eval("VMeetingID") %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 450,marginTop : 0 } )">
