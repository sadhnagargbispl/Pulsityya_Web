<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false" CodeFile="LevelIncentiveDetailReportRichnet.aspx.vb" Inherits="LevelIncentiveDetailReportRichnet" title="Level Incentive Report" %>
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <div style="padding: 10px 10px 20px 10px">
                                                <asp:GridView ID="GrdTotal" Width="100%" runat="server" AllowPaging="false" PageSize="200"
                                                    GridLines="Both" class="table table-bordered" 
