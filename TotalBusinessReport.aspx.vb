...
Partial Class TotalBusinessReport
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        Try
            If Session("AStatus") = "OK" Then
                Session("PageName") = " Report / Total Business Report"
            Else
    ...
    Public Sub BindData(ByVal pageIndex As Integer)
        ...
        Try
            ...
            If CmbKit.SelectedValue = "N" Then
                If TxtMemId.Text = "" Then
                   
                    ScriptManager.RegisterClientScriptBlock(Me.Page, Me.[GetType](), "Close", "<SCRIPT language='javascript'>alert('Enter Sponsor Id!! ');" & "</SCRIPT>", False)
                    Exit Sub
                End If
            End If
            If TxtMemId.Text <> "" Then
            ...
            prms(1) = New SqlParameter("@Type", kitId)
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "Sp_BusinessRankReport", prms)
    ...
    Private Sub ExportExcel()
        ...
        Using wb As New XLWorkbook()
            ...
            Response.AddHeader("content-disposition", "attachment;filename=TotalBusinessReport.xlsx")
