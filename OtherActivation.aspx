<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="OtherActivation.aspx.vb" Inherits="OtherActivation" %>
                                ...
                                <br />
                                        ...
                                        <br />
                                            <div class="col-md-3">
                                                Sponsor Id:</div>
                                            <div class="col-md-4">
                                                <asp:TextBox ID="TxtSponsor"  runat="server" class="form-control" AutoPostBack ="true"  ></asp:TextBox>
                                                <asp:TextBox ID="TxtRefFormno" runat="server" class="form-control" Visible="false"></asp:TextBox>
                                            </div>
                                            <div class="col-md-5">
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="* Enter Sponsor ID."
                                                    ControlToValidate="TxtSponsor" ValidationGroup="Save"></asp:RequiredFieldValidator>
