<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false"
    CodeFile="ApproveRankRequest.aspx.vb" Inherits="ApproveRankRequest" Title="" %>
                                        ...
                                        <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="IDNo" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="LblGrpID" runat="server" Text='<%# Eval("Rankid") %>'></asp:Label>
                                                        <asp:Label ID="LblIdNo" runat="server" Text='<%# Eval("MemberID") %>'></asp:Label>
                                                        <%--<asp:Label ID="lblformno" runat="server" Text='<%# Eval("RefFormNo") %>'></asp:Label>--%>
                                                        <asp:Label ID="lblformno" runat="server" Text='<%# Eval("FormNo") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="fromid" HeaderText="Referal ID" />
                                                <asp:BoundField DataField="Referalname" HeaderText="Referal Name" />
                                                <asp:BoundField DataField="MemberID" HeaderText="Member ID" />
                                                <asp:BoundField DataField="MemberName" HeaderText="Member Name" />
                                                <asp:BoundField DataField="Rank" HeaderText="Rank Name" />
