...
Imports System.IO
Partial Class App_UI_Application_Pages_KitProdMaster
    ...
    Public Sub BindData(Optional ByVal Condition As String = "")
        Dim sql As String = "Select c.CatName, a.ProdId,a.ProductCode as VProdId,a.ProductName,a.Rate,Cast( a.Qty as numeric(18,0)) as Qty,a.Tax,a.TaxAmount,a.Amount,a.ProductDesc as Remarks,CASE WHEN a.ActiveStatus='Y' Then 'Active' ELSE 'DeActive' END AS Status From " + objDAL.tblKitProductMaster + " as a,M_CatMaster as c Where a.CatID=c.CatID AND a.RowStatus='Y' AND c.RowStatus='Y'  " + Condition + " Order by ProductName"
    ...
    Protected Sub DeleteProd(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim Sql As String = "Update " + objDAL.tblKitProductMaster + " SET ActiveStatus='N' WHERE ProdId='" & GrpID & "' AND RowStatus='Y'"
        ...
        Else
            scrname = "<SCRIPT language='javascript'>alert('Not able to delete the selected Product! ');" & "</SCRIPT>"
        End If
        ScriptManager.RegisterClientScriptBlock(Me.Page, Me.[GetType](), "Product Deletion", scrname, False)
        BindData()
    End Sub
    ...
    Protected Sub imgSearch_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgSearch.Click
        ...
        If ddlGroupFields.SelectedValue = "None" Then Exit Sub
            ...
            If String.Equals(ddlGroupFields.SelectedItem.Text.ToLower(), "status") = True Then
                If String.IsNullOrEmpty(txtSearch.Text) = False Then
                    ...
                    Else
                        status = "Y"
                    End If
                    sql = " AND a.ActiveStatus like '%" + status.ToString() + "%'"
                End If
            Else
                sql = " AND a." + ddlGroupFields.SelectedValue.ToString() + " like '%" + txtSearch.Text + "%' "
            End If
            BindData(sql)
        End If
    End Sub
    ...
    Protected Sub GvData_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GvData.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            If String.Equals(e.Row.Cells(9).Text.ToLower(), "deactive") = True Then
