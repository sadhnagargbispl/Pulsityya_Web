<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="IncentiveDetailReport.aspx.vb" Inherits="App_UI_Application_Pages_IncentiveDetailReport"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <% If Session("CompID") IsNot Nothing AndAlso Session("CompID").ToString() = "1110" Then %>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <div style="padding: 10px 10px 20px 10px; overflow: scroll" id="divDetail" runat="server"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="SNo.">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblsno" runat="server" Text='<%# Eval("SNo") %>'></asp:Label></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="Payoutno" HeaderText="PayoutNo" />
                                    <asp:BoundField DataField="Idno" HeaderText="Idno" />
                                    <asp:BoundField DataField="MemFirstName" HeaderText="Membername" />
                                    <asp:BoundField DataField="Mobl" HeaderText="Mobile No" />
                                    <asp:BoundField DataField="Panno" HeaderText="Pan No" />
                                    <asp:TemplateField HeaderText="Performance Bonus">
                                        <ItemTemplate>
                                            <a href='<%# "ViewPerformanceIncome.aspx?Idno="& Eval("IDNo")&"&SessId="& Eval("SessId") %>'
                                                onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 620,height: 450,marginTop : 0 } )">
                                                <asp:Label ID="Label1" runat="server" ForeColor="Blue" Text='<%# Eval("Performance Bonus") %>'></asp:Label></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="Sponsor Income" HeaderText="Sponsor Income" />
                            ...
                            <asp:GridView ID="GridView2" Width="100%" runat="server" AllowPaging="false" GridLines="Both"
                                class="table table-bordered" HeaderStyle-CssClass="bg-primary" ShowHeader="true"
                                EmptyDataText="No data to display." AutoGenerateColumns="false" AllowSorting="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Wholesale Income">
                                        <ItemTemplate>
                                            <a href='<%# "ViewPage.aspx?Idno="& Eval("IDNo")&"&SessId="& Eval("SessId") %>'
                                                onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 620,height: 450,marginTop : 0 } )">
                                                <asp:Label ID="Label1" runat="server" ForeColor="Blue" Text='<%# Eval("WholesaleIncome") %>'></asp:Label></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Royalty Club Income">
                                        <ItemTemplate>
                                            <a href='<%# "ViewLevelIncomezara.aspx?Idno="& Eval("IDNo")&"&SessId="& Eval("SessId") %>'
                                                onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 620,height: 450,marginTop : 0 } )">
                                                <asp:Label ID="Label1" runat="server" ForeColor="Blue" Text='<%# Eval("RoyaltyClubIncome") %>'></asp:Label></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
