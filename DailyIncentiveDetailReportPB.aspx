<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="DailyIncentiveDetailReportPB.aspx.vb" Inherits="App_UI_Application_Pages_DailyIncentiveDetailReportPB"
    Title="" %>
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <div style="padding: 10px 10px 20px 10px">
                                                ...
                                                <asp:GridView ID="GrdTotal" Width="100%" runat="server" AllowPaging="false" PageSize="200"
                                                    ...
                                                    ShowHeader="true" EmptyDataText="No data to display." AutoGenerateColumns="true" AllowSorting="true"
