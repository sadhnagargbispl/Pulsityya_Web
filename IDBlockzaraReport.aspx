<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="IDBlockzaraReport.aspx.vb" Inherits="App_UI_Application_Pages_IDBlockzaraReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ShowMenu(Dv, control, e) {
            ...
            var inHtm
            if (IsBlock == 'Y')
                inHtm = '<li class="separator"><a href="UnBlockzara.aspx?Tp=S&key=' + el + '">Unblock</a></li>';
            else
                inHtm = '<li class="separator"><a href="Blockzara.aspx?Tp=S&key=' + el + '">Block Now</a></li>';
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>
                            ID Block And Unblock Report</h2>
                        <div class="clearfix">
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            ...
                            <div>
                            <div class ="col-md-1">
                                         <h3 style="font-family: Montserrat, sans-serif; font-size: medium"> Status :</h3>
                                         </div>
                                          <div class ="col-md-2">
                                        <asp:DropDownList ID="ddlstatus" runat="server" AutoPostBack="true" class="form-control">
                                             <asp:ListItem Text="All" Value="A" />
                                            <asp:ListItem Text="Blocked" Value="Y" />
                                            <asp:ListItem Text="Unblocked" Value="N" />
                            ...
                            <div style="overflow: scroll" class="table table-bordered">
                                <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="True" PageSize="20"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Click Here!" HeaderStyle-ForeColor="White" Visible="false" >
                                            <ItemTemplate>
                                               <div id="DivOptions">
                                        ...
                                        <asp:TemplateField HeaderText="Block Date" SortExpression="Block Date" HeaderStyle-ForeColor="White">
                                            <ItemTemplate>
                                                <asp:Label ID="lblblockdate" runat="server" Text='<%# Eval("Block Date") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Remark" SortExpression="Block Remark" HeaderStyle-ForeColor="White">
                                            <ItemTemplate>
                                                <asp:Label ID="lblblockdate" runat="server" Text='<%# Eval("blockremark") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
