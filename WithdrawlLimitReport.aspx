<%@ Page Title="" Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false" CodeFile="WithdrawlLimitReport.aspx.vb" Inherits="WithdrawlLimitReport" %>
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            <div align="center">
                                <div class="col-md-12" style="min-height: 500px;">
                                    ...
                                    <a href="WithdrawlLimit.aspx" onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 460,marginTop : 0 } )">
                                           
                                    <asp:Button ID="BtnAdd" runat="server" Text="Add Withdrawl Limit" class="btn btn-primary" /> </a> 
                                    </div>
