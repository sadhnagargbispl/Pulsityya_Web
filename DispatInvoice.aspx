<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DispatInvoice.aspx.vb" Inherits="DispatInvoice" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <link href="https://fonts.googleapis.com/css2?family=DM+Serif+Display&family=DM+Sans:ital,wght@0,300;0,400;0,500;0,600;1,400&display=swap"
        rel="stylesheet" />
    <style>
        *, *::before, *::after
        {
        ...
        @keyframes@keyframesrise{from{opacity:0;transform:translateY(28px);}
        to
        {
            opacity: 1;
...
<body>
    ...
    <div class="page">
        ...
        <div class="footer">
            <span style="color: white; font-size: 1.1em;">This is computer generated invoice hence
                no stamp required</span>
        </div>
        <!-- ══════════════════════════════
                 MOBILE CARDS
            ══════════════════════════════ -->
