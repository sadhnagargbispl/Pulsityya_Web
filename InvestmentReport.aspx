<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="InvestmentReport.aspx.vb" Inherits="App_UI_Application_Pages_InvestmentReport"
    Title="" %>
                        ...
                        <div class="clearfix">
                                ...
                                <div class="col-md-2" style="padding-top:9px">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <asp:Label ID="Label2" runat="server" Text="Investment Type: "></asp:Label>
                                        <asp:DropDownList ID="ddltype" runat="server" class="form-control">
                                            <asp:ListItem Selected="True" Value="">Both</asp:ListItem>
                                            <asp:ListItem Value="Activation">Activation</asp:ListItem>
                                            <asp:ListItem Value="Retopup">Retopup</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                            ...
                                            <div style="padding: 10px 10px 20px 10px">
                                                <asp:GridView ID="GrdTotal" Width="100%" runat="server" AllowPaging="false" PageSize="200"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Investment" SortExpression="Investment">
                                                            <ItemTemplate>
                                                            
                                                                <asp:Label ID="lblIncome" runat="server" Text='<%# Eval("Investment") %>'></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                       <asp:TemplateField HeaderText="Package Name" SortExpression="PackageName">
                                                            <ItemTemplate>
                                                            
                                                                <asp:Label ID="lblIncome" runat="server" Text='<%# Eval("kitname") %>'></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                       <%-- <asp:TemplateField HeaderText="Investment Type" SortExpression="InvestmentType">
                                                            <ItemTemplate>
                                                            
                                                                <asp:Label ID="lbltype" runat="server" Text='<%# Eval("status") %>'></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>--%>
                                                           <%-- <asp:TemplateField HeaderText="TopBy" SortExpression="TopBy">
                                                            <ItemTemplate>
                                                            
                                                                <asp:Label ID="lblIncome" runat="server" Text='<%# Eval("fromdebit") %>'></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>--%>
                                                    </Columns>
                                                </asp:GridView>
