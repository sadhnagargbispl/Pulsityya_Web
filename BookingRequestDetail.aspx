<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="BookingRequestDetail.aspx.vb" Inherits="BookingRequestDetail" %>
                                        ...
                                        <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="IDNo" Visible="false">
                                                    <ItemTemplate>
                                                    <asp:Label ID="lblflatid" runat="server" Text='<%# Eval("Flatid") %>'></asp:Label>
                                                ...
                                                <asp:BoundField DataField ="cmobileno" HeaderText="Customer Mobile No" />
                                                <asp:BoundField DataField="City" HeaderText="City" />
                                                
                                                <asp:BoundField DataField ="BookingAMount" HeaderText="Booking Amount" />
                                                <asp:BoundField DataField ="AMount" HeaderText="Deal Amount" />
                                                ...
                                                <asp:BoundField DataField="Remark" HeaderText="Member Remark"></asp:BoundField>
                                                <asp:BoundField DataField="Status" HeaderText="Status"></asp:BoundField>
                                                <asp:BoundField DataField="ApproveRemark" HeaderText="User  Remark" />
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <a href='<%# "Img.aspx?&type=Booking&ID=" & Eval("Reqno") %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 785,height: 580,marginTop : 0 } )">
