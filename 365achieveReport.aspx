<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="365achieveReport.aspx.vb" Inherits="App_UI_Application_Pages_365achieveReport"
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            <div align="center">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <asp:Label ID="lblStartDate" runat="server" Text="Choose Achieve Start Date : "></asp:Label>
                                    ...
                                    <div class="col-md-3">
                                        <asp:Label ID="lblEndDate" runat="server" Text="Choose Achieve End Date : "></asp:Label>
                            ...
                            <div style="margin-top: 40px; margin-bottom: 20px;">
                                ...
                                <asp:Label ID="lblCount" runat="server" Style="font-weight: bold; font-size: 14px;
                                    color: Gray; float :left ;" ></asp:Label>
                            </div>
                                ...
                                <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                    ...
                                    <Columns>
                                           <asp:TemplateField HeaderText="S.No." HeaderStyle-Width="35px">
                                            ...
                                            <asp:BoundField DataField ="LeftDirect" HeaderText="Left Direct" SortExpression ="LeftDirect" />
                                            <asp:BoundField DataField ="RightDirect" HeaderText="Right Direct" SortExpression ="RightDirect" />
                                            <asp:BoundField DataField ="Match Direct" HeaderText="Match Direct" SortExpression ="Match Direct" />
                                            <asp:BoundField DataField ="Slab" HeaderText="Slab" SortExpression ="Slab" />
                                            <asp:BoundField DataField ="AchieveDate" HeaderText="Achieve Date" SortExpression ="AchieveDate" />
