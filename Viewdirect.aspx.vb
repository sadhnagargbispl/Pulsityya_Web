...
Partial Class Viewdirect
    ...
    Public Sub BindData(Optional ByVal SrchCond As String = "")
        Try
            ...
            Dim Sql As String = "select  b.idno,(B.MemFirstName+' '+b.memLastname) as memberName,b.Mobl,b.City , a.Formno,a.Formnodwn " & _
           " From R_MemTreeRelation as a with(NoLock) Inner Join  " & _
     " M_membermaster as B with(NoLock) On a.Formnodwn=b.Formno and a.Mlevel=1 and b.ActiveStatus='Y' and a.formno='" & Val(formno) & "' and Cast(Replace(Convert(Varchar,B.UpgradeDate,106),' ','-')as Date)>='" & Request("fromDate") & "' and Cast(Replace(Convert(Varchar,B.UpgradeDate,106),'','-')as Date)<='" & Request("Todate") & "'"
