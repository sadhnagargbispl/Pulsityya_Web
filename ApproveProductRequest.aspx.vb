...
Partial Class ApproveProductRequest
    ...
    Public Sub BindData(Optional ByVal Condition As String = "")
        ...
        If RbReqStatus.SelectedValue <> "A" Then
            ...
            '    'If DDlByWalletSelect.SelectedValue = "N" Then
            '    '    'If DDlSelectTypeFordis.SelectedValue = "C" Then
            '    '    '    If RbReqStatus.SelectedValue = "Y" Then
            '    '    '        Condition = Condition & " And DispStatus = 'C'"
            '    '    '    Else
        ...
        Dim sql As String
        'If DDlByWalletSelect.SelectedValue = "N" Then
        '    sql = " select * from V#ProductRequestByWallet where 1 = 1 " & Condition & " order by RectimeStamp desc  "
        'Else
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Try
            ...
            '    sql &= " from V#ProductRequestByWallet where 1 = 1 " & Condition & " order by RecTimeStamp desc  "
            'Else
