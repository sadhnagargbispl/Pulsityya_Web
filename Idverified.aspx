<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="Idverified.aspx.vb" Inherits="App_UI_Application_Pages_Idverified" EnableEventValidation="true" %>
                                        ...
                                        <Columns>
                                           ...
                                           <%-- <asp:BoundField DataField="IdType" HeaderText="IdType" />
                                            ...
                                            <asp:TemplateField HeaderText="Front Address Proof" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <a href='<%# "Img.aspx?ID=" & Eval("FormNo") & "&Type=FrontAddress" %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width:500,height:500,marginTop : 50 } )"  target="_blank">
                                            ...
                                            <asp:TemplateField HeaderText="Back Address Proof" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <a href='<%# "Img.aspx?ID=" & Eval("FormNo") & "&Type=BackAddress" %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width:500,height:500,marginTop : 50 } )" target="_blank">
