<%@ Page Title="" Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false"
    CodeFile="ListFlattypeMaster.aspx.vb" Inherits="ListFlattypeMaster" %>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            <div class="col-md-12">
                                <div class=" col-md-12">
                                    <div class="col-md-10">
                                        <a href="FlatTypeMaster.aspx" onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 330,marginTop : 0 } )">
                                            <asp:Button ID="BtnAdd" runat="server" class="btn btn-primary" Text="Add New Flat Type" /></a>
                                ...
                                <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-Width="85px" ItemStyle-HorizontalAlign="Center" ControlStyle-CssClass="btn-group">
                                            <ItemTemplate>
                                                <a href='<%# "FlatTypeMaster.aspx?key=" & Crypto.Encrypt(Eval("ID"))  %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 330,marginTop : 0 } )"><i class="fa fa-edit"
