...
Partial Class LifeMemberProfile
        ...
        Try
            ...
            If Session("CompID") = 1075 Then
                ...
                If Ds.Tables(0).Rows.Count > 0 Then
                    ...
                    End If
                    Label3.Text = "Total Record: " & Ds.Tables(1).Rows(0)("RecordCount")
                    GridView1.Visible = True
                    gvContainer1.Visible = True
                Else
                    lblErr.Text = "No Record Found!!"
                    GridView1.Visible = False
                    gvContainer1.Visible = True
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        If dtData.Rows.Count > 0 Then
            If Session("CompID") = 1075 Then
                Label4.Text = " Total Activation: " & dtData.Rows(0)("TotalActivate")
                Label5.Text = " Total Deactivation: " & dtData.Rows(0)("TotalDeactivate")
            Else
