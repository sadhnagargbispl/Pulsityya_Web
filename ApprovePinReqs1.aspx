<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="ApprovePinReqs1.aspx.vb" Inherits="ApprovePinReqs1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="background-color: White; padding: 20px">
        ...
        <table width="100%" cellspacing="10px" align="left" style="margin: 0px; padding: 0px;">
            <tr>
                <td>
                    <asp:RadioButtonList ID="RbtPymode" runat="server" RepeatDirection="Horizontal" RepeatLayout="Table">
                        <asp:ListItem Selected="True" Text="Bank Only" Value="B"></asp:ListItem>
                        <asp:ListItem Text="Other Only" Value="O"></asp:ListItem>
                        <asp:ListItem Text="Wallet Only" Value="W"></asp:ListItem>
            ...
            <tr>
                <td>
                    ...
                    <asp:TextBox runat="server" Enabled="false" ID="TxtMemID" CssClass="TxtBox"></asp:TextBox>
                </td>
                <td>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="padding-top: 15px;">
                    ...
                    <asp:Button ID="btnExport" runat="server" CssClass="Btn" Text="Export To Excel" Visible="false" />
                    ...
                    <asp:Button ID="btnPrintAll" runat="server" Text="Print All Pages" CssClass="Btn"
                        Visible="false" />
                    <asp:Button ID="btnApproove" runat="server" CssClass="Btn" Text="Approve" Visible="false" />
                </td>
