<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="AwardAchieverReport.aspx.vb" Inherits="App_UI_Application_Pages_AwardAchieverReport"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="gvContainer" runat="server" style="overflow: scroll; margin-top: 25px;
        ...
        <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
            ...
            <asp:BoundField DataField ="Member Name" HeaderText ="MemberName" />
            <asp:BoundField DataField ="Award Name" HeaderText="Award Name" />
            <asp:BoundField DataField ="Achieved Date" HeaderText="Achieve Date" />
            <asp:BoundField DataField ="WkrLeg" HeaderText="Min BV" />
            <asp:BoundField DataField ="PwrLeg" HeaderText="Max Bv" />
            <asp:TemplateField HeaderText="Left Count">
            <ItemTemplate >
            <a href='<%# "ViewAward.aspx?FormNo="&Eval("FormNo")&"&LegNo="&(1) & "&RewardId="&Eval("RewardId")&"&Sessid="&Eval("Sessid")%>'   onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 350,marginTop : 0 } )"><asp:Label ID="LblCount" runat="server" Text='<%# Eval("LeftCount") %>'></asp:Label> </ItemTemplate></asp:TemplateField>
                       <asp:TemplateField HeaderText="Right Count">
            <ItemTemplate >
            <a href='<%# "ViewAward.aspx?FormNo="&Eval("FormNo")&"&LegNo="&(2) & "&RewardId="&Eval("RewardId")&"&Sessid="&Eval("Sessid")%>'   onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 350,marginTop : 0 } )"><asp:Label ID="LblCount" runat="server" Text='<%# Eval("RightCount") %>'></asp:Label> </ItemTemplate></asp:TemplateField>
            
            <asp:BoundField DataField ="Member Join Date " HeaderText="Member Join Date " /></Columns>
        </asp:GridView>
    </div>
    <br />
    <br />
