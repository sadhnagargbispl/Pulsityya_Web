<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="Complaints.aspx.vb" Inherits="App_UI_Application_Pages_Complaints" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="right_col" role="main">
        <div class="row">
            ...
            <div class="x_panel" id="Allview" runat="server">
                    <div class="x_title">
                        <h2>
                            Complaint</h2>
                        <div class="clearfix">
                            ...
                            <div align="center">
                                <div class="col-md-12" style="display: inline; padding: 1%"">
                                    ...
                                    <div class="col-md-2">
                                        Type :</div>
                                    <div class="col-md-4">
                                        <asp:RadioButtonList ID="RbReplied" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                ...
                                <div class="col-md-12" style="display: inline; padding: 1%">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="TxtFromDate"
                                            ...
                                            ValidationGroup="Save"></asp:RegularExpressionValidator></div>
                                    <div class="col-md-2">
                                        To:</div>
                                    <div class="col-md-2">
                ...
                <div class="x_panel" id="uddanview" runat="server">
                    <div class="x_title">
                        <h2>
                            Grievance</h2>
                        <div class="clearfix">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <div align="center">
                                <div class="col-md-12" style="display: inline; padding: 1%"">
                                    <div class="col-md-2">
                                    <asp:DropDownList ID="ddlGroupFields1" runat="server" class="form-control">
                                           <asp:ListItem Value="None" Selected="True">--Search By--</asp:ListItem>
                                            <asp:ListItem Value="m.IDNo">ID No.</asp:ListItem>
                                            <asp:ListItem Value="m.CType">Grievance Type</asp:ListItem>
                                            <asp:ListItem Value="m.Complaint">Grievance</asp:ListItem>
                                            <asp:ListItem Value="s.Solution">Solution</asp:ListItem>
                                        </asp:DropDownList>
                                    ...
                                    <div class="col-md-2">
                                        <asp:TextBox ID="txtnewsearch" class="form-control" runat="server" Style="display: inline"></asp:TextBox>
                                    </div>
                                    <div class="col-md-2">
                                     <%--   <asp:ImageButton ID="imgSearch" runat="server" CssClass="imgSearchButton" ImageUrl="Images/search.png"
                                            Width="32px" Height="32px" />
                                    ...
                                    <div class="col-md-4">
                                        <asp:RadioButtonList ID="RbReplied1" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                            <asp:ListItem Value="K" Text="All" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="Y" Text="Replied"></asp:ListItem>
                                            <asp:ListItem Value="N" Text="Not yet Replied"></asp:ListItem>
                                        </asp:RadioButtonList>
                                ...
                                <div class="col-md-12" style="display: inline">
                                    ...
                                    <div class="col-md-2">
                                        <asp:RadioButtonList ID="RbtStatus1" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                            <asp:ListItem Value="K" Text="All" Selected="True"></asp:ListItem>
                                            <asp:ListItem Value="C" Text="Close"></asp:ListItem>
                                            <asp:ListItem Value="O" Text="Open"></asp:ListItem>
                                        </asp:RadioButtonList>
                                    ...
                                    <div class="col-md-2">
                                        <asp:Label ID="LblGroup1" runat="server" Text="Search User Wise">
                                        </asp:Label></div>
                                    <div class="col-md-2">
                                        <asp:DropDownList ID="DDlGroup1" runat="server" class="form-control">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-md-4">
                                    </div>
                                ...
                                <div class="col-md-12" style="display: inline; padding: 1%">
                                    <div class="col-md-2">
                                        <asp:CheckBox ID="ChkDate1" runat="server" Text="Grievance Date :" />
                                    </div>
                                    <div class="col-md-2">
                                        <asp:TextBox ID="TxtFromDate1" class="form-control" runat="server"></asp:TextBox>
                                        <AjaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="TxtFromDate1"
                                            Format="dd-MMM-yyyy">
                                        </AjaxToolkit:CalendarExtender>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TxtFromDate1"
                                            ErrorMessage="Invalid From Date" Font-Names="arial" Font-Size="10px" SetFocusOnError="True"
                                            ValidationExpression="^(?:((31-(Jan|Mar|May|Jul|Aug|Oct|Dec))|((([0-2]\d)|30)-(Jan|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec))|(([01]\d|2[0-8])-Feb))|(29-Feb(?=-((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))-((1[6-9]|[2-9]\d)\d{2})$"
                                            ValidationGroup="Save"></asp:RegularExpressionValidator></div>
                                    <div class="col-md-2">
                                        To:</div>
                                    <div class="col-md-2">
                                        <asp:TextBox ID="TxtToDate1" class="form-control" runat="server"></asp:TextBox>
                                        <AjaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="TxtToDate1"
                                            Format="dd-MMM-yyyy">
                                        </AjaxToolkit:CalendarExtender>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="TxtToDate1"
                                            ErrorMessage="Invalid To Date" Font-Names="arial" Font-Size="10px" SetFocusOnError="True"
                                            ValidationExpression="^(?:((31-(Jan|Mar|May|Jul|Aug|Oct|Dec))|((([0-2]\d)|30)-(Jan|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec))|(([01]\d|2[0-8])-Feb))|(29-Feb(?=-((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00)))))-((1[6-9]|[2-9]\d)\d{2})$"
                                            ValidationGroup="Save"></asp:RegularExpressionValidator></div>
                                    <div class="col-md-4">
                                ...
                                <div class="col-md-12">
                                    <div style="width: 100%; float: right; margin-bottom: 20px;">
                                        <asp:Button ID="BtnSubmit1" runat="server" class="btn btn-primary" Text="Search" ValidationGroup="Save" />
                                        <asp:Button ID="btnExport1" runat="server" class="btn btn-primary" Text="Export To Excel" />&nbsp;
                                        <asp:Button ID="btnPrintCurrent1" runat="server" Text="Print Current Page" class="btn btn-primary" />&nbsp;
                                        <asp:Button ID="btnPrintAll1" runat="server" Text="Print All Pages" class="btn btn-primary" />&nbsp;
                                        <asp:Button ID="btnShowRecord1" runat="server" CssClass="btn-btn primary " Text="View All"
                                            Visible="false" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div style="margin-bottom: 20px">
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="IDNo" HeaderText="ID No." ControlStyle-Width="50px" />
                                <asp:BoundField DataField="MemName" HeaderText="Member Name" />
                                <asp:BoundField DataField="CDate" HeaderText="Grievance Date" />
                                <asp:BoundField DataField="CType" HeaderText="Grievance Type" />
                                <asp:BoundField DataField="Complaint" HeaderText="Grievance" />
                                <asp:BoundField DataField="SDate" HeaderText="Reply Date" />
                                <asp:BoundField DataField="Solution" HeaderText="Previous Reply" />
                                <%--<asp:BoundField DataField ="Status" HeaderText="Status" />--%>
                                <asp:TemplateField HeaderText="Reply" HeaderStyle-Width="55px" ItemStyle-HorizontalAlign="Center"
