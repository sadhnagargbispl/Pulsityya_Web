...
Partial Class Dispatchproductreport
    ...
    Protected Sub btnShowRecord_Click(ByVal sender As Object, _
    ByVal e As System.EventArgs) Handles btnShowRecord.Click
        BindData()
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                If (Session("CompID") = "1103" Or Session("CompID") = "1108" Or Session("CompID") = "1105") Then
                    GvData.Columns(12).Visible = True   'Invoice column
    ...
    Public Sub BindData()
        Try
            ...
            End If
            Dim sql As String = "exec Sp_purchaseReqReport '" & TransactionID & "','" & startDate & "','" & endDate & "','N','N',1,100000000,2"
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Response.AddHeader("content-disposition", String.Format("attachment; filename={0}", "DispatchReport.xls"))
        ...
        If Session("compid") = "1108" Or Session("compid") = "1103" Or Session("compid") = "1105" Then
            GvData.Columns(12).Visible = False   ' Dispatch
            GvData.Columns(13).Visible = False   ' Invoice
        End If
    ...
    Public Function convertJsonStringToDataSet(ByVal jsonString As String) As DataSet
        ...
        Return ds
    End Function
    Public Function Base64Encode(ByVal orderno As Object) As String
        Dim plainText As String = orderno.ToString()
