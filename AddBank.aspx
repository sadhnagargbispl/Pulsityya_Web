<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddBank.aspx.vb" Inherits="App_UI_Application_Pages_AddBank" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12" style="padding-top :1%">
                                    <div class="col-md-4">
                                        Bank Name :</div>
                                    <div class="col-md-6">
                                        <asp:TextBox class="form-control" ID="txtBankName" runat="server" AutoPostBack="true" ></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" ControlToValidate="txtBankName"
                                ...
                                <div class="col-md-12" style="padding-top :1%">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" Display="Dynamic" ControlToValidate="txtAccountNo"
                                            runat="server" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                                    </div>
                                    <div class="col-md-2">
                                    </div>
                                ...
                                <div class="col-md-12" style="padding-top :1%">
                                    ...
                                    <div class="col-md-6">
                                        <asp:TextBox class="form-control" ID="txtIFSCode" runat="server"></asp:TextBox></div>
                                    <div class="col-md-2">
                                    </div>
                                </div>
                                <div class="col-md-12" style="padding-top :1%">
                                ...
                                <div class="col-md-12" style="padding-top :1%">
                                    <div class="col-md-4">
                                        ...
                                        <asp:TextBox ID="txtIPAdrs" runat="server" Visible="false"></asp:TextBox></div>
                                    <div class="col-md-6">
