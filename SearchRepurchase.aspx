<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false" CodeFile="SearchRepurchase.aspx.vb" Inherits="SearchRepurchase" title="Untitled Page" %>
                        ...
                        <div>
                            <div align="center">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                   Member ID
                                        <asp:TextBox class="form-control" ID="txtIDNo" runat="server" ></asp:TextBox>
                                   </div>
                                     <div class="col-md-3">
                                   User Formn No
                                        <asp:TextBox class="form-control" ID="TextUserformnno" runat="server" ></asp:TextBox>
                                   </div>
                                       <div class="col-md-3">
                                       From Date
