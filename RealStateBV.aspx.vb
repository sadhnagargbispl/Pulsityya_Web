Imports System.Data
Partial Class App_UI_Application_Pages_RealStateBV
        ...
        Try
            If Not Page.IsPostBack Then
                ...
                If Session("AStatus") = "OK" Then
                    Session("PageName") = "Member / Add Real State BV"
                Else
    ...
    Protected Sub BtnLegShift_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnLegShift.Click
        Try
            ...
            Dim STR As String = "sp_AddRealStateBV '" & hdnFormno.Value & "', '" & Val(txtBV.Text) & "','" & Val(txtAmount.Text) & "','" & Val(TxtReward.Text) & "','" & Val(TxtRoyalty.Text) & "','" & txtRemark.Text & "'"
