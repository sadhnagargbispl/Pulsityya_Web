                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div id="divDetailSection" runat="server" style="margin-bottom: 30px; margin-right: 20px;">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-4">
                                                    <asp:TextBox ID="txtAddLn1" CssClass="form-control validate[required]"
                                                ...
                                                <div class="col-md-4">
                                                    <asp:TextBox ID="txtPinCode" CssClass="form-control validate[custom[pincode]]" AutoPostBack="true"
                                                        TabIndex="15" runat="server"></asp:TextBox></div>
                                                    ...
                                                    <ContentTemplate>
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <asp:TextBox ID="ddlDistrict" CssClass="form-control validate[required]" TabIndex="17"
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <asp:TextBox ID="ddlTehsil" CssClass="form-control validate[required]" TabIndex="18"
                                                                    runat="server"></asp:TextBox></div>
                                                            <div class="col-md-2">
                                                                Area:</div>
                                                            <div class="col-md-4">
