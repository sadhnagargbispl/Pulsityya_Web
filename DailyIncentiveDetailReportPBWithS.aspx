<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="DailyIncentiveDetailReportPBWithS.aspx.vb" Inherits="App_UI_Application_Pages_DailyIncentiveDetailReportPBWithS"
    Title="" %>
                                            ...
                                            <div style="padding: 10px 10px 20px 10px">
                                                <asp:GridView ID="GrdTotal" Width="100%" runat="server" AllowPaging="false" PageSize="200"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <a href='StatementDailyPB.aspx?PayoutNo=<%#Eval("Sessid")%>&Formno=<%#Eval("IDno")%>' target="_blank" style="color: Blue;">
                                                                    Statement</a>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
