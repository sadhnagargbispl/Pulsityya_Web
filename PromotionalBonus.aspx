<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="PromotionalBonus.aspx.vb" Inherits="App_UI_Application_Pages_PromotionalBonus"
                            ...
                            <div align="center">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <asp:DropDownList ID="ddlAction" runat="server" CssClass="form-control" Style="text-indent: 1px;">
                                ...
                                <div class="col-md-12">
                                    <div style="padding: 10px 10px 20px 10px; overflow: scroll">
                                        <asp:GridView ID="GvActivation" Width="100%" runat="server" RowStyle-Height="25px"
                                            Caption="" CaptionAlign="Top" GridLines="Both" AllowPaging="true" CssClass="table table-bordered"
