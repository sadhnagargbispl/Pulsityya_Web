...
dTree.prototype.node = function(node, nodeId) {
    ...
    if (this.config.useIcons) {
        ...
        if (node.IsBlock != 'Y') {
            ...
            strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=2 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Power</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.leftjoin + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Weaker</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.rightjoin + '</font></td></tr></table></font></td>';
            strTable += '</tr>';
            //			strTable += '<tr>';
            ...
            strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Power</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.leftbv + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Weaker</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.rightbv + '</font></td></tr></table></font></td>';
            ...
            strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Power</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.ActiveDirect + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Weaker</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.ActiveIndirect + '</font></td></tr></table></font></td>';
            ...
            strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Power</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.LeftCarryBv + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Weaker</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.RightCarryBv + '</font></td></tr></table></font></td>';
