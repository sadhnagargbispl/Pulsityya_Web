...
function Node(id, pid, category, doj, UpgradeDate, name, nodename, upliner, sponsor, leftbv, rightbv, DirctLeftActive,DirectRightActive,
url, title, target, icon, iconOpen, open, DirectCMonthEP, InDirectCMonthEP, SelfCMonthEP, DirectPMonthEP, InDirectPMonthEP, SelfPMonthEP, DirectTotalMonthEP, InDirectTotalMonthEP, SelfTotalMonthEP, Mobile) {
	this.id = id;
	this.pid = pid;
	this.name = name;
	this.url = url;
	...
	this.DirectCMonthEP = DirectCMonthEP;
	this.InDirectCMonthEP = InDirectCMonthEP;

	this.SelfCMonthEP = SelfCMonthEP;
	this.DirectPMonthEP = DirectPMonthEP;
	this.InDirectPMonthEP = InDirectPMonthEP;

	this.SelfPMonthEP = SelfPMonthEP;

	this.DirectTotalMonthEP = DirectTotalMonthEP;
	this.InDirectTotalMonthEP = InDirectTotalMonthEP;

	this.SelfTotalMonthEP = SelfTotalMonthEP;
...
dTree.prototype.add = function(id, pid, category, doj, UpgradeDate, name, nodename, upliner, sponsor, leftbv, rightbv, DirctLeftActive, DirectRightActive, url, title, target, icon, iconOpen, open, DirectCMonthEP, InDirectCMonthEP, SelfCMonthEP, DirectPMonthEP, InDirectPMonthEP, SelfPMonthEP, DirectTotalMonthEP, InDirectTotalMonthEP, SelfTotalMonthEP, Mobile) {
this.aNodes[this.aNodes.length] = new Node(id, pid, category, doj, UpgradeDate, name, nodename, upliner, sponsor, leftbv, rightbv, DirctLeftActive, DirectRightActive, url, title, target, icon, iconOpen, open, DirectCMonthEP, InDirectCMonthEP, SelfCMonthEP, DirectPMonthEP, InDirectPMonthEP, SelfPMonthEP, DirectTotalMonthEP, InDirectTotalMonthEP, SelfTotalMonthEP, Mobile);
};
...
dTree.prototype.node = function(node, nodeId) {
    ...
    if (this.config.useIcons) {
        ...
        if (node.icon != 'img/gray.png') {
            ...
            strTable += '<tr>';
            strTable += '<td bgcolor=#277AB1><font color=#FFFFFF FACE=Verdana SIZE=1><strong>Current Month EP</strong></font></td>';
            strTable += '<td><font FACE=Verdana SIZE=1>Direct :' + node.DirectCMonthEP + ', Indirect :' + node.InDirectCMonthEP + ',Self:' + node.SelfCMonthEP + '</font> </td>';
            strTable += '</tr>';

            strTable += '<tr>';
            strTable += '<td bgcolor=#277AB1><font color=#FFFFFF FACE=Verdana SIZE=1><strong>Previous Month EP</strong></font></td>';
            strTable += '<td><font FACE=Verdana SIZE=1>Direct :' + node.DirectPMonthEP + ', Indirect :' + node.InDirectPMonthEP + ',Self:' + node.SelfPMonthEP + '</font> </td>';
            strTable += '</tr>';

            strTable += '<tr>';
            strTable += '<td bgcolor=#277AB1><font color=#FFFFFF FACE=Verdana SIZE=1><strong>Accumulative EP</strong></font></td>';
            strTable += '<td><font FACE=Verdana SIZE=1>Direct :' + node.DirectTotalMonthEP + ', Indirect :' + node.InDirectTotalMonthEP + ',Self:' + node.SelfTotalMonthEP + '</font> </td>';
            strTable += '</tr>';
            ...
            strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Block</td>';
            strTable += '</tr>';
        }
