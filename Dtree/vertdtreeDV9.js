...
function Node(id, pid, category, doj, name, nodename,
    ...
    PerviousMonLeftRBV, PerviousMonRightRbv, AmmLeftRBV, AmRightRbv, LeftRP, RightRP, LeftTodayRp, RightTodayRp) {
    ...
    this.LeftTodayRp = LeftTodayRp;
    this.RightTodayRp = RightTodayRp;
...
dTree.prototype.add = function (id, pid, category, doj, name, nodename, upliner, sponsor, yesshow, leftbv, rightbv, Todayleftunit, Todayrightunit, ActiveDirect, ActiveIndirect, url, title, target, icon, iconOpen, open, leftjoin, rightjoin, level, upgradeDt, Idno, LeftCarryBv, RightCarryBv, IsBlock, BlockStatus, TodayLeftActive, TodayRightActive, TodayLeftJoin, TodayRightJoin, CurrentMonLeftRBV, CurrentMonRightRbv, PerviousMonLeftRBV, PerviousMonRightRbv, AmmLeftRBV, AmRightRbv, LeftRP, RightRP, LeftTodayRp, RightTodayRp) {
...
dTree.prototype.node = function (node, nodeId) {
    ...
    if (this.config.useIcons) {
        ...
        if (node.IsBlock != 'Y') {
            ...
            strTable += '<tr>';
            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Today RP :</font></td>';
            strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Left</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.LeftTodayRp + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Right</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.RightTodayRp + '</font></td></tr></table></font></td>';
            strTable += '</tr>';


            strTable += '<tr>';
            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Total RP :</font></td>';
            strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Left</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.LeftRP + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Right</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.RightRP + '</font></td></tr></table></font></td>';
            strTable += '</tr>';
