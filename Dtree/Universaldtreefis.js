...
function Node(id, pid, category,doj,name, nodename,
                ...
                leftjoin, rightjoin, level, memid, upgradeDt, clevel ) {
...
dTree.prototype.add = function(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, url, title, target, icon, iconOpen, open, leftjoin, rightjoin,memid,  level, upgradeDt, clevel) {

this.aNodes[this.aNodes.length] = new Node(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, url, title, target, icon, iconOpen, open, leftjoin, rightjoin,memid, level, upgradeDt, clevel);
...
//            strTable += '</tr>';
//            
//            strTable+='<tr>'; //			strTable+='<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Sponsor Name</font></td>';  //		    strTable+='</tr>';//		    strTable+='<tr>'; //			strTable+='<td>'+ node.sponsor + '</td>';  //		    strTable+='</tr>';
		...
		strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>'+'FIS' + node.id + '</td>';  
		strTable+='</tr>';
