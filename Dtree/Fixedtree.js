...
var tooltipfonttxt = 'color=#000000 size=2Px family=Verdana'
var tooltipfontlbl = 'color=White size=2Px family=Verdana'
var tooltiptdtxt = 'bgcolor=White'
var tooltiptdlbl = 'bgcolor=#277AB1 width=90px'
...
function Node(id, pid, category,doj,name, nodename,
                ...
                leftjoin, rightjoin, level, upgradeDt, Idno, LeftCarryBv, RightCarryBv, IsBlock, BlockStatus, CurrentLeftPV, CurrentRightPV
                 ,LeftVirtualBv , RightVirtualBv , SelfVirtualBv ) {
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (this.config.useIcons) {
		...
		if (node.upgradeDt != 'undefined' && node.upgradeDt != '') {
		    strTable += '<tr>';
		    strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '><strong>Top Up On</strong></font></td>';
		    strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.upgradeDt + ' </font></td>';
		    strTable += '</tr>';
		}
		strTable+='<tr>';
		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '><strong>Joining Status</strong></font></td>';
			strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=2 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Group A</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.leftjoin + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Group B</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.rightjoin + '</font></td></tr></table></font></td>';  
		strTable+='</tr>';
		    
		
	
		strTable+='<tr>';
		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '><strong>Matching Status</strong></font></td>';
...
//		strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>LEFT :' + node.leftbv + ', RIGHT :' + node.rightbv + '</font> </td>';  
		...
		strTable += '<tr>';
		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '><strong>Active Member</strong></font></td>';
		...
		strTable += '</tr>';
		strTable += '<tr>';
		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '><strong>CarryForward Point</strong></font></td>';
...
//		strTable += '<tr>';
//		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '><strong>Self Virtual BV</strong></font></td>';
//		strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.SelfVirtualBv + ' </font></td>';
//		 strTable += '</tr>';
		...
		{
		strTable+='<tr>';
		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '><strong>Status</strong></font></td>';  
