...
dTree.prototype.node = function(node, nodeId) {
    ...
    if (this.config.useIcons) {
        ...
        strTable += '<tr>';
        strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Current Month BV  :</font></td>';
        ...
        strTable += '<tr>';
        strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Till Prev. Month BV  :</font></td>';
        ...
        strTable += '<tr>';
        strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Total Accumulative BV  :</font></td>';
