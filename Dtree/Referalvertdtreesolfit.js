...
function Node(id, pid, category, doj, UpgradeDate, name, nodename, upliner, sponsor, leftbv, rightbv, DirctLeftActive, DirectRightActive, url, title, target, icon, iconOpen, openz) {
	this.id = id;
	this.pid = pid;
	this.name = name;
	this.url = url;
...
dTree.prototype.node = function(node, nodeId) {
    ...
    if (this.config.useIcons) {
        ...
        if (node.icon != 'img/gray.png') {
            ...
            strTable += '<tr>';
            strTable += '<td bgcolor=#277AB1><font color=#FFFFFF FACE=Verdana SIZE=1><strong>Distributor Name</strong></font></td>';
