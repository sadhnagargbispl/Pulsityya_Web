...
dTree.prototype.add = function(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, Todayleftunit, Todayrightunit, ActiveDirect, ActiveIndirect, url, title, target, icon, iconOpen, open, leftjoin, rightjoin, level, upgradeDt, Idno, LeftCarryBv, RightCarryBv, IsBlock, BlockStatus, TodayLeftActive, TodayRightActive, TodayLeftJoin, TodayRightJoin, CurrentMonLeftRBV, CurrentMonRightRbv, PerviousMonLeftRBV, PerviousMonRightRbv, AmmLeftRBV, AmRightRbv, SelftPv, LeftPv, RightPv, ColName1) {
...
//            strTable += '</tr>';
            ...
            strTable += '<tr>';
            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Total ' + node.ColName1 + ' :</font></td>';
//            ' + node.ColName1 + '
