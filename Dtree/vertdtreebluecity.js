...
function Node(id, pid, category, doj, name, nodename,
                ...
                PerviousMonLeftRBV, PerviousMonRightRbv, AmmLeftRBV, AmRightRbv,SelftPv,LeftPv, RightPv, ColName1,LeftDirect,RightDirect) {
...
dTree.prototype.add = function(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, Todayleftunit, Todayrightunit, ActiveDirect, ActiveIndirect, url, title, target, icon, iconOpen, open, leftjoin, rightjoin, level, upgradeDt, Idno, LeftCarryBv, RightCarryBv, IsBlock, BlockStatus, TodayLeftActive, TodayRightActive, TodayLeftJoin, TodayRightJoin, CurrentMonLeftRBV, CurrentMonRightRbv, PerviousMonLeftRBV, PerviousMonRightRbv, AmmLeftRBV, AmRightRbv, SelftPv, LeftPv, RightPv, ColName1, LeftDirect, RightDirect, Iscompany, iscompanyStatus) {
...
dTree.prototype.node = function(node, nodeId) {
    ...
    if (this.config.useIcons) {
        ...
        if (node.IsBlock != 'Y') {
                ...
                //            strTable += '<tr>';
                //            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Seft ' + node.ColName1 + ' :</font></td>';
                //            strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.SelftPv + '</font></td> ';
                //            strTable += '</tr>';
...
//                strTable += '</tr>';
                ...
                //            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Total  BV :</font></td>';
                ////            ' + node.ColName1 + '
                //            strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Left</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.LeftPv + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Right</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.RightPv + '</font></td></tr></table></font></td>';
                //            //		strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>LEFT :' + node.leftbv + ', RIGHT :' + node.rightbv + '</font> </td>';
...
//                strTable += '</tr>';
                ...
                strTable += '<tr>';
                strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>CarryForward ' + node.ColName1 + ' :</font></td>';
