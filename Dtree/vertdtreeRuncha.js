...
function Node(id, pid, category, doj, name, nodename,
                ...
                PerviousMonLeftRBV, PerviousMonRightRbv, AmmLeftRBV, AmRightRbv,LeftJoining,RightJoining) {
...
this.LeftJoining = LeftJoining;
this.RightJoining = RightJoining;
...
dTree.prototype.add = function(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, Todayleftunit, Todayrightunit, 
ActiveDirect, ActiveIndirect, url, title, target, icon, iconOpen, open, leftjoin, rightjoin, level, upgradeDt, Idno, LeftCarryBv, 
RightCarryBv, IsBlock, BlockStatus, TodayLeftActive, TodayRightActive, TodayLeftJoin, TodayRightJoin, CurrentMonLeftRBV, 
CurrentMonRightRbv, PerviousMonLeftRBV, PerviousMonRightRbv, AmmLeftRBV, AmRightRbv,LeftJoining,RightJoining) {

    this.aNodes[this.aNodes.length] = new Node(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, 
    Todayleftunit, Todayrightunit, ActiveDirect, ActiveIndirect, url, title, target, icon, iconOpen, open, leftjoin, rightjoin, 
    level, upgradeDt, Idno, LeftCarryBv, RightCarryBv, IsBlock, BlockStatus, TodayLeftActive, TodayRightActive, TodayLeftJoin, 
    TodayRightJoin, CurrentMonLeftRBV, CurrentMonRightRbv, PerviousMonLeftRBV, PerviousMonRightRbv, AmmLeftRBV, AmRightRbv,LeftJoining,RightJoining);
...
//            strTable += '</tr>';
        ...
        strTable += '<tr>';
            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Current Status :</font></td>';
            strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Direct :' + node.TodayLeftJoin + ', Indirect :' + node.TodayRightJoin + '</td>';
            strTable += '</tr>';
        
        
        
// strTable += '<tr>';
//            strTable += '<td ><font color=#FFFFFF FACE=Verdana SIZE=1><strong>Current Status</strong></font></td>';
//            strTable += '<td><font FACE=Verdana SIZE=1></font> </td>';
//            strTable += '</tr>';
        /*strTable+='<tr>'; 
