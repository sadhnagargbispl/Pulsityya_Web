...
function Node(id, pid, category,doj,name, nodename,
                ...
                leftjoin, rightjoin, level, upgradeDt, Idno, LeftCarryBv, RightCarryBv, IsBlock, BlockStatus, CurrentLeftPV, CurrentRightPV
                 ,LeftVirtualBv , RightVirtualBv , SelfVirtualBv,rank ) {
...
//		strTable+='<tr>';
//		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '><strong>Rank</strong></font></td>';  
//			strTable+='<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' +node.rank +'</td>';  
//		strTable+='</tr>';
...
strTable+='<tr>'; 
		...
		strTable+='<tr>';
            strTable += '<tr>';
            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Upliner ID :</font></td>';
		...
		if (node.upgradeDt != 'undefined' && node.upgradeDt != '') {
		    strTable += '<tr>';
		    strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '><strong>Activation Date :</strong></font></td>';
		    strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.upgradeDt + ' </font></td>';
		    strTable += '</tr>';
		}
		strTable+='<tr>';
		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '><strong>Total Joining</strong></font></td>';
		...
		strTable+='<tr>';
		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '><strong>Total BV</strong></font></td>';
...
//		strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>LEFT :' + node.leftbv + ', RIGHT :' + node.rightbv + '</font> </td>';  
		...
		strTable += '</tr>';
		strTable += '<tr>';
		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '><strong>CarryForward BV</strong></font></td>';
