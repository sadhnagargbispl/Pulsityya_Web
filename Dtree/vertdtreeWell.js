...
dTree.prototype.node = function(node, nodeId) {
    ...
    if (this.config.useIcons) {
        ...
        strTable += '<tr>';
        strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Current Week BV  :</font></td>';
        ...
        strTable += '<tr>';
        strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Per. Week BV  :</font></td>';
        ...
        strTable += '<tr>';
        strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Royalty BV  :</font></td>';
        strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Left</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>0.00</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Right</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>0.00</font></td></tr></table></font></td>';
        strTable += '</tr>';

        strTable += '<tr>';
        strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Reward BV  :</font></td>';
        strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Left</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>0.00</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Right</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>0.00</font></td></tr></table></font></td>';
        strTable += '</tr>';
