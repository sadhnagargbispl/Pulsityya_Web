...
var tooltipfonttxt = 'color=#000000 size=1Px family=Tahoma'
var tooltipfontlbl = 'color=White size=1Px family=Tahoma Width=30px'
var tooltiptdtxt = 'bgcolor=White size=1Px family=Tahoma'
var tooltiptdlbl = 'bgcolor=#277AB1 width=90px size=2Px family=Tahoma Width=30px'
var tooltiptdtxt1 = 'bgcolor=#ffff00 '
var tooltipfontlbl1 = 'color=Black size=2Px family=Verdana'

function Node(id, pid, category, doj, name, nodename,
                upliner, sponsor, leftbv, rightbv, ActiveDirect, ActiveIndirect, url,
                title, target, icon, iconOpen, open,
                leftjoin, rightjoin, level, upgradeDt, Idno, LeftCarryBv, RightCarryBv, IsBlock, BlockStatus, CurrentLeftPV, CurrentRightPV
                 , LeftVirtualBv, RightVirtualBv, SelfVirtualBv, Profilepic, Totalbv, Currentsessionleftbv, Currentsessionrightbv, Totalcurrentbv,
                 City, Cadre, LeftMatchingBV, RightMatchingBv, LeftRP, RightRP, ActiveDirect1, ActiveIndirect1, leftcyclebv, Rightcyclebv, leftmonthbv, Rightmonthbv, CurrentLeftBv, CurrentRightBv,
                 MonthLeftBv, MonthRightBv, LeftDirect, RightDirect, LeftsesstionPV,RightsesstionPV,Todayleftunit, Todayrightunit,loginIdno,idno1) {
    ...
    this.LeftVirtualBv = LeftVirtualBv;
    this.RightVirtualBv = RightVirtualBv;
    this.SelfVirtualBv = SelfVirtualBv;
    this.Profilepic = Profilepic;
    this.Totalbv = Totalbv;
    this.Currentsessionleftbv = Currentsessionleftbv;
    this.Currentsessionrightbv = Currentsessionrightbv;
    this.Totalcurrentbv = Totalcurrentbv;
    this.City = City;
    this.Cadre = Cadre;
    this.LeftMatchingBV=LeftMatchingBV;
    this.RightMatchingBv = RightMatchingBv;
    this.LeftRP=LeftRP;
    this.RightRP = RightRP;
    this.ActiveDirect1 = ActiveDirect1;
    this.ActiveIndirect1 = ActiveIndirect1;
    //add below 04 April 2022
    this.leftcyclebv=leftcyclebv;
    this.Rightcyclebv=Rightcyclebv;
    this.leftmonthbv=leftmonthbv;
    this.Rightmonthbv = Rightmonthbv;
    this.CurrentLeftBv = CurrentLeftBv;
    this.CurrentRightBv = CurrentRightBv;
    this.MonthLeftBv = MonthLeftBv;
    this.MonthRightBv = MonthRightBv;
    this.LeftDirect = LeftDirect;
    this.RightDirect = RightDirect;
    this.LeftsesstionPV = LeftsesstionPV;
    this.RightsesstionPV = RightsesstionPV;
    this.Todayleftunit = Todayleftunit;
    this.Todayrightunit = Todayrightunit;
    this.loginIdno = loginIdno;
    this.idno1=idno1;
};
...
dTree.prototype.add = function(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, ActiveDirect, ActiveIndirect, url, title, target, icon, iconOpen, open, leftjoin, rightjoin, level, upgradeDt, Idno, LeftCarryBv, RightCarryBv, IsBlock, BlockStatus, CurrentLeftPV, CurrentRightPV
                 , LeftVirtualBv, RightVirtualBv, SelfVirtualBv, Profilepic, Totalbv, Currentsessionleftbv, Currentsessionrightbv, Totalcurrentbv, City, Cadre, LeftMatchingBV, RightMatchingBv, LeftRP, RightRP, ActiveDirect1, ActiveIndirect1, leftcyclebv, Rightcyclebv, leftmonthbv, Rightmonthbv, 
                 CurrentLeftBv, CurrentRightBv, MonthLeftBv, MonthRightBv, LeftDirect, RightDirect, LeftsesstionPV, RightsesstionPV, Todayleftunit, Todayrightunit,loginIdno,idno1) {

    this.aNodes[this.aNodes.length] = new Node(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, ActiveDirect, ActiveIndirect, url, title, target, icon, iconOpen, open, leftjoin, rightjoin, level, upgradeDt, Idno, LeftCarryBv, RightCarryBv, IsBlock, BlockStatus, CurrentLeftPV, CurrentRightPV
                 , LeftVirtualBv, RightVirtualBv, SelfVirtualBv, Profilepic, Totalbv, Currentsessionleftbv, Currentsessionrightbv, Totalcurrentbv, City, Cadre, LeftMatchingBV, RightMatchingBv,
                  LeftRP, RightRP, ActiveDirect1, ActiveIndirect1, leftcyclebv, Rightcyclebv, leftmonthbv, Rightmonthbv, CurrentLeftBv, CurrentRightBv, MonthLeftBv, MonthRightBv, 
                  LeftDirect, RightDirect, LeftsesstionPV, RightsesstionPV, Todayleftunit, Todayrightunit,loginIdno,idno1);
...
if (node.Idno != '(Distributor)')
        ...
        if (node.IsBlock != 'Y') {
            ...
            strTable += '<tr>';
            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Distributor ID:</font></td>';
            strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.Idno + '</td>';
            strTable += '</tr>';

            strTable += '<tr>';
            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Upliner :</font></td>';
            strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.upliner + '</td>';
            strTable += '</tr>';
...
//           	strTable += '<tr>';
//           		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Today BV :</font></td>';
...
//           		//		strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>LEFT :' + node.leftbv + ', RIGHT :' + node.rightbv + '</font> </td>';  
//		     strTable += '</tr>';
//if (node.idno1.trim() === loginIdno.trim()) {
//   
//}
 // Total BV Row
    strTable += '<tr>';
    strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Total BV :</font></td>';
    strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff >'
              + '<tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Left</font></td>'
              + '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.leftbv + '</font></td>'
              + '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Right</font></td>'
              + '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.rightbv + '</font></td>'
              + '</tr></table></font></td>';
    strTable += '</tr>';
    ...
    strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff >'
              + '<tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Left</font></td>'
              + '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.Todayleftunit + '</font></td>'
              + '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Right</font></td>'
              + '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.Todayrightunit + '</font></td>'
              + '</tr></table></font></td>';
    strTable += '</tr>';

//  
//function buildTooltip(node) {
//   //if (parseFloat(node.formno) === parseFloat(loginIdno))  ]
//   //if (node.formno == loginIdno)
//   //if (parseInt(node.Idno) === parseInt(node.loginIdno))
//     var loginIdno = '<%=Session("formno").ToString() & " (" & Session("memName").ToString() & ")" %>';

//    //if (node.Idno.trim() === loginIdno.trim())
//    //var loginIdno= loginIdno.split("(")[0].trim();
//if (node.Idno.trim() === loginIdno){
//        strTable += '<tr>';
//        strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Total BV :</font></td>';
//        strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff >'
//                  + '<tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Left</font></td>'
...
//var loginIdno= loginIdno.split("(")[0].trim();
//if (node.Idno.trim() === loginIdno.split("(")[0].trim()) {
//        strTable += '<tr>';
//        strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Total BV :</font></td>';
//        strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff >'
//                  + '<tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Left</font></td>'
...
//    }
                ...
                strTable += '<tr>';
            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Active Distributor :</font></td>';
...
//            
//            strTable += '<tr>';
//            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Total Direct :</font></td>';
//            //            ' + node.ColName1 + '
//            strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Left</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.LeftDirect + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Right</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.RightDirect + '</font></td></tr></table></font></td>';
//            //		strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>LEFT :' + node.leftbv + ', RIGHT :' + node.rightbv + '</font> </td>';
...
//            
//            strTable += '<tr>';
//            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>CurrentSessnBV :</font></td>';
//            //            ' + node.ColName1 + '
//            strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Left</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.LeftsesstionPV + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Right</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.RightsesstionPV + '</font></td></tr></table></font></td>';
//            //		strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>LEFT :' + node.leftbv + ', RIGHT :' + node.rightbv + '</font> </td>';
...
//            strTable += '</tr>';
        ...
        if (node.pid == -1) {
            ...
            if (node.id > 0 && node.Idno != '(Distributor)')
            { onMouse = '" onMouseOver="ddrivetip(' + strTable + ',' + tootipwidth + ')"' + '" onMouseOut="hideddrivetip()"'; }
            else {
                onMouse = '"';
            }
