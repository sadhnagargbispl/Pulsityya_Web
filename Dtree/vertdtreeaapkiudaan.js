...
function Node(id, pid, category, doj, name, nodename,
                ...
                PerviousMonLeftRBV, PerviousMonRightRbv, AmmLeftRBV, AmRightRbv,SelftPv,LeftPv,RightPv,ColName1) {
...
dTree.prototype.add = function(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, Todayleftunit, Todayrightunit, ActiveDirect, ActiveIndirect, url, title, target, icon, iconOpen, open, leftjoin, rightjoin, level, upgradeDt, Idno, LeftCarryBv, RightCarryBv, IsBlock, BlockStatus, TodayLeftActive, TodayRightActive, TodayLeftJoin, TodayRightJoin, CurrentMonLeftRBV, CurrentMonRightRbv, PerviousMonLeftRBV, PerviousMonRightRbv, AmmLeftRBV, AmRightRbv,SelftPv,Leftpv,RightPv) {
    ...
    if (this.config.useIcons) {
        ...
        if (node.IsBlock != 'Y') {
            ...
            if (node.upgradeDt != 'undefined' && node.upgradeDt != '') {
                strTable += '<tr>';
                //below commit on 04 Feb 2022
                //strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Top Up On :</font></td>'; 
                strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Activation Date :</font></td>';
            ...
            strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=2 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Odd</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.leftjoin + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Even</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.rightjoin + '</font></td></tr></table></font></td>';
            strTable += '</tr>';
            //			strTable += '<tr>';
            ...
            strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Odd</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.LeftPv + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Even</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.RightPv + '</font></td></tr></table></font></td>';
            ...
            strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Odd</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.leftbv + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Even</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.rightbv + '</font></td></tr></table></font></td>';
            //		strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>LEFT :' + node.leftbv + ', RIGHT :' + node.rightbv + '</font> </td>';
            ...
            strTable += '<tr>';
            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Active Associate  :</font></td>';
            strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Odd</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.ActiveDirect + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Even</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.ActiveIndirect + '</font></td></tr></table></font></td>';
            ...
            strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Odd</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.LeftCarryBv + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Even</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.RightCarryBv + '</font></td></tr></table></font></td>';
