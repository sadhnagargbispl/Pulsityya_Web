...
var tooltipfonttxt = 'color=#564300 size=2Px font-family=Calibri'
var tooltipfontlbl = 'color=White size=2Px font-family=Calibri'
...
dTree.prototype.node = function(node, nodeId) {
    ...
    if (this.config.useIcons) {
        ...
        if (node.IsBlock != 'Y') {
            ...
            strTable += '<tr>';
            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Total EP :</font></td>';
          ...
          // 		strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>LEFT :' + node.leftbv + ', RIGHT :' + node.rightbv + '</font> </td>';
            ...
            strTable += '<tr>';
            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>CarryForward EP :</font></td>';
...
//        strTable += '<tr>';
//        strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Current Month REP  :</font></td>';
...
//        strTable += '<tr>';
//        strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Till Prev. Month REP  :</font></td>';
...
//        strTable += '<tr>';
//        strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Total Accumulative REP  :</font></td>';
