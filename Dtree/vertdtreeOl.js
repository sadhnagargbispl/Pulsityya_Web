...
dTree.prototype.node = function(node, nodeId) {
    ...
    if (this.config.useIcons) {
        ...
        if (node.IsBlock != 'Y') {
            ...
            strTable += '<tr>';
            strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Pin Level :</font></td>';
        ...
        strTable += '<tr>';
        strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Current Month  :</font></td>';
        strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Self PV</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.CurrentMonLeftRBV + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Group PV</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.PerviousMonLeftRBV + '</font></td></tr></table></font></td>';
        strTable += '</tr>';

        strTable += '<tr>';
        strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Prev.  Month  :</font></td>';
        strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Self PV</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.CurrentMonRightRbv + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Group PV</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.PerviousMonRightRbv + '</font></td></tr></table></font></td>';
        strTable += '</tr>';


        strTable += '<tr>';
        strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Total  :</font></td>';
        strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Self PV</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.AmmLeftRBV + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Group PV</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.AmRightRbv +'</font></td></tr></table></font></td>';
        strTable += '</tr>';
