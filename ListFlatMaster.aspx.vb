...
Partial Class ListFlatMaster
    ...
    Protected Sub GvData_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GvData.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            If String.Equals(e.Row.Cells(13).Text.ToLower(), "deactive") = True Then
    ...
    Protected Sub DeleteGroup(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim Sql As String = "Update M_projectMaster SET ActiveStatus='N' WHERE Id='" & userID & "' "
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Try
            ...
            Dim Qry As String = "Select ProjectName,Address1 as Address,LongLatitude as Location,VideoLink,Distance1,Distance2,Distance3" & _
            " ,Descriptions,SiteIncharge,Name,Mobileno,Status From V#ProjectMaster Where 1=1 Order by ID Desc"
            dtData = New DataTable
            dtData = objDAL.GetData(Qry)
            ExportToExcel(dtData, "ProjectDetail")
        Catch ex As Exception
    ...
    Protected Sub BtnAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnAdd.Click
        Response.Redirect("FlatMaster.aspx")
    End Sub
