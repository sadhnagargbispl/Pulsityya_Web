...
Partial Class LifeTree
    ...
    Private Sub ValidateTree(ByVal Formno As String)
        ...
        Else
            If CheckDownLineMemberTree(Formno) = False Then
            ...
            strQuery = getQuery(Formno, minDeptLevel)
    ...
    Private Function CheckDownLineMemberTree(ByVal Formno As String) As Boolean
        Dim chk As New Boolean
        chk = False
        strQuery = " Select FormnoDwn FROM M_MemTreeRelation WHERE FormNo=" & Formno
        'Dim conn As New SqlConnection
        'Dim Comm As New SqlCommand
        'Dim Adp1 As SqlDataAdapter
    ...
    Private Function getQuery(ByVal strSelectedFormNo As String, ByVal minDeptLevel As Integer) As String
        ...
        getQuery = "exec sp_ShowTree " & strSelectedFormNo & "," & minDeptLevel
    End Function
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            If DownFormNo <> "" Then
                Response.Redirect("LifeTree.aspx?DownLineFormNo=" & DownFormNo)
            Else
    ...
    Private Function get_FormNo(ByVal IDNo As String) As String
        ...
        Try
            ...
            Dim Str As String = " SP_MemberMaster 'FormNo','IDNo = ''" & IDNo & "''' "
