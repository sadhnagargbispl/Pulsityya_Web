<%@ Page Title="" Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false" CodeFile="CommunityReEntry.aspx.vb" Inherits="CommunityReEntry" %>
                                ...
                                <div align="center">
                                    <div class="col-md-12">
                                        <div class="row">
                                           ...
                                           <div class="col-md-2">
                                                <asp:Label ID="Label3" runat="server" Text="FromDate  "></asp:Label>
                                           ...
                                           <div class="col-md-2">
                                             <asp:Label ID="Label4" runat="server" Text="ToDate  "></asp:Label>
                                            ...
                                            RepeatLayout="Table">
                                          <asp:ListItem Text="Joining" Value="S" Selected="True"></asp:ListItem>
                                          <asp:ListItem Text="With ReEntry" Value="M" ></asp:ListItem>
                                     </asp:RadioButtonList>
                                        </div>
                                        ...
                                        <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="True" PageSize="20"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="SNo.">
                                                 ...
                                                 <asp:BoundField DataField="MemberIDNo" HeaderText="Member IDNo" />
                                                 <asp:BoundField DataField="MemberName" HeaderText="Member Name" />
                                          <asp:BoundField DataField="Statename" HeaderText="State Name" />
                                                 <asp:BoundField DataField="Mobl" HeaderText="Mobile No." />
                             <asp:TemplateField HeaderText="Count">
                                <ItemTemplate>
                                <a href='<%# "ReEntryView.aspx?MemberIDNo="& Eval("MemberIDNo") %>'
                                onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 620,height: 450,marginTop : 0 } )">
                                 <asp:Label ID="Label2" runat="server" ForeColor="Blue" Text='<%# Eval("Count") %>'></asp:Label></a>
                                </ItemTemplate>
                            </asp:TemplateField>
