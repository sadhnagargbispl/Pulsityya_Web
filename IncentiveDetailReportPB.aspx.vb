...
Partial Class App_UI_Application_Pages_IncentiveDetailReportPB
    ...
    Private Sub IncentiveSummary(ByVal PageIndex As Integer)
        Try
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetWeeklyPayoutSummaryPB", prms)
    ...
    Private Sub IncentiveDetail(ByVal Sessid As Integer, ByVal PageIndex As Integer)
        Try
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetWeeklyPayoutDetailPB", prms)
