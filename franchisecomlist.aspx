<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false" CodeFile="franchisecomlist.aspx.vb" Inherits="franchisecomlist" %>
                            ...
                            <div align="center">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                        <asp:CheckBox ID="franchise" runat="server" Text="Choose franchise Id:" />
                                        <asp:TextBox ID="Txtfraid" runat="server" class="form-control"></asp:TextBox></div>
                                    <div class="col-md-2" style="padding-top: 0.7%">
                                        PageSize:
                                        ...
                                        <div id="gvContainer" runat="server" class="col-md-12">
                                            ...
                                            <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="IdNo" HeaderText="IdNo." ControlStyle-Width="50px" SortExpression="franchiseid" />
                                                     <asp:BoundField DataField="franchiseid" HeaderText="Franchise Id." ControlStyle-Width="50px" SortExpression="Idno" />
                                                    <asp:BoundField DataField="Name" HeaderText="Member Name" SortExpression="MemName" />
                                                   ...
                                                   <asp:BoundField DataField="KitAmount" HeaderText=" Package Amount" SortExpression="KitAmount" />
                                                    <asp:BoundField DataField="Commission" HeaderText="Commission" SortExpression="Comm" />
                                                     <asp:BoundField DataField="Activation date" HeaderText="Activation date" SortExpression="ActivationDate" />
                                                </Columns>
                                            </asp:GridView>
