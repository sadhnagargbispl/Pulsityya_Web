...
<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Fixedtree.aspx.vb" Inherits="Fixedtree" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
	...
	<%--	<link href="dtree/dtree.css" type="text/css" rel="stylesheet" />--%>
       ...
       <script type="text/javascript" src="js/Dtree/vertdtree2.js"></script>

        <%--<script src="js/Dtree/dtree1.js" type="text/javascript"></script>--%>
       <%-- <script src="js/dtree.js" type="text/javascript"></script>--%>
		<%--<script src="dtree/dtree.js" type="text/javascript"></script>--%>
    <%--    <script src="js/vertdtree.js" type="text/javascript"></script>--%>
             ...
             <div style="vertical-align:top;position:absolute;top:8px;left:0px;">
              <table cellpadding="0" cellspacing="1" border="0" width="350px" style="vertical-align:top">
			        <tr style="font-weight: bold; font-size: 10px; font-family: Verdana;">
				        ...
				        <td>
					      <asp:Button id="cmdSave1" runat="server" Text="Submit" />
				        </td>
				        <td>
					         <asp:Button id="cmdBack" runat="server" Text="Home" />
				        </td>
			      <%-- <td><asp:Button ID="BtnStepAbove" runat="server" Text="1 Step Above"
		        ...
		        <td colspan="8">
			        ...
			        <tr style="font-weight: bold; font-size: 10px;">
                      ...
                      <center>		
                                ...
                                <iframe name="TreeFrame" frameborder="0" scrolling="auto" id="TreeFrame" runat="server"></iframe>
                            </div>--%>
		    </div>
		</center> 	     
    </form>
