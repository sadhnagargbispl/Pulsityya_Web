<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false"
    CodeFile="KYCVERIFYWITHPDFUPDATE.aspx.vb" Inherits="KYCVERIFYWITHPDFUPDATE" Title="" %>
                                ...
                                <div class="col-md-12" style="overflow: scroll">
                                    ...
                                    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                        ...
                                        <Columns>
                                            ...
                                            <%-- ===================== COMPANY KYC columns (sirf 1108 - code se Visible on) ===================== --%>
                                            <%-- Index 26..31. Aadhaar front/back to upar Front/Back Address Proof me, Auth Aadhaar No "Address Proof No" me aata hai. --%>
                                            <asp:BoundField DataField="CompBillNo" HeaderText="Bill No." Visible="false" />
                                            <asp:TemplateField HeaderText="Light Bill" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <a href='<%# "Img.aspx?ID=" & Eval("FormNo") & "&Type=CompBill" %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width:500,height:500,marginTop : 50 } )">
                                                        <asp:Image ID="ImgCompBill" Width="50px" Height="50px" runat="server" ImageUrl='<%# Eval("CompBillImg") %>'
                                                            Visible='<%# Eval("CompBillImg").ToString() <> "" %>' />
                                                    </a>
                                                    <br />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="CompGstNo" HeaderText="GST No." Visible="false" />
                                            <asp:TemplateField HeaderText="GST Certificate" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <a href='<%# "Img.aspx?ID=" & Eval("FormNo") & "&Type=CompGst" %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width:500,height:500,marginTop : 50 } )">
                                                        <asp:Image ID="ImgCompGst" Width="50px" Height="50px" runat="server" ImageUrl='<%# Eval("CompGstImg") %>'
                                                            Visible='<%# Eval("CompGstImg").ToString() <> "" %>' />
                                                    </a>
                                                    <br />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="CompOtherNo" HeaderText="Other No." Visible="false" />
                                            <asp:TemplateField HeaderText="Other Proof" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                <ItemTemplate>
                                                    <a href='<%# "Img.aspx?ID=" & Eval("FormNo") & "&Type=CompOther" %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width:500,height:500,marginTop : 50 } )">
                                                        <asp:Image ID="ImgCompOther" Width="50px" Height="50px" runat="server" ImageUrl='<%# Eval("CompOtherImg") %>'
                                                            Visible='<%# Eval("CompOtherImg").ToString() <> "" %>' />
                                                    </a>
                                                    <br />
                                                </ItemTemplate>
                                            </asp:TemplateField>
