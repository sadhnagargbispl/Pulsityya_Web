...
Partial Class RankAchieverNPReport
    ...
    Private Sub ExportExcel()
        ...
        Using wb As New XLWorkbook()
            wb.Worksheets.Add(dt, "RankAchiever")
            Response.Clear()
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            prms(1) = New SqlParameter("@RankType", AcType)
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetRankAchieverDetail", prms)
