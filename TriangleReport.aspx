<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="TriangleReport.aspx.vb" Inherits="App_UI_Application_Pages_TriangleReport"
    ...
    <div style="background-color: White ">
        <table width="100%" cellspacing="10px" align="left" style="margin: 20px; padding: 0px;">
            ...
            <tr>
                ...
                <td  style="height:5%; width:5%">
                <asp:CheckBox ID="ChkSearch" runat="server" Text="Sponsor Id" TextAlign ="Left"  />
          
               <asp:TextBox Id="TxtSearch" runat="server" CssClass ="TxtBox " Width="200px"></asp:TextBox>
                </td>
                <td style="padding-top :20px; width:5%">
                  <asp:Label ID="lblStartDate" runat="server" Text="Choose Start Date : "></asp:Label>
                    <asp:TextBox ID="txtStartDate" runat="server" CssClass="TxtBox" Width="200px"></asp:TextBox>
                ...
                <td style="padding-top :20px; width:5%">
                   <asp:Label ID="lblEndDate" runat="server" Text="Choose End Date : "></asp:Label>
                    <asp:TextBox ID="txtEndDate" runat="server" CssClass="TxtBox" Width="200px"></asp:TextBox>
...
<a class="btn btn-primary" href='<%# "ViewTriangleDetail.aspx?Idno="&  Eval("SponsorId")&"&PanNo="&Eval("Panno")  %>'   onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 700,height: 450,marginTop : 0 } )" ><i class="icon_plus_alt2"></i>
