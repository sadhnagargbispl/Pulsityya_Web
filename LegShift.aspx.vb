Imports System.Data
Partial Class App_UI_Application_Pages_LegShift
    ...
    Protected Sub BtnLegShift_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnLegShift.Click
        Try
            ...
            Else
                ...
                Sql = " Select * From M_MemberMaster WHERE LegNo='" & Val(RbLeg.SelectedValue) & "' AND UplnFormNo='" & Val(TxtFormNos.Text) & "'"
    ...
    Private Sub Leg_Shift()
        Try
            ...
            Sql = "Begin Transaction Exec LegShift_NJ '" & Val(TxtFormNo.Text) & "','" & Val(TxtFormNos.Text) & "','" & RbLeg.SelectedValue & "' Commit Transaction"
