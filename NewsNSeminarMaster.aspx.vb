...
Partial Class App_UI_Application_Pages_NewsNSeminarMaster
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Session("AStatus") = "OK" Then
            ...
            Session("PageName") = "Master / News Master"
        Else
    ...
    Protected Sub DeleteNews(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim Sql As String = "Update " + objDAL.tblNewsMaster + " SET ActiveStatus='N',LastModified='De-Activated by " & Session("UserName") & " at " & DateTime.Now.ToString() & "' WHERE NewsId='" & NewsID & "' AND RowStatus='Y'"
        ...
        End If
        ScriptManager.RegisterClientScriptBlock(Me.Page, Me.[GetType](), "AchiverName Deletion", scrname, False)
        BindData()
    End Sub
            ...
            If String.Equals(ddlSearchFields.SelectedItem.Text.ToLower(), "status") = True Then
                If String.IsNullOrEmpty(txtSearch.Text) = False Then
                    ...
                    Else
                        status = "Y"
                    End If
                    sql = " Select a.Type,Cast(b.NewsId as varchar) as VNewsId,b.NewsHdr,b.NewsDtl,dbo.FormatDate(b.FrmDate,'dd-MM-yyyy') as FrmDate,dbo.FormatDate(ToDate,'dd-MM-yyyy') as ToDate,b.Remarks,b.NewsId  ,CASE WHEN b.ActiveStatus='Y' Then 'Active' ELSE 'DeActive' END AS Status From " + objDAL.tblNewsTypeMaster + " as a," + objDAL.tblNewsMaster + " as b Where a.Prefix=b.Ntype AND b.RowStatus='Y' AND b.ActiveStatus like '%" + status.ToString() + "%' Order by NewsHdr"
                End If
            Else
                sql = "Select a.Type,Cast(b.NewsId as varchar) as VNewsId,b.NewsHdr,b.NewsDtl,dbo.FormatDate(b.FrmDate,'dd-MM-yyyy') as FrmDate,dbo.FormatDate(ToDate,'dd-MM-yyyy') as ToDate,b.Remarks,b.NewsId  ,CASE WHEN b.ActiveStatus='Y' Then 'Active' ELSE 'DeActive' END AS Status From " + objDAL.tblNewsTypeMaster + " as a," + objDAL.tblNewsMaster + " as b Where a.Prefix=b.Ntype AND b.RowStatus='Y' AND b." + ddlSearchFields.SelectedValue.ToString() + " like '%" + txtSearch.Text + "%' Order by NewsHdr"
            End If
            dtData = New DataTable
            dtData = objDAL.GetData(sql)
            GvData.DataSource = dtData
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Response.AddHeader("content-disposition", String.Format("attachment; filename={0}", "NewsNSeminarDetails.xls"))
