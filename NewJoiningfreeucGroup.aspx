<%@ Page Title="" Language="C#" MasterPageFile="~/SitePage.master" AutoEventWireup="true" CodeFile="NewJoiningfreeucGroup.aspx.cs" Inherits="NewJoiningfreeucGroup" %>
            ...
            <div class="row">
                            ...
                            <div class="row g-1">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                    ...
                                    <div class="form-group" id="rwSpnsr" runat="server">
                                        ...
                                        <asp:Label ID="lblUplnrNm" runat="server" Style="color: #1faf45; font-weight: bolder;"></asp:Label>
                                    </div>
                                    <%-- </ContentTemplate>
                                    <Triggers>
                                    ...
                                    <div class="form-group" runat="server" id="DivVVRanta" visible="false">
                                        ...
                                        <%--     <asp:TextBox ID="TxtUserName" class="form-control" runat="server" TabIndex="6" ValidationGroup="eInformation"
                                            autocomplete="off" CssClass="form-control" AutoPostBack="true" OnTextChanged="TxtUserName_TextChanged"></asp:TextBox>--%>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                    <ContentTemplate>--%>
                                    <style>
                                        .leg-radio-group input[type="radio"] {
                                            margin-right: 5px;
                                        }

                                        .leg-radio-group label {
                                            margin-right: 30px; /* ← Yahan gap badhayen ya ghatayen */
                                            cursor: pointer;
                                        }
                                    </style>
                                    ...
                                    <div class="form-group greybt" id="divFName" runat="server">
                                        <label class="form-label">
                                            Father/Husband's Name <span class="red">*</span></label>
                                        <div class="row">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-10" style="padding-left: 0px;">
                                                <asp:TextBox ID="txtFNm" runat="server" TabIndex="8" class="form-control validate[required]"
                ...
                Permanent Address</h5>--%>
                                    ...
                                    <div class="form-group " id="divMobile" runat="server">
                                        <%--<%=IIf(Session("DivMobile").ToString().Split("|")(4) = "Y", "<div style='display:block'>", "<div style='display:none'>")%>--%>
                                        <label class="form-label">
                                    ...
                                    <div class="form-group greybt" visible="true" runat="server">
                                        ...
                                        <%-- <asp:RequiredFieldValidator ID="rfvValidator" runat="server" Enabled="False" ControlToValidate="txtEMailId"
                                    ...
                                    <div id="divlogin" runat="server" visible="false">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div>
                                                <asp:TextBox ID="TxtConfirmPasswd"
                                                    runat="server"
                                                    CssClass="form-control"
                                                    TextMode="Password"
                                                    ClientIDMode="Static"
                                                ...
                                                <i class="fa fa-eye fa-eye field_icon" aria-hidden="true" style="transform: translateY(-190%); float: right; padding-right: 10px;" id="toggle_pwd1"></i>
                                                <asp:Label ID="lblPassMsg"
                                                    runat="server"
                                                    ClientIDMode="Static">
                                                </asp:Label>
...
E mail: dv9wellness@gmail.com
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <font face="Verdana" color="#000000" size="1"><b>I Agree With
                                                <asp:Literal ID="ltrTerms" runat="server"></asp:Literal>
                                                <%--<a href="DIRECT_SELLER_CONTRACT.html" target="_blank">
