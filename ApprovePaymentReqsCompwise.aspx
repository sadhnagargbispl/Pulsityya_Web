<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false"
    CodeFile="ApprovePaymentReqsCompwise.aspx.vb" Inherits="ApprovePaymentReqsCompwise"
    Title="" %>
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            <div>
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <asp:Label ID="Label4" runat="server" Text="filter option: "></asp:Label>
                                        <asp:DropDownList ID="DDlFilterOption" runat="server" class="form-control" AutoPostBack="true">
                                            <asp:ListItem Selected="True" Value="A">All</asp:ListItem>
                                            <asp:ListItem Value="O">By Other</asp:ListItem>
                                            <asp:ListItem Value="B">By Bank</asp:ListItem>
                                            <asp:ListItem Value="C">Req No</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-md-3" id="Requestno" runat="server" visible="false">
                                        <asp:Label ID="Label5" runat="server" Text="Request No: "></asp:Label>
                                        <asp:TextBox runat="server" ID="txtreqno" class="form-control"></asp:TextBox>
                                    </div>
                                    ...
                                    <div style="margin-top: 15px; overflow: scroll;">
                                        ...
                                        <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ChqNo" HeaderText="TXN no."></asp:BoundField>
                                                <asp:BoundField DataField="ChequeDate" HeaderText="TXN Date"></asp:BoundField>
                                               ...
                                               <%-- <asp:BoundField DataField="txnhash" HeaderText="Hash"></asp:BoundField>--%>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <a href='<%# "Imgcompwise.aspx?&type=Payment&ID=" & Eval("Reqno") %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 785,height: 580,marginTop : 0 } )">
