...
Partial Class BannerMaster
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Session("AStatus") = "OK" Then
            Session("PageName") = "Master / Banner Master"
        Else
    ...
    Public Sub BindData()
        Try
            ...
            Dim sql As String = "Select Bannerid,Cast(Bannerid as varchar) as VBannerCode,'" & Session("AdminWeb") & "'+ImagePath as Imgpath,remark,CASE WHEN ActiveStatus='Y' Then 'Active' ELSE 'DeActive' END AS Status, " & _
            " Case when ActiveStatus='N' then 'label label-danger' else 'label label-success' end as StatusClass  From M_BannerMaster Where ActiveStatus='Y' Order by Bannerid"
            dtData = New DataTable
            dtData = objDAL.GetData(sql)
            GvData.DataSource = dtData
            GvData.DataBind()
            Session("GData") = dtData
            ViewState("WithDrawDate") = "Bannerid"
    ...
    Protected Sub DeleteGroup(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim Sql As String = "Update M_BannerMaster SET ActiveStatus='N' WHERE Bannerid='" & Val(BankCode.ToString()) & "'"
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Response.AddHeader("content-disposition", String.Format("attachment; filename={0}", "BannerDetails.xls"))
