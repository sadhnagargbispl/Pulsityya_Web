<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="MemberProfileGH.aspx.vb" Inherits="App_UI_Application_Pages_MemberProfileGH"
                        ...
                        <div class="col-md-12">
                            <div align="center">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        Join Type:
                                        <asp:DropDownList ID="ddljointype" runat="server" class="form-control">
                                            <asp:ListItem Text="--ALL--" Value="A" />
                                            <asp:ListItem Text="Normal" Value="N" />
                                            <asp:ListItem Text="Social" Value="S" />
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-md-3">
                                        PageSize:
                                                ...
                                                <div id="gvContainer" runat="server" class="table table-bordered" style="overflow: scroll">
                                                    ...
                                                    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="JoinType" HeaderText="JoinType" SortExpression="JoinType" />
                                                            ...
                                                            <%--<asp:BoundField DataField="UplinerId" HeaderText="Placement Id" SortExpression="UplinerId" />
                                                            <asp:BoundField DataField="Uplinername" HeaderText="Placement Name" SortExpression="Uplinername" />--%>
