<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="FundWithdrawDateWise.aspx.vb" Inherits="App_UI_Application_Pages_FundWithdrawDateWise" %>
                                ...
                                <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="True" PageSize="200"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Wallet Type">
                                            <ItemTemplate>
                                                <asp:Label ID="LblWalletType" runat="server" Text='<%# Eval("WalletType") %>'></asp:Label></ItemTemplate>
                                        </asp:TemplateField>
