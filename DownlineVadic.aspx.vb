...
Partial Class DownlineVadic
    ...
    Private Sub FillDownlineSumm(ByVal FormNo As String)
        Try
            ...
            " Isnull(sum(Temp.LegXBVPaid),0) as LegXBVPaid,IsnUll(sum(Temp.LegYBvPaid),0) as LegYBVPaid,IsnUll(sum(Temp.LeftRBV),0) as LeftRBV,IsnUll(sum(Temp.RightRBV),0) as RightRBV,IsnUll(sum(Temp.SelfBv),0) As SelfBv From(" & _
            " Select Isnull(sum(PVValue),0) as LeftBV,0 as RightBV,0 as LegXBVCF,0 as LegYBvCF,0 as LegXBVPaid,0 as LegYBVPaid,0 as LeftRBV,0 as RightRBV,0 As SelfBv FROM RepurchIncome as a,M_MemTreeRelation as b  WHERE " & _
            " a.Formno=b.FormnoDwn and a.BillType<>'R' and b.LegNo='1' and " & _
            " b.FormNo=" & FormNo & "" & Condition2 & " " & _
            " Union ALL" & _
             " Select 0 as LeftBV,Isnull(sum(PvValue),0) as RightBV,0 as LegXBVCF,0 as LegYBvCF,0 as LegXBVPaid,0 as LegYBVPaid,0 as LeftRBV,0 as RightRBV,0 As SelfBv FROM RepurchIncome as a,M_MemTreeRelation as b  WHERE " & _
            " a.Formno=b.FormnoDwn and a.BillType<>'R' and b.LegNo='2' and " & _
            " b.FormNo=" & FormNo & "" & Condition2 & "" & _
            " Union All " & _
            " select 0 as LeftBv,0 as RightBV,0 as LegXBvCF,0 as LegYBVCF, Isnull(WkrLegBv,0)  as LegXBVPaid,0 as LegYBVPaid,0 as LeftRBV,0 as RightRBV,Isnull(SelfBv,0) As SelfBv from M_SesswiseBv  " & _
            " where Formno='" & FormNo & "' " & Condition3 & "" & _
            " Union All " & _
            " select 0 as LeftBv,0 as RightBV,Isnull(LegXBvCF,0) as LegXBvCF,Isnull(LegYBVCF,0) as LegYBVCF,0 as LegXBVPaid,0 as LegYBVPaid,0 as LeftRBV,0 as RightRBV,0 As SelfBv from M_SesswiseBv  " & _
            " where Formno='" & FormNo & "' " & Condition3 & "" & _
            " Union All " & _
            " Select 0 as LeftBV,0 as RightBV,0 as LegXBVCF,0 as LegYBvCF,0 as LegXBVPaid,0 as LegYBVPaid,Isnull(sum(PvValue),0) as LeftRBV,0 as RightRBV,0 As SelfBv FROM RepurchIncome as a,M_MemTreeRelation as b  WHERE " & _
            " a.Formno=b.FormnoDwn and a.BillType='R' and b.LegNo='1' and " & _
            " b.FormNo=" & FormNo & "" & Condition2 & " " & _
            " Union ALL" & _
             " Select 0 as LeftBV,0 as RightBV,0 as LegXBVCF,0 as LegYBvCF,0 as LegXBVPaid,0 as LegYBVPaid,0 as LeftRBV,Isnull(sum(PvValue),0) as RightRBV,0 As SelfBv FROM RepurchIncome as a,M_MemTreeRelation as b  WHERE " & _
            " a.Formno=b.FormnoDwn and a.BillType='R' and b.LegNo='2' and " & _
            " b.FormNo=" & FormNo & "" & Condition2 & "" & _
            ") as Temp"
            ...
            If Dt.Rows.Count > 0 Then
                ...
                LblLeftRBV.InnerText = Dt.Rows(0)("LeftRBV")
                LblRightRBV.InnerText = Dt.Rows(0)("RightRBV")
                LblSelfBv.InnerText = Dt.Rows(0)("SelfBv")
...
" where formno=" & Val(formNo.ToString()) & "  and LegNo='2' and ActiveStatus='N' " & Condition2 & ") as Temp"
            ...
            If rbleg.SelectedValue = "0" Or rbleg.SelectedValue = "1" Then
                ...
                strquery = "select top(100)*,doj +' '+JoiningTime  as DateofJoining,TopupDate+ ' '+TopUpTime as TopUp  from V#Downline where formno=" & Val(formNo.ToString()) & " and LegNo='1' " & Condition2 & "  Order by JoinDate"
            ...
            If rbleg.SelectedValue = "0" Or rbleg.SelectedValue = "2" Then
                strquery = "select Top(100)*,doj +' '+JoiningTime  as DateofJoining,TopupDate+ ' '+TopUpTime as TopUp  from V#Downline where formno=" & Val(formNo.ToString()) & " and LegNo='2' " & Condition2 & " order by JoinDate"
    ...
    Protected Sub BtnExportB_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnExportB.Click
        ...
        Dim str As String = "select top 100 IDNO,MemName as MemberName,RefFormno as SponsorId,ReferalName as SponsorName,doj as Doj,JoiningTime,TopUpDate ,TopUpTime, KitName as Package,KitAmount as PackageAmount,Bv as Unit  from V#Downline where formno=" & Val(formNo.ToString()) & " and LegNo='2' " & cond & " order by JoinDate"
    ...
    Protected Sub BtnExportA_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnExportA.Click
        ...
        End If
        ''Sponsor as UplinerId,SponsorName as UplinerName,
        Dim str As String = "select top 100 IDNO,MemName as MemberName,RefFormno as SponsorId,ReferalName as SponsorName,doj as Doj,JoiningTime,TopUpDate ,TopUpTime, KitName as Package,KitAmount as PackageAmount,Bv as Unit    from V#Downline where formno=" & Val(formNo.ToString()) & " and LegNo='1' " & cond & " order by JoinDate"
