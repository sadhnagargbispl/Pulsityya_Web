<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Add100percent.aspx.vb" Inherits="App_UI_Application_Pages_Add100percent"
     %>
                               ...
                               <%-- <div class="col-md-12" style="padding-top: 3%">
                                ...
                                <div class="col-md-12" style="padding-top: 3%" id="PLoanPercent" runat="server" >
                                    ...
                                    <div class="col-md-12" style="padding-top: 3%">
                                        ...
                                        <div class="col-md-12" style="padding-top :3%; display:none ">
                                    <div class="col-md-4">
                                        Status :</div>
                                    <div class="col-md-6">
