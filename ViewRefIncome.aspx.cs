...
public partial class ViewRefIncome : System.Web.UI.Page
{
    ...
    public void BindData(string SrchCond = "")
    {
        try
        {
            ...
            string sql1 = "";
            if (Request["pagetype"].ToString() == "REFLEVEL")
            {
                sql1 = objDAL.IsoStart + " Exec SP_RefferalLevelIncome '" + Session["formno"] + "', '" + Request["Sessid"] + "' " + objDAL.IsoEnd;
            }
            else
            {
                sql1 = objDAL.IsoStart + " Exec SP_RefferalIncome '" + Session["formno"] + "', '" + Request["Sessid"] + "' " + objDAL.IsoEnd;
            }
