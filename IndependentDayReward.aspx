<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="IndependentDayReward.aspx.vb" Inherits="IndependentDayReward" %>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>
                            Independent Day Bonanza Reward
                        </h2>
                        <div class="clearfix">
                        </div>
                    </div>
                            ...
                            <div class="table-responsive makeitresponsivegrid" style="min-height: 500px;">
                                <div align="center">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <asp:Label ID="Label2" runat="server" Text="Reward "></asp:Label>
