<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="Downline.aspx.vb" Inherits="Downline1" %>
                ...
                <div class="x_panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            <div align="center">
                                <div class="col-md-12">
                                <div class="col-md-2"> Enter Member ID :</div> 
                                <div class="col-md-3">
...
<div class="col-md-3">
    ...
    <asp:DropDownList ID="CmbKit" runat="server" class="form-control"></asp:DropDownList>
   </div>
   <div class="col-md-2">
   <% If Session("CompId")="1081" Then %>
   <asp:RadioButtonList AutoPostBack="True" ID="rbleg1" RepeatDirection="Horizontal"
   ...
   <div class="col-md-3">
   <br />
      <asp:RadioButtonList ID="RbtSearch" runat="server" AutoPostBack="true" RepeatColumns ="2" RepeatDirection ="Horizontal"  >
    <asp:ListItem Text="Date wise" Value="D" Selected ="True"></asp:ListItem>
    <asp:ListItem Text="Session Wise" Value="S"></asp:ListItem> </asp:RadioButtonList>
   </div>
   <div class="col-md-3">
   <br />
    ...
    <asp:DropDownList ID="DDLSession" runat="server" class="form-control" Visible="false"></asp:DropDownList>
         <asp:Label ID="LblSDate" runat="server" Visible="false"></asp:Label>
              ...
              <asp:Label ID="LblToDate" runat="server" Visible ="false" ></asp:Label>
               ...
               <div class="col-md-3">
                ...
                <div class="col-md-3"> <asp:Button ID="btnShowDownline" class="btn btn-primary"  runat="server" Text="Show Downline Report" ValidationGroup="Save"  />
                </div>
                <div class="col-md-9"><asp:Label ID="lblError" runat="server" Text="" ForeColor="Red" Visible="false" Font-Size="13px"></asp:Label></div>
           ...
           <center>
            <div align="center">
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td>
                            <table class="Table-lblNew" cellspacing="2" cellpadding="2" width="700">
                                <tbody>
                                    <tr valign="top">
                                        <td class="box-body1-clear" align="center" colspan="5">
                                            Status</td>
                                    </tr>
                                     <tr valign="top">
                                        <td class="box-body1-clear" align="center" colspan="2" style="width:40%; ">
                                            Member Status</td>
                                            <td class="box-body1-clear" align="center" style="width:20%; border :1px solid black; border-bottom :0"></td>
                                             <td class="box-body1-clear" align="center" colspan="2" style="width:40%">
                                           Carry Forward</td>
                                    </tr>
                                     <tr valign="top">
                                 ...
                                 Left
                                    ...
                                    <tr valign="top">
                                        <td align="center" style="padding :10px; border :1px solid black; border-bottom :0;border-top:0" >
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                ...
                <tr>
                    <td ><asp:Label id="Leftactive" Font-Bold="true" runat="server"></asp:Label>
                    </td>
                    <td ><asp:Label id="LeftDeactive" Font-Bold="true" runat="server"></asp:Label>
                    </td>
                </tr>
                <tr class="tr-1">
                        ...
                        <div id="DivSideA" runat="server">
                            <table border="0" width="100%" cellspacing="2" cellpadding="0">
                                ...
                                <asp:DataGrid ID="GrdDirects1" runat="server" class="table table-bordered" RowStyle-Height="25px" 
                                            ...
                                            Width="100%" ShowHeader="true" PageSize="5" EmptyDataText="No data to display." GridLines ="Both" HeaderStyle-CssClass="bg-primary">
                                 <Columns>
                                 <asp:TemplateColumn >
                                 <ItemTemplate ><%#Container.DataSetIndex + 1%>. </ItemTemplate></asp:TemplateColumn>
                                              ...
                                              <%--  <asp:BoundColumn DataField="Sponsor" HeaderText="Upliner ID" >
                                                ...
                                                <asp:BoundColumn DataField="Topup" HeaderText="Topup Date" >
                                                 ...
                                                 <asp:BoundColumn DataField="Mobl" HeaderText="Mobile No" >
                                                    <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
                                                </asp:BoundColumn>
                                                 <asp:BoundColumn DataField="Address" HeaderText="Address" >
                                                  ...
                                                  <asp:BoundColumn DataField="KitAmount" HeaderText="Pkg. MRP" ></asp:BoundColumn>
                                                    <asp:BoundColumn DataField="BV" HeaderText="BV" ></asp:BoundColumn>
                                            </Columns>
                                   ...
                                   <tr>
                                    <td align="left" valign="top">
                                        <asp:Button ID="BtnExportA" runat="server" Text="Export to Excel" class="btn btn-primary" style="margin-left: 400px;" />
                                    </td>
                                </tr>
                            </table>
                        </div>
                ...
                <tr id="trRightHeading" runat="server">
                    ...
                    <tr>
                    <td ><asp:Label id="RActive" Font-Bold="true" runat="server"></asp:Label>
                    </td>
                    <td ><asp:Label id="RDeactive" Font-Bold="true" runat="server"></asp:Label>
                    </td>
                </tr>
                </tr>
                <tr class="tr-1">
                        ...
                        <div id="DivSideB" runat="server">
                            <table border="0" width="100%" cellspacing="2" cellpadding="0">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td align="left" valign="top">
                                        <asp:Button ID="BtnExportB" runat="server" Text="Export to Excel" class="btn btn-primary" style="margin-left: 400px;" />
                                    </td>
                                </tr>
                            </table>
                        </div>
