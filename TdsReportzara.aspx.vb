...
Partial Class App_UI_Application_Pages_TdsReportzara
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Session("AStatus") = "OK" Then
            Session("PageName") = "Report  / Tds Report"
        Else
    ...
    Private Function Check_IdNo() As String
        Try
    ...
    Public Sub BindSession()
        Try
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetmonthSession")
    ...
    Private Sub IncentiveDetail(ByVal Sessid As Integer, ByVal PageIndex As Integer)
        Try
            ...
            prms(0) = New SqlParameter("@Sessid", Convert.ToInt32(Sessid))
            prms(1) = New SqlParameter("@IdNo", Convert.ToString(Idno).ToLower())
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "TDS_Report", prms)
            ...
            'Me.PopulatePager(Sessid, PageIndex)
        Catch ex As Exception
    ...
    Private Sub ExportExcel()
        ...
        Using wb As New XLWorkbook()
            ...
            Response.AddHeader("content-disposition", "attachment;filename=TDSReport.xlsx")
