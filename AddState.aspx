<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddState.aspx.vb" Inherits="App_UI_Application_Pages_AddState" %>
                                ...
                                <div class="col-md-12" style="padding-top: 1%">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" Display="Dynamic" ControlToValidate="ddlcountry"
                                            runat="server" ValidationGroup="Save" InitialValue="---Seelct Country---">*</asp:RequiredFieldValidator>
                                    </div>
                                    <div class="col-md-6">
                                    </div>
                                </div>
