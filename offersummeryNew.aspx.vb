...
Partial Class App_UI_Application_Pages_offersummeryNew
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Session("AStatus") = "OK" Then
            Session("PageName") = " Report / Offer Report"
    ...
    Protected Sub GvData_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles GvData.PageIndexChanging
        ...
        GvData.DataSource = Session("RewardListNew")
        GvData.DataBind()
    End Sub
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Try
            ...
            prms(0) = New SqlParameter("@offerno", ddloffer.SelectedValue)
            ...
            'Ds = SqlHelper.ExecuteDataset(constr, "Sp_GeOfferId", prms)
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "Sp_GetOfferId", prms)
            'str = "Exec Sp_GeOfferId '" & ddloffer.SelectedValue & "',1,'" & ddlPageSize.SelectedValue & "','Y','" & ParameterDirection.Output & "'"
            'Ds = objDAL.GetData(str)
            Session("RewardList1") = Ds.Tables(0)
            ExportExcel()
        Catch ex As Exception
    ...
    Private Sub ExportExcel()
        Dim dt As DataTable = Session("RewardList1")
        Using wb As New XLWorkbook()
            wb.Worksheets.Add(dt, "Offerreport")
            Response.Clear()
    ...
    Private Sub Fillist()
        'objDAL = New DAL
        Dim Str As String = "Select * from M_MemberOfferNew order by OfferID desc "
    ...
    Public Sub BindData(ByVal pageIndex As Integer)
        ...
        Try
            ...
            Session("RewardListNew") = Ds.Tables(0)
            ViewState("IdNo") = "IdNo"
    ...
    Private Sub RebindData(ByVal sColimnName As String, ByVal sSortOrder As String)
        Try
            Dim dt As DataTable = CType(Session("RewardListNew"), DataTable)
