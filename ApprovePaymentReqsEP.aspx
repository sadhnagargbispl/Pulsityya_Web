<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="ApprovePaymentReqsEP.aspx.vb" Inherits="ApprovePaymentReqsEP" %>
                                    ...
                                    <div style="margin-top: 15px; overflow: scroll;">
                                        <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Amount" HeaderText="EP"></asp:BoundField>
                                                <asp:BoundField DataField="EPValue" HeaderText="EP Value (RS.)"></asp:BoundField>
