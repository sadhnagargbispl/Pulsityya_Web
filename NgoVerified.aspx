<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="NgoVerified.aspx.vb" Inherits="NgoVerified" %>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>
                            Ngo/Social Certificate Verify</h2>
                        <div class="clearfix">
                        </div>
                    </div>
                                    ...
                                    <%--<div class="col-md-10">--%>
                                        <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="NgoNo" HeaderText="NGO No." />
                                                <asp:BoundField DataField="ActivationDate" HeaderText="Date Of Activation" />
                                                <asp:TemplateField HeaderText="Ngo Certificate" ItemStyle-HorizontalAlign="Center" >
                                                    <ItemTemplate>
                                                    <%#Eval("Link")%>
                                                       <%-- <asp:LinkButton ID="LBApprove" runat="server" Text="Show Image" OnClick="ApproveData" style="color:Black" data-toggle="modal" data-target="#modal_open"  href="javascript:void(0);"></asp:LinkButton>--%>
                                                        <%-- <a href='<%# "Img.aspx?ID=" & Eval("FormNo") & "&Type=GST" %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width:500,height:500,marginTop : 50 } )">
                                                    <asp:Image ID="Image3" Width="50px" Height="50px" runat="server" ImageUrl='<%#  Eval("GSTproofStatus")  %>' />--%>
                                                </a>
                                                        <br />
                                                        <asp:Label ID="Lbldate" runat="server" Text='<%#Eval("NgoProofDate") %>' Visible="false"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Verify Date" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        Verify Status:
                                                        <asp:Label ID="LblIdVerify" runat="server" Text='<%#Eval("NgoVerf") %>'></asp:Label>
                                                        <br />
                                                        Verify Date:
                                                        <asp:Label ID="LblVerifyDate" runat="server" Text='<%#Eval("NgoVerifiedDate") %>'></asp:Label>
                                                        <br />
                                                        <%-- Reject Remark:
