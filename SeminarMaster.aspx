<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false"
    CodeFile="SeminarMaster.aspx.vb" Inherits="App_UI_Application_Pages_SeminarMaster"
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            ...
                            <div class="col-md-12">
                                ...
                                <a href="AddSeminar.aspx" onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 420,height: 480,marginTop : 0 } )">
                            ...
                            <div style="margin-bottom: 20px">
                                <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TraningW_Per" HeaderText="Traning(%)" />
                                        ...
                                        <asp:TemplateField HeaderText="Modify" HeaderStyle-Width="85px" ItemStyle-HorizontalAlign="Center"
                                            ...
                                            <ItemTemplate>
                                                <a href='<%# "AddSeminar.aspx?MeetingID=" & Eval("VMeetingID") %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 450,marginTop : 0 } )">
