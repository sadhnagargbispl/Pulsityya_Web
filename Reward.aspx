<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="Reward.aspx.vb" Inherits="Reward" Title="" EnableEventValidation="true" %>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div style="padding: 10px 10px 20px 10px" id="divDetail" runat="server">
                        ...
                        <asp:GridView ID="GWdataproho" Width="100%" runat="server" AllowPaging="true" GridLines="Both"
                            class="table table-bordered" HeaderStyle-CssClass="bg-primary" ShowHeader="true"
