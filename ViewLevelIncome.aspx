<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewLevelIncome.aspx.cs" Inherits="ViewLevelIncome" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="table-responsive" style="margin-bottom: 10px; padding-right: 20px; padding-top: 20px">
            ...
            <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="true" RowStyle-Height="5px"
                ...
                AlternatingRowStyle-CssClass="alt" Font-Size="13px" Width="100%" ShowHeader="true"
