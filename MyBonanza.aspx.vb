...
Partial Class MyBonanza
        ...
        Try
            ...
            If ddlsearchtype.SelectedValue = 1 Then
                If Chkmemid.Checked Then
                    formno = GetFormNo()
                End If
                qry1 = "Exec Sp_GetRewardBonanzaReport '" & Val(formno) & "','" & ddllist.SelectedValue & "','" & txtFromDate.Text & "',"
            ...
            Else
                If Chkmemid.Checked Then
                    formno = GetFormNo()
                End If
                qry1 = "Exec Sp_GetRewardBonanzaReport '" & Val(formno) & "','" & ddllist.SelectedValue & "','" & txtFromDate.Text & "','" & TxtToDate.Text & "',"
    ...
    Private Sub FillReward()
        ...
        ElseIf Session("CompID") = 1108 Then
            S = "Select * From (Select 0 As Rewardid, '-- ALL --' As Reward Union ALL" & _
         " select Rewardid,Reward from MstRewards Where ActiveStatus='Y' ) as Temp "
        Else
            S = "Select * From (Select 0 As Rewardid, '-- ALL --' As Reward Union ALL" & _
