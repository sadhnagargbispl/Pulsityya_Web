...
Partial Class profileWithPostal
    ...
    Private Sub FillDetail()
        Try
            ...
            If dt.Rows.Count > 0 Then
                ...
                CmbPrefix.SelectedValue = dt.Rows(0)("Prefix")

                'txtAddLn1.Text = dt.Rows(0)("DeliveryAddress")
                ...
                Dim memDob As Object = dt.Rows(0)("MemDob")

                ' Check karo agar date null nahi hai aur 1900-01-01 nahi hai
                If Not IsDBNull(memDob) AndAlso CType(memDob, Date) <> New Date(1900, 1, 1) Then
                    Dim dobDate As Date = CType(memDob, Date)
                    ddlDOBdt.SelectedValue = dobDate.Day.ToString()
                    ddlDOBmnth.SelectedValue = dobDate.Month.ToString()
                    ddlDOBYr.SelectedValue = dobDate.Year.ToString()
                Else
                    ' 1900-01-01 ya null aaye to blank/default select karo
                    ddlDOBdt.SelectedValue = "0"
                    ddlDOBmnth.SelectedValue = "0"
                    ddlDOBYr.SelectedValue = "0"
                End If
                ...
                TxtPostalAddress.Text = dt.Rows(0)("DeliveryAddress")

                If Session("CompID") = "1103" Then
                    divDOBLabel.Visible = True
                    divDOBSection.Visible = True
                Else
                    divDOBLabel.Visible = False
                    divDOBSection.Visible = False
                End If

                If Session("CompID") = 1074 Or Session("CompID") = 1090 Or Session("CompID") = 1091 Then
                    TxtPostPincode.Text = dt.Rows(0)("pincode")
                    ddlPostSate.SelectedValue = dt.Rows(0)("StateCode")
                    TxtPostDistrict.Text = dt.Rows(0)("District")
                    TxtPostCity.Text = dt.Rows(0)("City")
                Else
                    TxtPostPincode.Text = dt.Rows(0)("PostalPin")
                    ddlPostSate.SelectedValue = dt.Rows(0)("PostalStateCode")
                    'TxtPostDistrict.Text = dt.Rows(0)("PostalDistrict")
                    'TxtPostCity.Text = dt.Rows(0)("PostalCity")

                    If IsDBNull(dt.Rows(0)("PostalDistrict")) Then
                        TxtPostDistrict.Text = ""

                    Else
                        TxtPostDistrict.Text = dt.Rows(0)("PostalDistrict")
                    End If
                    If IsDBNull(dt.Rows(0)("PostalCity")) Then
                        TxtPostCity.Text = ""
                ...
                If Session("compid") = "1007" Then
                    If dt.Rows(0)("Fax") = "CHOOSE ACCOUNT" Then
                        DDLAccountType.SelectedValue = "0"
                    ElseIf dt.Rows(0)("Fax") = "CHOOSE ACCOUNT TYPE" Then
                        DDLAccountType.SelectedValue = "0"
                    Else
                ...
                Else
                    ...
                    '    DDLAccountType.SelectedValue = dt.Rows(0)("Fax")
                    'End If
                    Dim faxValue As String = dt.Rows(0)("Fax").ToString()

                    If faxValue = "CHOOSE ACCOUNT TYPE" Then
                        DDLAccountType.SelectedValue = "0"
                    ElseIf DDLAccountType.Items.FindByValue(faxValue) IsNot Nothing Then
                        DDLAccountType.SelectedValue = faxValue
                    Else
                        ' Optionally handle the case where value isn't in dropdown
                        DDLAccountType.SelectedIndex = 0 ' or set to a default value
                    End If
                End If
        ...
        Try
            ...
            If Val(txtPinCode.Text) <> 0 Then
                ...
                If Dt.Rows.Count > 0 Then
                    ...
                    'ddlstate.SelectedItem.Text = Dt.Rows(0)("StateName")
                    Dim dr As DataRow
                    dr = Dt.NewRow
    ...
    Private Sub UpdateDb()
       ...
       "('" & Val(Session("UserID")) & "','" & Session("UserName") & "','Profile ','Profile Update','" & remark & "',Getdate(),'" & Val(formNo) & "')"
            ...
            " BranchName='" & TxtBranchName.Text & "',IFSCode='" & TxtIfsCode.Text & "',PANNo='" & txtPanNo.Text & "',AadharNo3='" & txtGstNo.Text & "',AadharNo='" & TxtIdProofNo.Text.Trim.ToUpper & "', " & _
            "Passw='" & TxtPassword.Text.Trim() & "',E_MainPassw='" & TxtPassword.Text.Trim() & "',Epassw='" & TxtTransactionPassword.Text & "', " & _
            " DeliveryAddress = '" & TxtPostalAddress.Text.ToUpper() & "', PostalPin = '" & TxtPostPincode.Text.ToUpper() & "'," & _
            " PostalDistrict = '" & TxtPostDistrict.Text.ToUpper() & "',PostalCity = '" & TxtPostCity.Text.ToUpper() & "'," & _
            " PostalState = '" & ddlPostSate.SelectedItem.Text.ToUpper() & "',PostalStateCode = '" & ddlPostSate.SelectedValue & "', " & _
    ...
    Protected Sub Clear()
        Response.Redirect("profileWithPostal.aspx")
        Exit Sub
        txtMemberId.Enabled = True
        txtMemberId.Text = ""
        lblUplinerId.Text = ""
