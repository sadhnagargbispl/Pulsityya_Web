<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="AssignRank.aspx.vb" Inherits="AssignRank" %>
                            ...
                            <div align="center">
                                ...
                                <div class="col-md-12" style="margin-bottom: 1%">
                                    ...
                                    <div class="col-md-12" style="margin-bottom: 1%">
                                        ...
                                        <div class="col-md-4">
                                            <asp:Button ID="BtnLegShift" runat="server" Text="Save" 
                                                class="btn btn-primary" ValidationGroup="Save"  Enabled ="false" /></div>
                                        <div class="col-md-6">
                                        </div>
                                    </div>
                                </div>
