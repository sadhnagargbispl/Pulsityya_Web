<%@ Page Title="" Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false"
    CodeFile="MyPurchaseReportsolly.aspx.vb" Inherits="MyPurchaseReportsolly" %>
                                ...
                                <div align="center">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <label>
                                                Page Size:</label>
                                            <asp:DropDownList ID="ddlPageSize" runat="server" class="form-control" AutoPostBack="true" OnSelectedIndexChanged="PageSize_Changed">
