<%@ Page Title="" Language="C#" MasterPageFile="~/SitePage.master" AutoEventWireup="true" CodeFile="RepurchaseNow.aspx.cs" Inherits="RepurchaseNow" %>
                ...
                <div class="col-12 col-sm-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Repurchase Now</h5>
                        </div>
                        <div class="card-body">
                            <div class="row g-1">
                                <div class="col-md-6">
