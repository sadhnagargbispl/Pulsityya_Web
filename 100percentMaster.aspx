<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="100percentMaster.aspx.vb" Inherits="App_UI_Application_Pages_100percentMaster"
                            ...
                            <div class="table-responsive makeitresponsivegrid" style="min-height: 500px;">
                                <div align="center">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <a href="Add100percent.aspx" onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 300,marginTop : 0 } )">
                                                    <asp:Button ID="BtnAddNew" runat="server" CssClass="btn btn-primary " Text="Add 100 Percent" /></a>
