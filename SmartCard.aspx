<%@ Page Title="" Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false" CodeFile="SmartCard.aspx.vb" Inherits="SmartCard" %>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="LBDelete" runat="server" Text="Modify" 
                                                     Visible='<%# Eval("VisibleStatus") %>'>
                                                      <a href='<%# "AddSmartCard.aspx?CouponNo=" & Eval("CouponNo")  %>'  
