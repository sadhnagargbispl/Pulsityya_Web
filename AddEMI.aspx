<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="AddEMI.aspx.vb" Inherits="AddEMI" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        function confirmation() {
            ...
            var EmiAmount = document.getElementById("<%= TxtROI.ClientID %>").value;
           
            if (confirm('Your remaining amount ' + Amount + ' for '+ Month +' month and calculate EMI Amount is '+ EmiAmount +'. Are you sure about this action ?'))
             {
                return true;
            } else {
                return false;
                                    ...
                                    <tbody>
                                       ...
                                       <tr style="margin-top: 20px; padding-top: 20px; margin-bottom: 20px;"><td><br /></td></tr>
                                        <tr style="margin-top: 20px; padding-top: 20px">
                                            ...
                                            <td>
                                                <asp:TextBox ID="TxtFund" Width="200px" runat="server" class="form-control" onkeypress="return isNumberKey(event);" AutoPostBack="true"
                                                   ></asp:TextBox>
