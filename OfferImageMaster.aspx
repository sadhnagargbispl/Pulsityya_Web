<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="OfferImageMaster.aspx.vb" Inherits="OfferImageMaster"
                ...
                <div class="x_panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            <div class="col-md-12">
                                <a href="AddOfferImage.aspx" onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 577,height: 452,marginTop : 0 } )">
                                ...
                                <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderStyle-Width="85px" ItemStyle-HorizontalAlign="Center" ControlStyle-CssClass="btn-group">
                                            <ItemTemplate>
                                                <%--<a href='<%# "AddOfferImage.aspx?PId=" & Crypto.Encrypt(Eval("Id"))  %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 330,marginTop : 0 } )">
