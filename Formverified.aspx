<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="Formverified.aspx.vb" Inherits="App_UI_Application_Pages_Formverified" EnableEventValidation="true"  %>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-3">
                                        <asp:DropDownList ID="DDlVerify" runat="server" class="form-control">
                                            ...
                                            <asp:ListItem Text="VERIFY" Value="A"></asp:ListItem>
                                ...
                                <div class="col-md-12" style="overflow: scroll">
                                    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Front Page Form" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <a href='<%# "Img.aspx?ID=" & Eval("FormNo") & "&Type=FrontSideForm" %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width:500,height:500,marginTop : 50 } )">
                                                        <asp:Image ID="Image3" Width="50px" Height="50px" runat="server" ImageUrl='<%#  Eval("FrontSideForm")  %>' />
                                                    </a>
                                                    <br />
                                                    Upload Date<br />
                                                    <asp:Label ID="Lbldate" runat="server" Text='<%#Eval("rectimestamp") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Back Page Form" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <a href='<%# "Img.aspx?ID=" & Eval("FormNo") & "&Type=BackSideForm" %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width:500,height:500,marginTop : 50 } )"
                                                        target="_blank">
                                                        <asp:Image ID="Image4" Width="50px" Height="50px" runat="server" ImageUrl='<%#  Eval("BackSideForm")  %>' />
                                                    </a>
                                                    <br />
                                                    Upload Date:<br />
                                                    <asp:Label ID="LblBackDate" runat="server" Text='<%#Eval("rectimestamp") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Uploaded Form Date" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <strong>Verify Detail:</strong>
                                                    <asp:Label ID="LblIdVerify" runat="server" Text='<%#Eval("Status") %>'></asp:Label>
                                                    <br />
                                                    <strong>Verify Date</strong>
                                                    <asp:Label ID="LblVerifyDate" runat="server" Text='<%# Eval("VerifyDate") %>'></asp:Label>
