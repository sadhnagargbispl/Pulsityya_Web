...
Partial Class App_UI_Application_Pages_SeminarMaster
    ...
    Public Sub BindData(Optional ByVal Condition As String = "")
        ...
        " Case when A.ActiveStatus='N' then 'label label-danger' else 'label label-success' end as StatusClass,MRP,TraningW_Per From M_StateDivMaster As B,M_MeetingMaster As A LEFT JOIN M_MemberMaster as M ON A.UserID=M.FormNo Where A.StateCode=B.StateCode " & Condition & " ORDER BY MeetingTime DESC"
