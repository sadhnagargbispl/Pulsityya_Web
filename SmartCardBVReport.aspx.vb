...
Partial Class SmartCardBVReport
    ...
    Public Sub BindData(ByVal PageIndex As Integer)
        ...
        Try
            ...
            GrdTotal.DataBind()
            Dim str As String = " sp_SmartCardBVReport '" & txtMemId.Text & "','" & txtStartDate.Text & "','" & txtEndDate.Text & "'"
    ...
    Private Sub ExportExcel()
        ...
        Using wb As New XLWorkbook()
            ...
            Response.AddHeader("content-disposition", "attachment;filename=RealStateBV.xlsx")
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Try
            ...
            GrdTotal.DataSource = Nothing
            GrdTotal.DataBind()
            Dim str As String = " sp_RealStateBVReport '" & txtMemId.Text & "','" & txtStartDate.Text & "','" & txtEndDate.Text & "'"
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), CommandType.Text, str)
            If (Ds.Tables(0).Rows.Count > 0) Then
