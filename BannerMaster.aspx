<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="BannerMaster.aspx.vb" Inherits="BannerMaster" Title="" EnableEventValidation="false" %>
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            <div align="center">
                                <div class="col-md-12">
                                    ...
                                    <a href="AddBanner.aspx" onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 400,height: 430,marginTop : 0 } )">
                                        <asp:Button ID="BtnAddNew" runat="server" class="btn btn-primary" Text="Add Banner Detail" /></a>
                                ...
                                <div style="margin-bottom: 20px">
                                    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="BannerCode" Visible="false" SortExpression="Bannerid">
                                                <ItemTemplate>
                                                    <asp:Label ID="LblGrpID" runat="server" Text='<%# Eval("BannerId") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>  
                                            ...
                                            <asp:TemplateField HeaderText="Modify" HeaderStyle-Width="85px" ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <a href='<%# "AddBanner.aspx?BannerId=" & Crypto.Encrypt(Eval("VBannerCode"))  %>'
