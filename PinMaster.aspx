<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="PinMaster.aspx.vb" Inherits="App_UI_Application_Pages_PinMaster"
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            ...
                            <div class="col-md-12">
                                ...
                                <a href="Addpin.aspx" onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 350,marginTop : 0 } )">
                                    <asp:Button ID="BtnAddNew" runat="server" class="btn btn-primary" Text="Add Pin" /></a>
