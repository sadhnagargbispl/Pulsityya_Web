<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false"
    CodeFile="KitMaster.aspx.vb" Inherits="App_UI_Application_Pages_KitMaster" Title=""
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            <div align="center">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <a href="AddKit.aspx" onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 600,height: 450,marginTop : 0 } )">
                                   ...
                                   <%-- <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                        ...
                                        <asp:TemplateField HeaderText="S.No.">
                                            ...
                                            <asp:TemplateField HeaderText="Modify" HeaderStyle-Width="55px" ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <a href='<%# "AddKit.aspx?KitId=" & Eval("VKitId")  %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 450,marginTop : 0 } )">
