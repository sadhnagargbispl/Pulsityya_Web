...
Partial Class UniversalTree
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        BindData(formno)
        TreeFrame.Attributes.Item("src") = "UniTree.aspx?DownLineFormNo=" & Val(formno.ToString()) & "&deptlevel=" & Val(depthlevel.ToString())
    End Sub
            ...
            If Request.QueryString("key") <> "" And Not Request.QueryString("key") Is Nothing Then
                If Not Page.IsPostBack Then
                    ...
                    If formno <> "" Then
                        Dim level As String
                        level = 4
                        TreeFrame.Attributes.Item("src") = "UniTree.aspx?DownLineFormNo=" & Val(formno.ToString()) & "&deptlevel=" & Val(level.ToString())
                    End If
                End If
            End If
        End If
