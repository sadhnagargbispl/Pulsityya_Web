<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="onlinetransactionnew.aspx.vb" Inherits="onlinetransactionnew" %>
                                ...
                                <div align="center">
                                    <div class="col-md-12">
                                        <div class="row">
                                         ...
                                         <asp:Label ID="Label1" runat="server" Text="Status"></asp:Label>
                                                  ...
                                                  <asp:ListItem Text="--Select Status--" Value="All" />
                                                  <asp:ListItem Text="PAID" Value="PAID" />
                                        <asp:ListItem Text="Pending" Value="Pending" />
                                        <asp:ListItem Text="FAILED" Value="ACTIVE"></asp:ListItem>
                                             </asp:DropDownList>
                                            </div>
                                            <div class="col-md-2">
                                    ...
                                    <div class="col-md-12">
                                        <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="True" PageSize="20"
                                            AutoGenerateColumns="false" AllowSorting="true" ShowHeader="true" class="table table-bordered" HeaderStyle-CssClass="bg-primary"
                                            EmptyDataText="No data to display." GridLines="Both">
                                            <Columns>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="LblGrpID" runat="server" Text='<%# Eval("orderId") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:BoundField DataField="Transactioncharge" HeaderText="Transaction Charge" SortExpression="Transactioncharge" />
                                           <asp:BoundField DataField="OrderDate" HeaderText="Order Date" SortExpression="OrderDate" />
                                           <asp:TemplateField HeaderText="type">
                                           <ItemTemplate>
                                               <asp:Label ID="LblType" runat="server" Text='<%# Eval("Acttype") %>'></asp:Label>
                                           ...
                                           <asp:TemplateField HeaderText="Status" SortExpression="Status">
                                            ...
                                            <asp:TemplateField HeaderText="Retry" HeaderStyle-Width="85px" ItemStyle-HorizontalAlign="Center"
