...
Partial Class franchisecomlist
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        Try
            If Session("AStatus") = "OK" Then
                Session("PageName") = "Franchise Commition Report"
            Else
    ...
    Public Sub BindData(ByVal pageIndex As Integer)
        ...
        Try
            ...
            'End If
            If franchise.Checked Then
                If Txtfraid.Text <> "" Then
                    Condition1 = Trim(Txtfraid.Text)
                Else
                    Condition1 = "0"
            ...
            prms(0) = New SqlParameter("@FranchiseId", Convert.ToString(Condition1).ToLower())
            prms(1) = New SqlParameter("@Idno", Convert.ToString(Condition).ToLower())
            prms(2) = New SqlParameter("@KitId", kitId)
            prms(3) = New SqlParameter("@Frmdate", Convert.ToDateTime(startDate))
            prms(4) = New SqlParameter("@Todate", Convert.ToDateTime(endDate))
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "Sp_FranchiseCommission", prms)
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Try
            ...
            'prms(0) = New SqlParameter("@FranchiseId", Convert.ToString(Condition).ToLower())
