...
Partial Class App_UI_Application_Pages_RepurchIncome
    ...
    Public Sub BindData(ByVal PageIndex As Integer)
        ...
        Try
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetRepurchPayoutDetail", prms)
    ...
    Private Sub ExportExcel()
        ...
        Using wb As New XLWorkbook()
            ...
            Response.AddHeader("content-disposition", "attachment;filename=RepurchaseWallet.xlsx")
