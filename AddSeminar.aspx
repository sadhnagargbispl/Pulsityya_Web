<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddSeminar.aspx.vb" Inherits="App_UI_Application_Pages_AddSeminar" %>
                        ...
                        <div class="x_panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12" style="padding-top: 1%">
                                    ...
                                    <div class="col-md-6">
                                        <asp:DropDownList ID="DdlHH" Width="60px" class="form-control" Style="display: inline;
                                            padding: 0px 0px;" runat="server">
                                        </asp:DropDownList>
                                        <asp:DropDownList ID="DdlMM" Width="50px" runat="server" class="form-control" Style="display: inline;
                                            padding: 0px 0px;">
                                        ...
                                        <asp:DropDownList ID="Ddltt" Width="50px" runat="server" class="form-control" Style="display: inline;
                                            padding: 0px 0px;">
                                    ...
                                    <div class="col-md-6">
                                        <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <br />
                                                <asp:TextBox ID="TxtOtherDist" runat="server" class="form-control" placeholder="Other"></asp:TextBox>
                                            </ContentTemplate>
                                            <Triggers>
                                ...
                                <div class="col-md-12" style="padding-top: 1%">
                                    ...
                                    <div class="col-md-6">
                                        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="ddlTehsil" class="form-control" TabIndex="16" runat="server">
                                                </asp:DropDownList>
                                                <br />
                                                <asp:TextBox ID="TxtOtherCity" runat="server" class="form-control" placeholder="Other"></asp:TextBox>
                                            </ContentTemplate>
                                            <Triggers>
                                ...
                                <div class="col-md-12" style="padding-top: 1%">
                                    ...
                                    <div class="col-md-6">
                                        <asp:TextBox ID="txtTraningWallet" class="form-control" runat="server"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" Display="Dynamic" ControlToValidate="txtTraningWallet"
                                            ValidationGroup="Form-submit" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                                        <AjaxToolkit:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server"
                                            FilterType="Numbers,Custom" TargetControlID="txtTraningWallet" ValidChars=".0123456789">
                                        </AjaxToolkit:FilteredTextBoxExtender>
                                    </div>
                                    <div class="col-md-2">
                                    </div>
