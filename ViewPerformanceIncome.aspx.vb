...
Partial Class ViewPerformanceIncome
    ...
    Public Sub BindData(Optional ByVal SrchCond As String = "")
        Try
            ...
            Dim formno As String = ""
            formno = GetFormNo()
            Dim sql1 As String = " Select A.SessID,Replace(Convert(Varchar,C.FrmDate,106),' ','-') As FrmDate,B.IDNo,B.MemFirstName,a.BV as Amount,"
            sql1 &= " A.Slab,A.Comm From M_PerformanceInc As A Inner join M_MemberMaster As B On A.FormNoDwn=B.FormNo"
            sql1 &= " Inner Join M_SessnMaster As C On A.SessID=C.SessID Where "
            sql1 &= " A.FormNo='" & Val(formno) & "' "
            sql1 &= " And A.SessID='" & Request("Sessid") & "' and Comm<>0"
