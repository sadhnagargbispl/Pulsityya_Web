<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false"
    CodeFile="MembershipMaster.aspx.vb" Inherits="App_UI_Application_Pages_MembershipMaster" Title=""
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            <div align="center">
                                <div class="col-md-12">
                                    ...
                                    <a href="AddMembership.aspx" onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 600,height: 450,marginTop : 0 } )">
                                        <asp:Button ID="BtnAddNew" runat="server" class="btn btn-primary" Text="Create New Membership" /></a>
                                </div>
                            ...
                            PagerStyle-CssClass="PagerStyle">
                                        ...
                                        <asp:TemplateField HeaderText="S.No.">
                                            ...
                                            <asp:BoundField DataField="PersonCount" HeaderText="Person Count" />
                                            <asp:BoundField DataField="YearDuration" HeaderText="Year Duration" />
                                            ...
                                            <asp:TemplateField HeaderText="Modify" HeaderStyle-Width="55px" ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <a href='<%# "AddMembership.aspx?Id=" & Eval("Id")  %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 420,height: 450,marginTop : 0 } )">
