<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="RptCancelPins.aspx.vb" Inherits="App_UI_Application_Pages_RptCancelPins" %>
                                            ...
                                            <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                                ...
                                                <Columns>
                                                  <asp:BoundField DataField ="SNo" HeaderText="SNo" SortExpression ="SNo" />
                                                    <asp:BoundField DataField="FormNo" HeaderText="Pin No." ControlStyle-Width="50px"
                                                        SortExpression="Formno" />
                                                    <asp:BoundField DataField="ScratchNo" HeaderText="Scratch No." ControlStyle-Width="50px"
                                                        SortExpression="ScratchNo" />
                                                    <asp:BoundField DataField="KitName" HeaderText="Package Name" SortExpression="KitName" />
                                                    <asp:BoundField DataField="CancelledBy" HeaderText="Cancelled By" SortExpression="CancelledBy" />
                                                    <asp:BoundField DataField="CancelDate" HeaderText="Cancelled Date" SortExpression="CancelDate" />
                                                </Columns>
                                            </asp:GridView>
