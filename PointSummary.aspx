<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="PointSummary.aspx.vb" Inherits="App_UI_Application_Pages_PointSummary"
    ...
    <div style="background-color: White ">
        <table width="100%" cellspacing="10px" align="left" style="margin: 20px; padding: 0px;">
            ...
            <tr>
                ...
                <td  style="height:5%">
                <asp:RadioButtonList ID="RbtType" runat="server" RepeatDirection ="Horizontal" RepeatLayout ="Flow" >
                <asp:ListItem Text="Summary" Value="S" Selected="True"></asp:ListItem>                
                <asp:ListItem Text="Detail" Value="D"></asp:ListItem></asp:RadioButtonList>
            ...
            <tr>
                ...
                <td colspan="3" style="padding-top :15px;">
                   ...
                   <%-- <asp:Button ID="btnshowall" runat="server" CssClass="Btn" Text="Show All" />--%>
                    <asp:Button ID="btnExport" runat="server" CssClass="Btn" Text="Export To Excel" visble="false" />
