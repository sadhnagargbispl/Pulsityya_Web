<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="Copy of MISReport.aspx.vb" Inherits="MISReport" Title="" %>
                                ...
                                <div class="col-md-12">
                                    <div style="padding: 10px 10px 20px 10px; overflow: scroll">
                                        <asp:GridView ID="GvActivation" Width="100%" runat="server" RowStyle-Height="25px"
                                            Caption="Activation MIS" CaptionAlign="Top" GridLines="Both" AllowPaging="true"
                                        ...
                                        <br />
                                        <asp:GridView ID="GrdPayout" Width="100%" runat="server" RowStyle-Height="25px" Caption="Payout MIS"
                                            CaptionAlign="Top" GridLines="Both" AllowPaging="true" CssClass="table table-bordered"
                                            PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" ShowHeader="true"
                                            PageSize="50" EmptyDataText="No data to display." AutoGenerateColumns="true">
                                        </asp:GridView>
                                        <br />
                                        <asp:GridView ID="GrdProduct" Width="100%" runat="server" RowStyle-Height="25px"
                                            Caption="Product MIS" CaptionAlign="Top" GridLines="Both" AllowPaging="true"
                                            CssClass="table table-bordered" PagerStyle-CssClass="pgr"
                                            AlternatingRowStyle-CssClass="alt" ShowHeader="true" PageSize="50" EmptyDataText="No data to display."
                                            AutoGenerateColumns="true">
                                        </asp:GridView>
                                        <br />
                                        <asp:GridView ID="GrdSummary" Width="100%" runat="server" RowStyle-Height="25px"
                                            Caption="Summary MIS" CaptionAlign="Top" GridLines="Both" AllowPaging="true"
                                            CssClass="table table-bordered" PagerStyle-CssClass="pgr"
                                            AlternatingRowStyle-CssClass="alt" ShowHeader="true" PageSize="50" EmptyDataText="No data to display."
                                            AutoGenerateColumns="true">
                                        </asp:GridView>
