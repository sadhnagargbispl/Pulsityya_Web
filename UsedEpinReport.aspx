<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="UsedEpinReport.aspx.vb" Inherits="UsedEpinReport" Title="" EnableEventValidation="false" %>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <asp:DropDownList ID="DDlSearchName" runat="server" class="form-control">
                                        <asp:ListItem Text="Source Id" Value="G"></asp:ListItem>
                                        <asp:ListItem Text="Generated Id" Value="S"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div class="col-md-3">
                                        ...
                                        <div id="gvContainer" runat="server" style="overflow: scroll;" class="col-md-12">
                                            ...
                                            <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Generated Id" HeaderText="Generated Id" SortExpression="Generated Id" />
                                                    <asp:BoundField DataField="Generated User Name" HeaderText="Generated User Name"
                                                        SortExpression="Generated User Name" />
                                                    <asp:BoundField DataField="PinSource MemberId" HeaderText="PinSource MemberId" SortExpression="Pin Source MemberId" />
                                                    <asp:BoundField DataField="PinSource Member Name" HeaderText="PinSource Member Name"
                                                        SortExpression="PinSource Member Name" />
                                                    <asp:BoundField DataField="Pin Used Date and Time" HeaderText="Pin Used Date and Time"
                                                        SortExpression="Pin Used Date and Time" />
                                                    ...
                                                    <asp:BoundField DataField="Epin Number" HeaderText="Epin Number" SortExpression="Epin Number" />
                                                    <asp:BoundField DataField="Epin Code" HeaderText="Epin Code" SortExpression="Epin Code" />
                                                </Columns>
                                            </asp:GridView>
