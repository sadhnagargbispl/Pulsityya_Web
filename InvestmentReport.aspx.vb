...
Partial Class App_UI_Application_Pages_InvestmentReport
    ...
    'Dim constr As String = ConfigurationManager.ConnectionStrings(HttpContext.Current.Session("MlmDatabase" & Session("CompID"))).ConnectionString

    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        Try
            If Session("AStatus") = "OK" Then
                Session("PageName") = "Report / Investment Report"
            Else
    ...
    Public Sub BindData(ByVal PageIndex As Integer)
        ...
        Try
            ...
            prms(7) = New SqlParameter("@Type", ddltype.SelectedValue)
            'Ds = SqlHelper.ExecuteDataset(constr, "sp_GetInvestmentDetail", prms)
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetInvestmentDetailNew", prms)
            GrdTotal.DataSource = Ds.Tables(0)
            GrdTotal.DataBind()
            Dim recordCount As Integer = Ds.Tables(1).Rows(0)("RecordCount")
            Dim Inv As Integer = Ds.Tables(1).Rows(0)("Investment")
            ...
            If Ds.Tables(0).Rows.Count > 0 Then
                ...
                lblinv.Text = "Total Investment: " & Ds.Tables(1).Rows(0)("Investment")
