<%@ Page Title="" Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false"
    CodeFile="RejoiningProcess.aspx.vb" Inherits="RejoiningProcess" %>
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            <div id="divSingle" runat="server" class="col-md-12">
                                ...
                                <div class="col-md-12" style="margin-bottom: 2%">
                                    ...
                                    <div class="col-md-4">
                                        <asp:TextBox class="form-control" ID="TxtWalletAddress" runat="server" ReadOnly="true"></asp:TextBox>
                                ...
                                <div class="col-md-12" style="margin-bottom: 2%">
                                    <div class="col-md-2">
                                        <strong>TxnHash. :</strong></div>
                                    <div class="col-md-4">
                                        <asp:TextBox class="form-control" ID="TxtThxhash" runat="server"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" ControlToValidate="TxtThxhash"
                                            runat="server" ValidationGroup="Save" ForeColor="Red">*</asp:RequiredFieldValidator>
                                    </div>
                                    <div class="col-md-6">
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <asp:Button ID="UpdateTxnHash" class="btn btn-primary" runat="server" Text="Submit"
