...
Partial Class ListFlattypeMaster
    ...
    Public Sub BindData()
        Try
            ...
            Dim Qry As String = "Select id,Flattype,Status From V#FlattypeMaster Where 1=1" & _Condition & " Order by ID Desc"
    ...
    Protected Sub DeleteGroup(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim Sql As String = "Update M_FlatTypeMaster SET ActiveStatus='N' WHERE Id='" & userID & "' "
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Try
            ...
            Dim Qry As String = "Select Flattype,Status From V#FlattypeMaster Where 1=1 Order by ID Desc"
            dtData = New DataTable
            dtData = objDAL.GetData(Qry)
            ExportToExcel(dtData, "FlatType")
        Catch ex As Exception
