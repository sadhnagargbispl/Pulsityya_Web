...
public partial class IndexGreen : System.Web.UI.Page
{
    DAL Obj;
    DataSet Ds;
    ...
    private void LoadTeam()
    {
        try
        {
            ...
            if (Ds.Tables[0].Rows.Count > 0)
            {
                ...
                Td1.InnerText = Ds.Tables[0].Rows[0]["groupcLeftTodayRegister"].ToString();
                TotalTodayRegister.InnerText = (Convert.ToDecimal(Ds.Tables[0].Rows[0]["LeftTodayRegister"]) + Convert.ToDecimal(Ds.Tables[0].Rows[0]["RightTodayRegister"]) + Convert.ToDecimal(Ds.Tables[0].Rows[0]["groupcLeftTodayRegister"]) ).ToString();
                ...
                Td2.InnerText = Ds.Tables[0].Rows[0]["groupctotalRegister"].ToString();
                TotalJoin.InnerText = (Convert.ToDecimal(Ds.Tables[0].Rows[0]["LeftRegister"]) + Convert.ToDecimal(Ds.Tables[0].Rows[0]["RightRegister"]) + Convert.ToDecimal(Ds.Tables[0].Rows[0]["groupctotalRegister"])).ToString();
                ...
                Td4.InnerText = Ds.Tables[0].Rows[0]["groupcLeftactive"].ToString();
                TotalActivation.InnerText = (Convert.ToDecimal(Ds.Tables[0].Rows[0]["Leftactive"]) + Convert.ToDecimal(Ds.Tables[0].Rows[0]["RightActive"]) + Convert.ToDecimal(Ds.Tables[0].Rows[0]["groupcLeftactive"])).ToString();
                ...
                Td3.InnerText = Ds.Tables[0].Rows[0]["groupcRightTodayActive"].ToString();
                TodayTotalActive.InnerText = (Convert.ToDecimal(Ds.Tables[0].Rows[0]["LeftTodayActive"]) + Convert.ToDecimal(Ds.Tables[0].Rows[0]["RightTodayActive"]) + Convert.ToDecimal(Ds.Tables[0].Rows[0]["groupcRightTodayActive"])).ToString();
                ...
                Td5.InnerText = Ds.Tables[0].Rows[0]["groupcDirectactive"].ToString();
                TotalDirectActive.InnerText = (Convert.ToDecimal(Ds.Tables[0].Rows[0]["Directactive"]) + Convert.ToDecimal(Ds.Tables[0].Rows[0]["InDirectactive"]) + Convert.ToDecimal(Ds.Tables[0].Rows[0]["groupcDirectactive"])).ToString();

                LblTotalBusiness.Text = (Convert.ToDecimal(Ds.Tables[0].Rows[0]["DirectUnit"]) + Convert.ToDecimal(Ds.Tables[0].Rows[0]["InDirectUnit"])).ToString();
            }
