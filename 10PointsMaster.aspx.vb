...
Imports System.IO
Partial Class App_UI_Application_Pages_10PointsMaster
    ...
    Protected Sub GvData_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles GvData.PageIndexChanging
        ...
        GvData.DataSource = Session("10PointsData")
        GvData.DataBind()
    End Sub
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
       ...
       ",M_MemberMaster as b where a.Idno=b.Idno " & Condition & " "
            ...
            ExportToExcel("10PointsReport.xls", dg)
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        " Replace(Convert(varchar,a.RecTimeStamp,106),' ','-') + ' '+ CONVERT(varchar(15),CAST(a.RecTimeStamp AS TIME),100) as [Date], " & _
        " Case when a.activestatus='Y' then 'Active' else 'Deactive' end as Status from M_Tenpoints as a" & _
