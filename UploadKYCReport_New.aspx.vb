...
Partial Class App_UI_Application_Pages_UploadKYCReport_New
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        Try
            Dim dtCondtion As DataTable = New DataTable()
            ...
            If RbtSummary.SelectedValue = "S" Then
                If DDlSerchBy.SelectedValue = "Y" Then
                    ...
                    StrSql = "Select ColumnName,Condtion from KycReportCondition Where KycType = '" & ddlKyc.SelectedValue & "' And SearchType = 'Y'"
                    dtCondtion = objDAL.GetData(StrSql)
                    qry = " select   IdNo,(MemFirstName+' '+MemLastName)as [Member Name],"
                    qry &= "" & dtCondtion.Rows(0)("ColumnName") & ""
                    qry &= "from M_memberMaster as e, KycVerify as a Left Join M_UserMaster as b on a.PanUserId=b.UserId and b.RowStatus='Y'"
                    qry &= " Left Join M_UserMaster as c on a.AddrssUserId=c.UserId and c.RowStatus='Y'"
                    qry &= " Left Join M_UserMaster as d on a.BankUserId=d.UserId and d.RowStatus='Y'"
                    qry &= " where e.Formno=a.Formno and (" & dtCondtion.Rows(0)("Condtion") & ") " & Condition & ""




                    'qry = "select   IdNo,(MemFirstName+' '+MemLastName)as [Member Name],IsNull(Replace(Convert(Varchar,PanVerifyDate,106),' ','-')+ ' '+CONVERT(varchar(15),CAST(PanVerifyDate AS TIME),100),'') as [PAN Verified Date]," & _
                    ...
                    '  " IsNull(d.UserName,'') as [BankProof Verify By]   from M_memberMaster as e, KycVerify as a Left Join M_UserMaster as b on a.PanUserId=b.UserId and b.RowStatus='Y'" & _
                ...
                ElseIf DDlSerchBy.SelectedValue = "R" Then
                    ...
                    StrSql = "Select ColumnName,Condtion from KycReportCondition Where KycType = '" & ddlKyc.SelectedValue & "' And SearchType = 'R'"
                    dtCondtion = objDAL.GetData(StrSql)
                    ...
                    'qry = " select   IdNo,(MemFirstName+' '+MemLastName)as [Member Name],IsNull(Replace(Convert(Varchar,PanVerifyDate,106),' ','-')+ ' '+  CONVERT(varchar(15),CAST(PanVerifyDate AS TIME),100),'') as [PanCard Rejected Date],a.PanRemarks as [PanCard Remark]," & _
                    ...
                    '   " IsNull(d.UserName,'') as [BankProof Rejected By]   from M_memberMaster as e,KycVerify as a Left Join M_UserMaster as b on a.PanUserId=b.UserId and b.RowStatus='Y'" & _
                    '   " Left Join M_UserMaster as c on a.AddrssUserId=c.UserId and c.RowStatus='Y' Left Join M_UserMaster as d on a.BankUserId=d.UserId and d.RowStatus='Y'" & _
                ...
                ElseIf DDlSerchBy.SelectedValue = "N" Then
                    ...
                    StrSql = "Select ColumnName,Condtion from KycReportCondition Where KycType = '" & ddlKyc.SelectedValue & "' And SearchType = 'N'"
                    dtCondtion = objDAL.GetData(StrSql)

                    qry = " select   IdNo,(MemFirstName+' '+MemLastName) "
                    qry &= "  + ' :- ' +"
                    qry &= " " & dtCondtion.Rows(0)("ColumnName") & " as [Member Name]"
                    qry &= " from M_memberMaster as e, KycVerify as a Left Join M_UserMaster as b on a.PanUserId=b.UserId and b.RowStatus='Y'"
                    qry &= " Left Join M_UserMaster as c on a.AddrssUserId=c.UserId and c.RowStatus='Y' "
                    qry &= " Left Join M_UserMaster as d on a.BankUserId=d.UserId and d.RowStatus='Y' "
                    qry &= " where e.Formno=a.Formno and (" & dtCondtion.Rows(0)("Condtion") & ") " & Condition & ""

                    ' qry = "select   IdNo,(MemFirstName+' '+MemLastName)  " & _
                    ' " + ' :- ' +" & _
                    ' " CAse When (AddrProof = '' Or BackAddressProof = '') Then 'Add Proof' Else  '' End" & _
                    ' " +CAse When (BankProof = '') Then ',Bank Proof' Else  '' End " & _
                    ' " +CAse When (PanImg  ='' ) Then ',Pan Kyc' Else  '' End as [Member Name]" & _
                ...
                ElseIf DDlSerchBy.SelectedValue = "P" Then
                    If (ddlKyc.SelectedValue = "4") Then
                        qry = "select   IdNo,(MemFirstName+' '+MemLastName)as [Member Name],IsNull(Replace(Convert(Varchar,PanVerifyDate,106),' ','-')+ ' '+CONVERT(varchar(15),CAST(PanVerifyDate AS TIME),100),'') as [PAN Verified Date]," & _
                              " IsNull(b.UserName,'') as [Pan Verify By],IsNull(Replace(Convert(Varchar,AddrssVerifyDate,106),' ','-')+ ' '+  CONVERT(varchar(15),CAST(AddrssVerifyDate AS TIME),100),'') as [Address Proof Verified Date]," & _
                              " IsNull(C.UserName,'') as [AddressProof Verify By],IsNull(Replace(Convert(Varchar,BankVerifyDate,106),' ','-')+ ' '+  CONVERT(varchar(15),CAST(BankVerifyDate AS TIME),100),'') as [Bank Proof Verified Date]," & _
                              " IsNull(d.UserName,'') as [BankProof Verify By]   from M_memberMaster as e, KycVerify as a Left Join M_UserMaster as b on a.PanUserId=b.UserId and b.RowStatus='Y'" & _
                    ...
                    Else
                        StrSql = "Select ColumnName,Condtion from KycReportCondition Where KycType = '" & ddlKyc.SelectedValue & "' And SearchType = 'P'"
                        dtCondtion = objDAL.GetData(StrSql)

                        qry = " select IdNo,(MemFirstName+' '+MemLastName)as [Member Name],"
                        qry &= " " & dtCondtion.Rows(0)("ColumnName") & ""
                        qry &= " from M_memberMaster as e, KycVerify as a"
                        qry &= " where e.Formno=a.Formno " & dtCondtion.Rows(0)("Condtion") & " " & Condition & ""
