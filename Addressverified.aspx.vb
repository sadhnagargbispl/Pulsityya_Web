...
Imports System.IO
Partial Class App_UI_Application_Pages_Addressverified
    ...
    Public Sub BindData(Optional ByVal Condition As String = "")
        Try
            ...
            Dim sql As String = " select Cast(a.FormNo as varchar) as FormNo,Replace(CONVERT(varchar,a.Doj,106),' ','-')as Doj," & _
                                ...
                                " a.IDNo,RTRIM(a.MemFirstName +' ' +a.MemLastName) as MemName,a.Address1,a.City,a.Tehsil,b.Statename," & _
                                " a.Pincode,cm.Countryname,cm.stdcode,a.Fax,cASE WHEN c.BackAddressProof<>'' then c.BackAddressProof else '" & Session("CompWeb") & "/Images/no_photo.jpg' end as BackAdressProof," & _
                                ...
                                " From M_MemberMaster as a left join M_countryMaster as cm on a.countryid=cm.cid and cm.activeStatus='Y' and cm.rowstatus='Y',M_StatedivMaster as b,KycVerify as c Left Join  M_KycReject as f On c.AddressRejectId=f.Kid Left Join M_UserMaster as e On c.AddrssUserId=e.Userid and e.Rowstatus='Y' ,M_IdTypeMaster as d where c.IdType=d.Id and d.ActiveStatus='Y' " & _
    ...
    Protected Sub BtnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnExport.Click
        Try
            ...
            Dim sql As String = " select a.IDNo,RTRIM(a.MemFirstName +' ' +a.MemLastName) as MemberName,Replace(CONVERT(varchar,a.Doj,106),' ','-')as Doj," & _
                                " Case when a.Activestatus='Y' then Replace(CONVERT(varchar,a.UpgradeDate,106),' ','-') else '' End as ActivationDate," & _
                                " a.Address1,a.City,b.Statename," & _
                                " a.Pincode,cm.Countryname,cm.stdcode,d.IdType,c.IdProofNo," & _
                                ...
                                " Case when c.isAddrssVerified='R' then c.AddrssRemark else '' end as RejectRemark,Isnull(f.Reason, '')As RejectReason" & _
                                " From M_MemberMaster as a left join M_countryMaster as cm on a.countryid=cm.cid and cm.activeStatus='Y' and cm.rowstatus='Y'" & _
 " ,M_StatedivMaster as b,KycVerify as c Left Join  M_KycReject as f On c.AddressRejectId=f.Kid Left Join M_UserMaster as e On c.AddrssUserId=e.Userid and e.Rowstatus='Y' " & _
