<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddCountryBank.aspx.vb" Inherits="AddCountryBank" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12" style="padding-top :1%">
                                    <div class="col-md-4">
                                        Bank Name :</div>
                                    <div class="col-md-6">
                                        <asp:TextBox class="form-control" ID="txtBankName" runat="server"></asp:TextBox>
