...
Partial Class App_UI_Application_Pages_SeminarMasterNew
    ...
    Public Sub BindData()
        Dim sql As String = "Select IId,ImageType,CASE WHEN ActiveStatus='Y' Then 'Active' ELSE 'DeActive' END AS Status,Image From  M_SeminarMaster   "
    ...
    Protected Sub DeleteGroup(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim Sql As String = "Update M_SeminarMaster SET ActiveStatus='N' WHERE IId='" & Val(StateCode.ToString()) & "' "
