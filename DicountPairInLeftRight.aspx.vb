...
Partial Class DicountPairInLeftRight
    ...
    Public Sub BindData(ByVal PageIndex As Integer)
        Try
            ...
            'Else
            If txtAmounRight.Text <> "" Then
                Amount = txtAmounRight.Text.Trim
            Else
                Amount = "0"
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "Sp_GEt100PairInLeftRight", prms)
    ...
    Private Sub ExportExcel()
        ...
        Using wb As New XLWorkbook()
            wb.Worksheets.Add(dt, "ActivationPairInLeftRight")
            Response.Clear()
            Response.Buffer = True
            Response.Charset = ""
            Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
            Response.AddHeader("content-disposition", "attachment;filename=ActivationPairInLeftRight.xlsx")
