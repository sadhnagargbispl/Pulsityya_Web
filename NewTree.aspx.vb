...
Partial Class NewTree
    ...
    Private Sub GenerateTree(ByVal strQuery As String)
        ...
        For Each dr As DataRow In dtData.Rows
            ...
            If Session("CompID") = 1010 Or Session("CompID") = 1070 Or Session("CompID") = 1074 Or Session("CompID") = 1091 Or Session("CompID") = 1095 Or Session("CompID") = 1108 Then
                LeftCarryForward = dr.Item("LeftCarryForwardBv").ToString
                RightCarryForward = dr.Item("RightCarryForwardBv").ToString
            End If

            If Session("CompID") = 1061 Or Session("CompID") = 1108 Then
