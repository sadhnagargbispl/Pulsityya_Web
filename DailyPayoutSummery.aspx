<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="DailyPayoutSummery.aspx.vb" Inherits="App_UI_Application_Pages_DailyPayoutSummery"
                ...
                <div class="x_panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div style="background-color: White">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-3">
                                    <asp:Label ID="Label1" runat="server" Text="Gross Income(>=)"></asp:Label>
                                    <asp:TextBox ID="txtGrossIncome" runat="server" class="form-control" Text="0"></asp:TextBox>
                                    <ajax:FilteredTextBoxExtender ID="txtCharacters_FilteredTextBoxExtender" runat="server"
                                        Enabled="True" TargetControlID="txtGrossIncome" FilterType="Numbers" ValidChars="0123456789">
                                    </ajax:FilteredTextBoxExtender>
                                </div>
                                <div class="col-md-3">
                                    <asp:Label ID="Label2" runat="server" Text="Net Income (>=)"></asp:Label>
                                    <asp:TextBox ID="txtNetIncome" runat="server" class="form-control" Text="0"></asp:TextBox>
                                    <ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" Enabled="True"
                                        TargetControlID="txtNetIncome" FilterType="Numbers" ValidChars="0123456789">
                                    </ajax:FilteredTextBoxExtender>
                                </div>
                            </div>
                            <div class="col-md-12">
