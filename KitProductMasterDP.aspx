<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false"
    CodeFile="KitProductMasterDP.aspx.vb" Inherits="App_UI_Application_Pages_KitProductMasterDP"
    Title="" %>
                                    ...
                                    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" GridLines="None"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="DP">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="LblRate" CssClass="rate" Text='<%# Eval("DP") %>'></asp:Label>
                                                    
                                                    <asp:Label runat="server" ID="lblMrp" CssClass="rate" Text='<%# Eval("MRP") %>' Visible="false"></asp:Label>
                                            ...
                                            <asp:TemplateField HeaderText="Discount Amount">
                                              ...
                                              <asp:TemplateField HeaderText="Total Amount(Rs.)" HeaderStyle-Width="80px">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="LblAmt" Text='<%# Eval("DP")* Eval("Qty") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
