...
Imports System.IO
Partial Class App_UI_Application_Pages_FundLedgerReport
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Session("AStatus") = "OK" Then
            Session("PageName") = "Ledger / Fund Ledger Report"
        Else
    ...
    Protected Sub GvData_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles GvData.PageIndexChanging
        ...
        GvData.DataSource = Session("LedgerData")
        GvData.DataBind()
    End Sub
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Dim qry1 As String = ""
        qry1 = "select Replace(Convert(Varchar,FrmDate,106),' ','-') as [Payout Date], TotalJoin as [Total Joinning],TotalActive as [Total Activation]," & _
            " TotalActivePv as [Total Bv],MainFund as [Company Fund],MatchPair as [Match Pair],PaidAmount as [Paid Amount] ,MatchPairLess  as [Pair Matched Less Than Capping],CappingLess as [Fund Distributed Without capping],MatchPairAbove as [ Capping Pair ],CappingFund as [ Capping Fund],PairRate as [Pair Rate], " & _
          " ActRate as [Actual Rate] from D_SessnMaster  where FrmDate<= Dateadd(dd,-1, Convert( char(8) , Current_timestamp, 112 ))" & Condition & " "
