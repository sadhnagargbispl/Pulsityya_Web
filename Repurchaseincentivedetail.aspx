<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="Repurchaseincentivedetail.aspx.vb" Inherits="App_UI_Application_Pages_Repurchaseincentivedetail"
                            ...
                            <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="false" GridLines="Both"
                                ...
                                <Columns>
                                    <asp:TemplateField Visible="false">
                                        <ItemTemplate>
                                            <a href='MonthlyStatement.aspx?formno=<%# Eval("idno") %>&PayoutNo=<%# Eval("PayoutNo")%>'
