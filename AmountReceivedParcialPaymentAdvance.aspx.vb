...
Partial Class AmountReceivedParcialPaymentAdvance
    ...
    Private Sub PaymentDetails()
        Try
            ...
            End If
            strquery = " Sp_GetPartialPaymentReport '" & Idno & "','" & txtfrmdate.Text & "','" & txttodate.Text & "'"
    ...
    Private Sub ExportExcel()
        ...
        Using wb As New XLWorkbook()
            ...
            Response.AddHeader("content-disposition", "attachment;filename=AmountReceivedByFullPayment.xlsx")
