<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="EpinIssuedValueReport.aspx.vb" Inherits="App_UI_Application_Pages_EpinIssuedValueReport"
                        ...
                        <div>
                            <div align="center">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-1">
                                        <asp:CheckBox ID="ChkKit" runat="server" Text="Choose User :" /></div>
                                    <div class="col-md-2">
                                            ...
                                            <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                                ...
                                                <Columns>
                                                   <asp:BoundField DataField="SNo" HeaderText="SNO" SortExpression ="SNo" />
                                                    ...
                                                    <asp:BoundField DataField="EpinValue" HeaderText="EpinValue" SortExpression="EpinValue" />
                                                </Columns>
                                            </asp:GridView>
