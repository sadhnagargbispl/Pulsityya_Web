...
Partial Class App_UI_Application_Pages_IncentiveDetailReportNew
        ...
        Try
            ...
            Else
                ...
                If Session("compid") = "1096" Then
                    ...
                    divSummary.Visible = False
                    DivBsnReport.Visible = True
                Else
                    divDetail.Visible = False
                    divSummary.Visible = True
                    DivBsnReport.Visible = False
                End If
    ...
    Private Sub ExportExcel()
        ...
        Using wb As New XLWorkbook()
            ...
            If Session("compid") = "1096" Then
                Response.AddHeader("content-disposition", "attachment;filename=CoreTeamBonusReport.xlsx")
            Else
    ...
    End Sub
    Protected Sub GRDBSNVIEW_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs) Handles GRDBSNVIEW.RowDataBound

        If e.Row.RowType = DataControlRowType.Header Then
            ' Total Business -> Core Team Total Income
            If Session("compid") = "1096" Then
                e.Row.Cells(2).Text = "Core Team Total Income"
    ...
    Private Sub IncentiveSummary(ByVal PageIndex As Integer)
        Try
            ...
            If Session("compid") = "1096" Then
                GRDBSNVIEW.DataSource = Ds.Tables(0)
                GRDBSNVIEW.DataBind()
