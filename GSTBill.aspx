<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GSTBill.aspx.vb" Inherits="GSTBill" %>
...
<body class="fontStyle ">
    ...
    <div>
        <table border="1" align="center" cellspacing="0" width="70%">
            ...
            <tr>
                <td rowspan="1" class="removeborder" colspan ="2">
                Buyer,<br />
                ...
                <td rowspan="1" class="removeborder"><br />
            ...
            <tr>
                <td rowspan="1" colspan="3" class="removeborder">
                </td>
                <td colspan="2" class="rightBorderOnly">
                <asp:Label ID="LblBuyer" runat="server"></asp:Label>  <center> <strong ><asp:Label ID="lblRemarks" runat="server" Text="Terms Of Delivery" align="left"></asp:Label></strong> </center>
                </td>
            </tr>
            <tr>
                <td colspan="5">
