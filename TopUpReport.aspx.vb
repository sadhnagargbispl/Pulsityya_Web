        ...
        Try
            ...
            If ChkMember.Checked Then
                If txtMember.Text <> "" Then
                    formno = GetFormNo()
                    Condition = Condition & " and idno='" & txtMember.Text & "'"

                End If
            End If
            If ChkKit.Checked Then

                Condition = Condition & " And package='" & CmbKit.SelectedItem.Text & "' "
            End If
            If txtStartDate.Text <> "" Then
                Condition = Condition & "AND Cast(Convert(varchar,UpgradeDate,106) as Datetime) >='" & txtStartDate.Text & "'  "
            End If
            If txtEndDate.Text <> "" Then
                Condition = Condition & " And Cast(Convert(varchar,UpgradeDate,106) as Datetime)<='" & txtEndDate.Text & "' "

            End If
            Dim qry1 As String = ""
            qry1 = "select * from V#InvestmentDetailNew where 1=1 " & Condition & " Order by Cast(Convert(varchar,UpgradeDate,106) as Datetime) desc"
