...
Partial Class App_UI_Application_Pages_Newoxyglobal
    ...
    Public Sub BindFromDate()
        ...
        Try
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetMatrixDailySessionDetail")
    ...
    Public Sub BindData(ByVal PageIndex As Integer)
        ...
        Try
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetDailyMatrixPayoutDetail", prms)
    ...
    Private Sub ExportExcel()
        ...
        Using wb As New XLWorkbook()
            ...
            Response.AddHeader("content-disposition", "attachment;filename=OXYGLobalPayoutReport.xlsx")
