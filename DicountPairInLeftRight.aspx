<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false" CodeFile="DicountPairInLeftRight.aspx.vb" Inherits="DicountPairInLeftRight" title="Untitled Page" %>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>
                            Activation Pair In Left Right</h2>
                        <div class="clearfix">
                        </div>
                    </div>
                        ...
                        <div>
                            <div align="center">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                    No Of Pair:
                                        <asp:TextBox class="form-control" ID="txtAmounRight" runat="server" placeholder="No Of Pair"
