...
Protected Sub BtnAddNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnAddNew.Click
    ...
    Public Sub BindData()
        Dim sql As String = ""
        sql = "select * from V#SubCategoryList"
    ...
    Protected Sub DeleteGroup(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim Sql As String = "Update M_SubCatMaster SET ActiveStatus='N',LastModified='De-Activated by " & Session("UserName") & " at " & DateTime.Now.ToString() & "' WHERE SubCatID = '" & Val(KitId.ToString()) & "' AND RowStatus='Y'"
        Dim updateEffect As Integer = objDAL.UpdateData(Sql)
        If updateEffect <> 0 Then
            ScriptManager.RegisterStartupScript(Me, Me.[GetType](), "Key", "alert('Deleted Successfully.!');location.replace('SubCategoryMaster.aspx');", True)
