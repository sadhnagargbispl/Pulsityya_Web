...
Imports System.IO
Imports System.Net
Partial Class App_UI_Application_Pages_oxyLevelwithdrawls
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Session("AStatus") = "OK" Then
            Session("PageName") = " Wallet / Level withdrawls  "
        Else
    ...
    Public Sub BindSession()
        'Dim sql As String = "Select * From(Select 0 As SessID,'-- ALL --' As SessnName Union ALL select SessID,'Withdrawal Week '+Cast(SessID As Varchar)+' Date : '+ Replace(Convert(Varchar, frmDate,106),' ','-') +' to '+ Replace(Convert(Varchar, ToDate,106),' ','-') As SessnName from M_LvlSessnMaster Where ToDate Is Not Null) As Temp order by SessID"
        Dim sql As String = "SELECT * FROM (SELECT 0 AS SessID, '-- ALL --' AS SessnName "
        sql &= " UNION ALL "
        sql &= "SELECT SessID,'Withdrawal Week ' + CAST(SessID AS VARCHAR) + ' Date: ' + REPLACE(CONVERT(VARCHAR, frmDate, 106), ' ', '-') + ' to ' + REPLACE(CONVERT(VARCHAR, ToDate, 106), ' ', '-') AS SessnName "
        sql &= "FROM M_LvlSessnMaster WHERE ToDate IS NOT NULL) AS Temp "
        sql &= "ORDER BY CASE WHEN SessID = 0 THEN 0 ELSE 1 END,SessID DESC"
    ...
    Private Sub FillDetail()
        ...
        sql = " Select A.FormNo,A.Sno,dbo.FormatDate(ReqDate,'dd-MMM-yyyy') As WithDrawDate,C.IdNo As MemberID,A.PayeeName,ReqAmount As Amount" & _
           ...
           " ,Replace(Convert(Varchar,d.FrmDate,106),' ','-') as FromDate,Replace(Convert(varchar,d.ToDate,106),' ','-') as ToDate, " & _
            ...
            " ,Case when ChequeNo<> '' then dbo.FormatDate(ChequeDate,'dd-MMM-yyyy') else '' end  As ChequeDate,ChequeNo,PaymentMode From Levelwithdrawls As A Left join M_BankMaster   As B On  A.BankID=B.BankCode And " & _
         "  B.RowStatus='Y' And B.ActiveStatus='Y' ,M_MemberMaster As C,M_LvlSessnMaster AS D Where A.wsESSId=D.sESSID And A.FormNo=C.FormNo " & Condition & " Order by a.UserId, A.Formno"
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Try
            ...
            sql = "Select dbo.FormatDate(ReqDate,'dd-MMM-yyyy') As WithDrawDate,C.IdNo As MemberID,A.PayeeName,ReqAmount As Amount" & _
                ...
                " ,Replace(Convert(Varchar,d.FrmDate,106),' ','-') as FromDate,Replace(Convert(varchar,d.ToDate,106),' ','-') as ToDate, " & _
                " ''''+A.AcNo as AcNo, A.IFSCode, B.BankName, A.BranchName, A.PanNo From Levelwithdrawls As A Left join M_BankMaster " & _
               "  As B On  A.BankID=B.BankCode And    B.RowStatus='Y' And B.ActiveStatus='Y' ," & _
                " M_MemberMaster As C,M_LvlSessnMaster AS D Where A.wsESSId=D.sESSID And A.FormNo=C.FormNo " & Condition & "  Order by a.UserId, A.Formno"
            ...
            ExportToExcel("Levelwithdrawls.xls", dg)
    ...
    Protected Sub btnConfirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnConfirm.Click
        ...
        'Dim Sql As String = "Update Levelwithdrawls Set Status='A',IssueDate=GETDATE(),Remark='" & TxtRemark.Text & "',UserId='" & Val(Session("UserID")) & "',
        'UserName='" & Session("UserName") & "' Where Sno=" & lblID.Text & ";" & _
        Dim sql As String = "Update Levelwithdrawls Set Status='A',IssueDate=GETDATE(),Remark='" & TxtRemark.Text & "',PaymentMode='" & RbtPayment.SelectedItem.Text & "', " & _
    ...
    Protected Sub btnApprove_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnApprove.Click
        ...
        For Each Gvr As GridViewRow In GvData.Rows
            ...
            If Chk.Checked Then
                ...
                Dim Remark As String = ""
                Remark = "Withdrawal Approved Of Idno " & TxtIDNo.Text & " For WeekNo:" & LnblWeek.Text & " By " & Session("UserName") & ""
                Dim Sql As String = "Update Levelwithdrawls Set Status='A',IssueDate=GETDATE(),Remark='" & txtRemark.Text & "',UserId='" & Val(Session("UserID")) & "',UserName='" & Session("UserName") & "' Where Sno=" & LblId.Text & ";" & _
    ...
    Protected Sub BtnExportToCsv_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnExportToCsv.Click
        ...
        '     " ,Case when a.Status='P' Then '' else A.Remark end As Remark,UserName as ProcessedBy,Replace(Convert(varchar,IssueDate,106),' ','-') + ' '+ CONVERT(varchar(15),CAST(IssueDate AS TIME),100) as ProcessedDate,A.WSessID as WeekNo" & _
        '    " ,Replace(Convert(Varchar,d.FrmDate,106),' ','-') as FromDate,Replace(Convert(varchar,d.ToDate,106),' ','-') as ToDate, " & _
        '    " ''''+A.AcNo as AcNo, A.IFSCode, B.BankName, A.BranchName, A.PanNo From Levelwithdrawls As A Left Join M_BankMaster As B On  A.BankID=B.BankCode And " & _
        ...
        " from Levelwithdrawls as a,M_memberMaster as b   where a.Formno = b.Formno " & Condition & " Order by Sno "

        Dim dt As DataTable = objDAL.GetData(sql)
        Response.Clear()
        Response.Buffer = True
        Response.AddHeader("content-disposition", _
                "attachment;filename=Levelwithdrawls.csv")
        Response.Charset = ""
    ...
    Protected Sub btnRejectAll_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRejectAll.Click
        ...
        For Each Gvr As GridViewRow In GvData.Rows
            ...
            If Chk.Checked Then
                ...
                sql = sql & "Update Levelwithdrawls Set Status='R',IssueDate=GETDATE(),Remark='" & TxtRemark & "',UserId='" & Val(Session("UserID")) & "',UserName='" & Session("UserName") & "' Where Sno=" & Id & ";" & _
    ...
    Protected Sub btnReject_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReject.Click
        ...
        For Each Gvr As GridViewRow In GvData.Rows
            ...
            If Chk.Checked Then
                ...
                Dim WeekNo As String = DirectCast(Gvr.FindControl("LblWeek"), Label).Text
                Remark = "Withdrawal Rejected Of Idno " & IdNo & " for WeekNo:" & WeekNo & " By " & Session("UserName") & ""
                sql = sql & "Update Levelwithdrawls Set Status='R',IssueDate=GETDATE(),Remark='" & TxtARemark.Text & "',UserId='" & Val(Session("UserID")) & "',UserName='" & Session("UserName") & "' Where Sno=" & Id & ";" & _
