<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false" CodeFile="DirectNewJoining.aspx.vb" Inherits="DirectNewJoining" title="Untitled Page" %>
                                ...
                                <%--<div class="col-md-2">Search By</div>
                                    <div class="col-md-3">
                                        <asp:DropDownList ID="CmbKit" runat="server" class="form-control" AutoPostBack="true" >
                                            ...
                                            <asp:ListItem Text="By Self Wallet" Value="By Self Wallet"></asp:ListItem>
                                            <asp:ListItem Text="By Other Id Wallet" Value="By Other Id Wallet"></asp:ListItem>
                                            <asp:ListItem Text="By Franchisee" Value="By Franchisee"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>--%>
                                    <div class="col-md-3">
                                    BV:
                                        <asp:TextBox class="form-control" ID="txtAmount" runat="server" placeholder="BV"></asp:TextBox>
                                  <%--      <asp:DropDownList CssClass="form-control" ID="DDlFranchisee" runat="server" Visible ="false"></asp:DropDownList>
                                  --%>      </div>
                                       <div class="col-md-3">
                                       From Date
