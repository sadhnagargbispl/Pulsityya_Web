<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="ImageTypeMaster.aspx.vb" Inherits="App_UI_Application_Pages_ImageTypeMaster"
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <asp:Button ID="btnExport" runat="server" class="btn btn-primary" Text="Export To Excel"
                                        Visible="false" />
                                    <a href="AddImageType.aspx" onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 330,marginTop : 0 } )">
                                        <asp:Button ID="BtnAddNew" runat="server" class="btn btn-primary" Text="Add Image Type" /></a>
                                    ...
                                    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Modify" HeaderStyle-Width="85px" ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <a href='<%# "AddImageType.aspx?IId=" & Crypto.Encrypt(Eval("IId"))  %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 330,marginTop : 0 } )">
