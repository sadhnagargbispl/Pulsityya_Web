...
Partial Class App_UI_Application_Pages_ImageTypeMaster
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Session("AStatus") = "OK" Then
            Session("PageName") = "Master / Image Type Master"
        Else
    ...
    Public Sub BindData()
        Dim sql As String = "Select IId,ImageType,CASE WHEN ActiveStatus='Y' Then 'Active' ELSE 'DeActive' END AS Status From  M_ImageTypeMaster   "
    ...
    Protected Sub DeleteGroup(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim Sql As String = "Update M_ImageTypeMaster SET ActiveStatus='N' WHERE IId='" & Val(StateCode.ToString()) & "' "
    ...
    Protected Sub GvData_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GvData.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            If String.Equals(e.Row.Cells(2).Text.ToLower(), "deactive") = True Then
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Response.AddHeader("content-disposition", String.Format("attachment; filename={0}", "ImageTypeDetails.xls"))
