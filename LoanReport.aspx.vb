...
Partial Class LoanReport
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_IDLoan", prms)
    ...
    Public Sub BindData(ByVal PageIndex As Integer)
        ...
        Try
            ...
            Else
                endDate = txtEndDate.Text
            End If
            Dim str As String = "sp_IDLoan " '" & Idno & "','" & startDate & "','" & endDate & "','" & PageIndex & "','" & ddlPageSize.SelectedValue & "','N',1"
            ...
            Dim prms As SqlParameter() = New SqlParameter(6) {}
            prms(0) = New SqlParameter("@Idno", Convert.ToString(Idno).ToLower())
            '  prms(1) = New SqlParameter("@Loanno", Integer.Parse(AcType))
            prms(1) = New SqlParameter("@StartDate", Convert.ToDateTime(startDate))
            prms(2) = New SqlParameter("@EndDate", Convert.ToDateTime(endDate))
