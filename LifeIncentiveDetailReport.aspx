<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="LifeIncentiveDetailReport.aspx.vb" Inherits="LifeIncentiveDetailReport"
                        ...
                        <div style="padding: 10px 10px 20px 10px; overflow: scroll" id="divDetail" runat="server"
                            ...
                            <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="false" GridLines="Both"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="PayoutNo" HeaderText="Payout No" SortExpression ="PayoutNo" />
                                    ...
                                    <asp:TemplateField HeaderText=" Matching Bonus" SortExpression ="Matching Bonus">
                                        <ItemTemplate>
                                            <a href='<%# "ViewIncomeDetail.aspx?type="& Eval("PairIncome")  %>'
                                               ...
                                               <asp:Label ID="LblMatching" runat="server"  Text=' <%#Eval("Matching Bonus")%>' style="color:Blue"></asp:Label>
                                            </a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    
                                    <asp:TemplateField HeaderText=" Mentorship Bonus" SortExpression ="Mentorship Bonus">
                                        <ItemTemplate>
                                            <a href='<%# "ViewIncomeDetail.aspx?type="& Eval("PairIncentive")  %>'
                                                onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 350,marginTop : 0 } )">
                                               <asp:Label ID="LblMat" runat="server"  Text=' <%#Eval("Mentorship Bonus")%>' style="color:Blue"></asp:Label>
                                            </a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                             ...
                             <asp:BoundField DataField ="Previous Amount" HeaderText="Previous Amount" SortExpression ="Previous Amount" />
                             <asp:BoundField DataField ="Net Income" HeaderText="Net Income" SortExpression ="Net Income" />
                             <asp:BoundField DataField ="Closing Amount" HeaderText="Closing Amount" SortExpression ="Closing Amount" />
