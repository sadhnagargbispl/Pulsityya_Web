<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Mission365view.aspx.vb"
    Inherits="Mission365view" %>
...
<asp:TemplateField HeaderText ="SNo">
							...
							<%#Container.DataItemIndex + 1%>.
							 ...
							 <asp:BoundField DataField="idno" HeaderText="IDNo"  ></asp:BoundField>
								...
								<asp:BoundField DataField="PairIncome" HeaderText="Sales Incentive"  ></asp:BoundField>   
							  <asp:BoundField DataField="slab" HeaderText="slab"  ></asp:BoundField>
							  <asp:BoundField DataField="comm" HeaderText="Commision"  ></asp:BoundField>
							  <%--<asp:BoundField DataField="MemName" HeaderText="Member Name"  ></asp:BoundField>
								  <asp:BoundField DataField="Bonus" HeaderText="Bonus"  ></asp:BoundField>
								 <asp:BoundField DataField="Legno" HeaderText="Legno"  >	 </asp:BoundField>--%>    
