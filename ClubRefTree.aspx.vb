...
Partial Class ClubRefTree
    ...
    Private Function CheckDownLineMemberTree() As Boolean
        ...
        chk = False
        strQuery = " Select FormnoDwn FROM M_ClubTreeRelation  WHERE  FormNo=" & Request("DownLineFormNo")
    ...
    Private Sub GenerateTree(ByVal strQuery As String)
        ...
        Dim UpLiner, Sponsor, IMECode, CorpusName As String
        ...
        For Each dr As DataRow In dtData.Rows
            ...
            strUrlPath = "ClubRefTree.aspx?DownLineFormNo=" & FormNo
            ...
            myRunTimeString = myRunTimeString + " mytree.add(" & FormNo & "," & ParentId & "," & "'" & _
                                                                ...
                                                                level & "' ,'" & UpDt & "','" & CorpusName & "','" & idno & "');" + vbNewLine
        Next
    ...
    Private Function getQuery(ByVal strSelectedFormNo As String, ByVal minDeptLevel As Integer) As String
        ...
        getQuery = "exec sp_ShowClubTree " & strSelectedFormNo & "," & minDeptLevel
    End Function
