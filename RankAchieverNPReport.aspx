<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="RankAchieverNPReport.aspx.vb" Inherits="RankAchieverNPReport"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <asp:DropDownList ID="RbtWalletType" runat="server" AutoPostBack="true" CssClass="form-control"
                                        ...
                                        <asp:ListItem Text="Gold Achiever" Value="G"></asp:ListItem>
                                        <asp:ListItem Text="Silver Achiever" Value="S"></asp:ListItem>
                                    </asp:DropDownList>
