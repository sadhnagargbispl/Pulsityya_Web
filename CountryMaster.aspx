<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="CountryMaster.aspx.vb" Inherits="App_UI_Application_Pages_CountryMaster"
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            ...
                            <div class="col-md-12">
                                ...
                                <a href="AddCountry.aspx"  onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 350,marginTop : 0 } )">
                                    <asp:Button ID="BtnAddNew" runat="server" class="btn btn-primary" Text="Add Country" /></a>
               ...
               OnSorting="GvData_Sorting" PageSize="10" EmptyDataText="No data to display.">
                                    <Columns>
                                        <asp:TemplateField HeaderText="CountryCode" Visible="false" SortExpression="CountryCode">
                                            <ItemTemplate>
                                                <asp:Label ID="LblGrpID" runat="server" Text='<%# Eval("CountryCode") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="CountryName" HeaderText="Country Name" SortExpression="CountryName" />
                                         <asp:BoundField DataField="CountryCode" HeaderText="Country Code" SortExpression="CountryCode" />
                                          <asp:BoundField DataField="StdCode" HeaderText="Std Code" SortExpression="StdCode" />
                                       ...
                                       <asp:label Id="LblStatus" runat="server" Text='<%# Eval("Status") %>' class='<%# Eval("StatusClass") %>'></asp:label>
                                        ...
                                        <asp:TemplateField HeaderText="Modify" HeaderStyle-Width="85px" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <a href='<%# "AddCountry.aspx?CountryCode=" & Crypto.Encrypt(Eval("CID"))  %>'
