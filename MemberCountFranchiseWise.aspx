<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="MemberCountFranchiseWise.aspx.vb" Inherits="MemberCountFranchiseWise" %>
                                    ...
                                    <div class="col-md-12">
                                        <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="True" PageSize="20"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText=" Active Member Count" SortExpression="cnta" HeaderStyle-ForeColor="White">
                                                    <ItemTemplate>
                                                        <a class="btn btn-primary btn-xs" href='MemberDetails.aspx?Auid=<%# Eval("StateCode")%>'
                                                 ...
                                                 <asp:TemplateField HeaderText="De-Active Member Count" SortExpression="CntD" HeaderStyle-ForeColor="White">
                                                    <ItemTemplate>
                                                        <a class="btn btn-primary btn-xs" href='MemberDetails.aspx?Duid=<%# Eval("StateCode")%>'
                                                            onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 650,height: 600,marginTop : 0 } )">
                                                            <%#Eval("CntD")%></a>
                                                        <%-- <%#Eval("cnt")%>--%>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="StateNAme" SortExpression="StateNAme" HeaderStyle-ForeColor="White">
                                                    <ItemTemplate>
