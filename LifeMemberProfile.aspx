<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="LifeMemberProfile.aspx.vb" Inherits="LifeMemberProfile"
                            ...
                            <div align="center">
                                ...
                                <div id="doublescroll" class="col-md-12">
                                                ...
                                                <div id="gvContainer" runat="server" class="table table-bordered" style="overflow: scroll">
                                                    ...
                                                    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <%--<asp:BoundField DataField="Whatsappn" HeaderText="Whatsapp No." SortExpression="Whatsappn" />--%>
                                                            ...
                                                            <asp:BoundField DataField="KitAmount" HeaderText="Bill Amount" SortExpression="KitAMount" />
                                                            
                                                            <asp:BoundField DataField="Pv" HeaderText="PV/EP" SortExpression="Pv" />
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                <div id="gvContainer1" runat="server" class="table table-bordered" style="overflow: scroll">
                                                    <asp:Label ID="Label1" runat="server" Style="font-weight: bold; font-size: 12px;
                                                        color: Red"></asp:Label>
                                                    <asp:Label ID="Label3" runat="server" Style="font-weight: bold; font-size: 14px;
                                                        color: Gray"></asp:Label>&nbsp&nbsp&nbsp
                                                    <asp:Label ID="Label4" runat="server" Style="font-weight: bold; font-size: 14px;
                                                        color: Gray"></asp:Label>&nbsp&nbsp&nbsp
                                                    <asp:Label ID="Label5" runat="server" Style="font-weight: bold; font-size: 14px;
                                                        color: Gray"></asp:Label>&nbsp&nbsp&nbsp
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="BV" HeaderText="BV" SortExpression="KitAMount" />
