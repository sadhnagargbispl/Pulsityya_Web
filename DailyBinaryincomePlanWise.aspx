<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false"
    CodeFile="DailyBinaryincomePlanWise.aspx.vb" Inherits="DailyBinaryincomePlanWise"
    Title="" %>
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <div style="padding: 10px 10px 20px 10px">
                                                <asp:GridView ID="GrdTotal" Width="100%" runat="server" AllowPaging="false" PageSize="200"
                                                    ...
                                                    <Columns>
                                                        <asp:BoundField HeaderText="SNo" DataField="Sno" SortExpression="Sno" />
                                                        <asp:BoundField HeaderText="Payout Date" DataField="PayoutDate" SortExpression="PayoutDate" />
                                                        ...
                                                        <asp:BoundField HeaderText="Matching Income" DataField="BinaryIncome" SortExpression="BinaryIncome" />
                                                        <asp:TemplateField HeaderText="Direct Sponsor Income" SortExpression="SpillIncome">
                                                            <ItemTemplate>
                                                                <a href='<%# "ViewLevelIncomezara.aspx?Idno="& Eval("IdNo")&"&SessId="& Eval("SessId")  %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 620,height: 450,marginTop : 0 } )">
                                                                    <asp:Label ID="Label1" runat="server" ForeColor="Blue" Text='<%# Eval("SpillIncome") %>'></asp:Label></a>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Rank Income" SortExpression="MagicBinary">
                                                            <ItemTemplate>
                                                                <a href='<%# "ViewLevelIncome.aspx?Idno="& Eval("IdNo")&"&SessId="& Eval("SessId")  %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 620,height: 450,marginTop : 0 } )">
                                                                    <asp:Label ID="Label1" runat="server" ForeColor="Blue" Text='<%# Eval("MagicBinary") %>'></asp:Label></a>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField HeaderText="Gross Income" DataField="GrossIncome" SortExpression="GrossIncome"  />
                                                        <asp:BoundField HeaderText="TDS Amount" DataField="TDS Amount" SortExpression="TDS Amount" />
                                                        <asp:BoundField HeaderText="Admin Charge" DataField="Admin Charge" SortExpression="Admin Charge" />
                                                        <asp:BoundField HeaderText="Total Deduction" DataField="Total Deduction" SortExpression="Total Deduction" />
                                                        <asp:BoundField HeaderText="Net Income" DataField="NetIncome" SortExpression="NetIncome" />
                                                    </Columns>
                                                </asp:GridView>
