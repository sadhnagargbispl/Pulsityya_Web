...
Partial Class App_UI_Application_Pages_DailyIncentiveDetailReportPBWithS
    ...
    Public Sub BindFromDate()
        ...
        Try
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetDailySessionDetailPB ")
    ...
    Public Sub BindData(ByVal PageIndex As Integer)
        ...
        Try
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetDailyPayoutDetailPBWithS", prms)
