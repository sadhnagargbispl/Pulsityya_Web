...
Imports System.IO
Partial Class App_UI_Application_Pages_AdminHomeGH
...
" D.KitName,D.KitAmount,D.Bv,'Rs 0.00/-' As Balance,a.ActiveStatus,a.IsBlock,'' as CountryName,'false' as CountryVisible,'' as StdCode,a.TxnNo,a.CurType,a.CAmount, CAse when Replace(a.JoinType,'  ','N') = 'N'  Then 'Normal' Else 'Social'  End As JoinType From M_MemberMaster As A Inner Join M_StateDivMaster As B on A.StateCode=B.StateCode and  b.RowStatus='Y' " & _
" Left Join M_MemberMaster As C On A.RefFormNo=C.FormNo Left Join M_MemberMaster As e On A.UpLnFormNo=e.Formno Inner join M_kitMaster As D On A.KitID=D.KitID " & Condition & " Order by A.Doj Desc"
    ...
    Public Sub Exportdata()
        ...
        Try
            Dim sql As String = ""
            ' If Session("compid") <> "1025" Then
            sql = "Select Top 500 CAse when Replace(a.JoinType,'  ','N') = 'N'  Then 'Normal' Else 'Social'  End As JoinType,  A.IDNo,A.MemFirstName As MemName,C.IDNo As SponsorId,(C.MemFirstName +' '+C.MemLastName) as SponsorName," & _
            ...
            " and a.IsBlock='N' then 'Active' when a.IsBlock='Y' then 'Blocked' Else 'Pending' End As Status,'Rs 0.00/-' As Balance,a.ActiveStatus,a.TxnNo as TransactionNo,a.CurType as CurrencyType,a.CAmount as CurrencyAmount From M_MemberMaster As A with(nolock) " & _
