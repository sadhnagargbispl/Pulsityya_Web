...
function Node(id, pid, category,doj,name, nodename,
                ...
                leftjoin,rightjoin,IMECode,level,upgradeDt,CorpusName,idno) {
...
dTree.prototype.add = function(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, url, title, target, icon, iconOpen, open, leftjoin, rightjoin, IMECode, level, upgradeDt,CorpusName,idno) {

this.aNodes[this.aNodes.length] = new Node(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, url, title, target, icon, iconOpen, open, leftjoin, rightjoin, IMECode, level, upgradeDt,CorpusName,idno);
