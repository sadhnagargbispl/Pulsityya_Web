...
function Node(id, pid, category,doj,UpgradeDate,name, nodename,upliner,sponsor,leftbv,rightbv,DirctLeftActive, DirectRightActive,url, title, target, icon, iconOpen, open, GroupStatus) {
	this.id = id;
	this.pid = pid;
	this.name = name;
	this.url = url;
...
function dTree(objName, topicon) {
	...
	//root			: 'img/base.jpg',
	    root            : topicon,
	    folder: 'images/referalnew.gif',
	    folderOpen: 'images/referalnew.gif',
...
dTree.prototype.add = function(id, pid,category,doj,UpgradeDate, name, nodename,upliner,sponsor,leftbv,rightbv,DirctLeftActive, DirectRightActive,url, title, target, icon, iconOpen, open ,GroupStatus) {
	this.aNodes[this.aNodes.length] = new Node(id, pid,category,doj, UpgradeDate,name, nodename,upliner,sponsor,leftbv,rightbv,DirctLeftActive, DirectRightActive,url, title, target, icon, iconOpen, open,GroupStatus);
};
...
//            strTable += '</tr>';
		strTable += '<tr>';
		/*strTable += '<td bgcolor=#277AB1 ><font color=#FFFFFF FACE=Verdana SIZE=1><strong>Kit Name</strong></font></td>';*/
		strTable += '<td bgcolor=#277AB1 ><font color=#FFFFFF FACE=Verdana SIZE=1><strong>Joining Type</strong></font></td>';
		strTable += '<td ><font FACE=Verdana SIZE=1>' + node.category + '&nbsp;</font></td>';
		strTable += '</tr>';
		strTable += '<tr>';
            ...
            strTable += '</tr>';
//		 if (node.GroupStatus != 'undefined' && node.GroupStatus != '') {
//		strTable += '<tr>';
//		strTable += '<td bgcolor=#277AB1 ><font color=#FFFFFF FACE=Verdana SIZE=1><strong>Position</strong></font></td>';
//		strTable += '<td ><font FACE=Verdana SIZE=1>' + node.GroupStatus + '&nbsp;</font></td>';
//		strTable += '</tr>';
//		}
		strTable += '</table>\'';
		if (node.pid == -1) {
