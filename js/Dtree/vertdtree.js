...
function Node(id, pid, category,doj,name, nodename,
                ...
                leftjoin,rightjoin,leftactive,rightactive,level,upgradeDt) {
...
dTree.prototype.add = function(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, url, title, target, icon, iconOpen, open, leftjoin, rightjoin, leftactive, rightactive, level, upgradeDt) {

this.aNodes[this.aNodes.length] = new Node(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, url, title, target, icon, iconOpen, open, leftjoin, rightjoin, leftactive, rightactive, level, upgradeDt);
...
//		strTable+='</tr>'; 
		...
		strTable+='<tr>';
		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Distributor Name :</font></td>';  
	...
	strTable+='<tr>'; 
		...
		strTable+='<tr>'; 
			strTable+='<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Referal :</font></td>';  
		...
		strTable+='<tr>'; 
			strTable+='<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Date of Purchase :</font></td>';  
		...
		strTable+='</tr>';
		strTable += '<tr>';
		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Active Status :</font></td>';
		strTable += '<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>LEFT :' + node.leftactive + ', RIGHT :' + node.rightactive + '</font></td>';
		strTable += '</tr>';    
		...
		strTable+='<tr>';
		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Business Volume :</font></td>';
