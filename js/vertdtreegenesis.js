...
function Node(id, pid, category,doj,name, nodename,
                ...
                leftjoin,rightjoin,level,upgradeDt,LeftCarryForward,RightCarryForward,IdNo,ActiveDirect,ActiveIndirect,IsBlock,BlockStatus) {
	...
	this.LeftCarryForward = LeftCarryForward;
	this.RightCarryForward = RightCarryForward;
	this.IdNo = IdNo;
...
function dTree(objName,topicon) {
	...
	this.icon = {
		...
		middleLine: 'images/myline2.gif',

		leftLine: 'images/myline2.gif',

		smallLine: 'images/smallLine.gif',

		rightLine: 'images/myline2.gif'
...
dTree.prototype.add = function(id, pid,category,doj, name, nodename,upliner,sponsor,leftbv,rightbv,url, title, target, icon, iconOpen, open,leftjoin,rightjoin,level,upgradeDt,LeftCarryForward,RightCarryForward,IdNo,ActiveDirect,ActiveIndirect,IsBlock,BlockStatus) {

this.aNodes[this.aNodes.length] = new Node(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, rightbv, url, title, target, icon, iconOpen, open, leftjoin, rightjoin, level, upgradeDt, LeftCarryForward, RightCarryForward, IdNo, ActiveDirect, ActiveIndirect, IsBlock, BlockStatus);
...
//		strTable+='</tr>'; 
	...
	/*	strTable+='<tr>'; 
		...
		strTable += '</tr>';
		strTable += '<tr>';
		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>CarryForward EV :</font></td>';
		strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Group A</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.LeftCarryForward + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Group B</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.RightCarryForward + '</font></td></tr></table></font></td>';
