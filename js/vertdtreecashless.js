...
function Node(id, pid, category,doj,name, nodename,
                ...
                leftjoin,rightjoin,level,upgradeDt,LeftCarryForward,RightCarryForward,IdNo,ActiveDirect,ActiveIndirect,
                IsBlock,BlockStatus) {
...
dTree.prototype.add = function(id, pid,category,doj, name, nodename,upliner,sponsor,leftbv,rightbv,url, title, target, 
icon, iconOpen, open,leftjoin,rightjoin,level,upgradeDt,LeftCarryForward,RightCarryForward,IdNo,ActiveDirect,
ActiveIndirect,IsBlock,BlockStatus) {

this.aNodes[this.aNodes.length] = new Node(id, pid, category, doj, name, nodename, upliner, sponsor, leftbv, 
rightbv, url, title, target, icon, iconOpen, open, leftjoin, rightjoin, level, upgradeDt, LeftCarryForward, 
RightCarryForward, IdNo, ActiveDirect, ActiveIndirect, IsBlock, BlockStatus);
...
//		strTable+='<tr>'; 
//			strTable+='<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>Upliner ID :</font></td>';  
//			strTable+='<td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>'+ node.UplinerFormno + '</font></td>'; 
//		strTable+='</tr>';
...
//		}
		...
		strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Left</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.leftjoin + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Right</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.rightjoin + '</font></td></tr></table></font></td>';
		strTable += '</tr>';
		strTable += '<tr>';
		...
		strTable += '</tr>';
		strTable += '<tr>';
		strTable += '<td ' + tooltiptdlbl + '><font ' + tooltipfontlbl + '>CarryForward Pv :</font></td>';
