    ...
    if (this.config.useIcons) {
        ...
        if (node.IsBlock != 'Y') {
            ...
            */
            ...
            strTable += '<td ' + tooltiptdtxt + '><table width=100% border=1 cellpadding=1 cellspacing=0 bgcolor=#ffffff ><tr><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Left</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>' + node.LeftCarryForward + '</font></td><td ' + tooltiptdtxt + '><font ' + tooltipfonttxt + '>Right</font></td><td ' + tooltiptdtxt + '> <font ' + tooltipfonttxt + '>' + node.RightCarryForward + '</font></td></tr></table></font></td>';
