<%--<%@ Page Title="" Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false" CodeFile="MemberProfileNew.aspx.vb" Inherits="MemberProfileNew" %>
--%>

<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="MemberProfileNew.aspx.vb" Inherits="App_UI_Application_Pages_MemberProfileNew"
                        ...
                        <div class="col-md-12">
                            <div align="center">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <asp:Label ID="Label1" runat="server" Text="Paln Type: "></asp:Label>
                                        <asp:DropDownList ID="CmbPaln" runat="server" CssClass="form-control" AutoPostBack="true"
                                            OnSelectedIndexChanged="CmbPaln_SelectedIndexChanged">
                                            <asp:ListItem Value="1" Selected="True">Plan A</asp:ListItem>
                                            ...
                                            <ContentTemplate>
                                                <div id="gvContainer" runat="server" class="table table-bordered" style="overflow: scroll;">
                                                    ...
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                                        ...
                                                        ShowHeader="true" AllowSorting="true" OnSorting="GridView1_Sorting" PageSize="10"
                                                        EmptyDataText="No data to display." ForeColor="black" HeaderStyle-ForeColor="white"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="DOJ" HeaderText="DOJ" SortExpression="DOJ" />
                                                              <asp:BoundField DataField="PackageNamePlanA" HeaderText="PackageName Plan A" SortExpression="PackageNamePlanA" />
                                                            <asp:BoundField DataField="UpgradeDateplanA" HeaderText="Date of Activation Plan A" SortExpression="UpgradeDateplanA" />
                                                          
                                                            <asp:BoundField DataField="PackageNameplanB" HeaderText="PackageName Plan B" SortExpression="PackageNameplanB" />
                                                                <asp:BoundField DataField="UpgradeDateplanB" HeaderText="Date of Activation Plan B" SortExpression="UpgradeDateplanB" />
                                                            ...
                                                            <asp:TemplateField>
                                                                <HeaderTemplate>
                                                                    <asp:Label ID="lblEVBV" runat="server" Text="BV"></asp:Label>
                                                                </HeaderTemplate>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblValue" runat="server" Text='<%# If(Session("compid") IsNot Nothing AndAlso Session("compid").ToString() = "1110", Eval("BV"), Eval("PV")) %>'>
                                                                    </asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                    ...
                                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                                        GridLines="Both" AllowPaging="False" class="table table-bordered" HeaderStyle-CssClass="bg-primary"
                                                        ShowHeader="true" AllowSorting="true" OnSorting="GridView2_Sorting" PageSize="10"
                                                        EmptyDataText="No data to display." ForeColor="black" HeaderStyle-ForeColor="white"
                                                        ...
                                                        <Columns>
                                                          ...
                                                          <%--  <asp:BoundField DataField="UpgradeDate" HeaderText="Date of Activation Plan B" SortExpression="UpgradeDate" />
                                                            <asp:BoundField DataField="PackageName" HeaderText="PackageName Plan B" SortExpression="PackageName" />--%>
                                                            <asp:BoundField DataField="SponsorId" HeaderText="SponsorId" SortExpression="SponsorId" />
                                                            <asp:BoundField DataField="Sponsorname" HeaderText="SponsorName" SortExpression="Sponsorname" />
                                                            <asp:BoundField DataField="Password" HeaderText="Password" SortExpression="Password" />
                                                            <asp:BoundField DataField="EPassWord" HeaderText="Transaction Password" SortExpression="EPassWord" />
