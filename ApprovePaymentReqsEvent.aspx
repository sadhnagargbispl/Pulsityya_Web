<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="ApprovePaymentReqsEvent.aspx.vb" Inherits="ApprovePaymentReqsEvent" %>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>
                            Vadic Gurukul Event Fund Report</h2>
                        <div class="clearfix">
                        </div>
                    </div>
                            ...
                            <div align="center">
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                        ...
                                        <asp:TextBox runat="server" Enabled="false" ID="TxtMemID" class="form-control"></asp:TextBox>
                                    </div>
                                    <div class="col-md-3" style="padding: 9px;">
                                ...
                                <span style="font-size: 10px; font-weight: bold; margin-bottom: 11px; margin-top: 8px;
                                    padding-left: 10px; display: none;">Please Verify Page By Page</span>
