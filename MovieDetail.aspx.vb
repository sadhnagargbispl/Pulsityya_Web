...
Partial Class App_UI_Application_Pages_MovieDetail
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        Try
            If Session("AStatus") = "OK" Then
                Session("PageName") = " Report / Rank Achiever Report"
            Else
    ...
    Private Sub RebindData(ByVal sColimnName As String, ByVal sSortOrder As String)
        Try
            ...
            Dim dt As DataTable = CType(Session("RewardList"), DataTable)
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Try
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetMovieDetail", prms)
    ...
    Private Sub ExportExcel()
        ...
        Using wb As New XLWorkbook()
            wb.Worksheets.Add(dt, "MovieDetail")
            Response.Clear()
            Response.Buffer = True
            Response.Charset = ""
            Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
            Response.AddHeader("content-disposition", "attachment;filename=MovieDetail.xlsx")
        ...
        Try
            ...
            If Ds.Tables(1).Rows(0)("RecordCount") > 0 Then
                For i As Integer = 0 To GvData.Columns.Count - 1
                    ...
                    tableCell.Controls.Add(img)
                Next
                lblCount.Text = "Total Record : " & recordCount
                GvData.Visible = True
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        'End If
        'If txtStartDate.Text <> "" Then
        '    Condition = Condition & " And  Cast(Convert(Varchar,b.RectimeStamp,106) as DateTime)>='" & txtStartDate.Text & "'"
        'End If
        'If txtEndDate.Text <> "" Then
        '    Condition = Condition & " And Cast(Convert(Varchar,b.RectimeStamp,106)as DateTime)<='" & txtEndDate.Text & "'"
        'End If
        'Dim qry1 As String = ""
        'qry1 = " Select a.idno as Memberid,(a.MemFirstName+' '+a.MemLastName)As MemberName,a.mobl as MobileNo," & _
        '             " Replace(Convert(varchar,b.Rectimestamp,106),' ','-') as RequestDate from M_Membermaster " & _
        '           " as a,MovieTickets as b where a.formno=b.formno " & Condition & ""
        ...
        '    ViewState("WithDrawDate") = "Memberid"
        '    ViewState("Sort_Order") = "ASC"
        'Else
        '    GvData.Visible = False
        '    gvContainer.Visible = False
