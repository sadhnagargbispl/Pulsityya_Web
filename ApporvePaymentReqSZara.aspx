<%--<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ApporvePaymentReqSZara.aspx.vb" Inherits="ApporvePaymentReqSZara" %>
--%>
<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="ApporvePaymentReqSZara.aspx.vb" Inherits="ApporvePaymentReqSZara" %>
                                        ...
                                        <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="PayMode" HeaderText="Payment Mode"></asp:BoundField>
                                                  <asp:BoundField DataField="walletname" HeaderText="Wallet Name"></asp:BoundField>
