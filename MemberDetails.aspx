<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MemberDetails.aspx.vb" Inherits="MemberDetails" %>
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="GvData" runat="server" CssClass="table datatable" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                  ...
                                                  <%--  <asp:BoundField HeaderText="De-Active Member" DataField="DeActCnt" />
                                                    <asp:BoundField HeaderText="Total Member" DataField="Total" />--%>
