<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="MisReportBS.aspx.vb" Inherits="MisReportBS" %>
                            ...
                            <div class="table-responsive makeitresponsivegrid">
                                <div align="center">
                                    <div class="col-md-12" style="min-height: 250px;">
                                        <table class="table-responsive">
                                            <div class="col-md-3" id="lbllevel" runat="server">
                                                Date :
                                                <asp:TextBox ID="TxtToDate" runat="server" class="form-control" onkeypress="return false;"></asp:TextBox>
                                                <AjaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtToDate"
                                                    Format="dd-MMM-yyyy" CssClass="PopCal">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <asp:GridView ID="gvpay" Width="100%" runat="server" AllowPaging="True" PageSize="100"
                                            AutoGenerateColumns="true" ForeColor="Black" class="table table-bordered" HeaderStyle-CssClass="bg-primary"
                                            EmptyDataText="No data to display." GridLines="None">
                                        </asp:GridView>
                                    </div>
