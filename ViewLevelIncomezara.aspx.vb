...
Partial Class ViewLevelIncomezara
    ...
    Public Sub BindData(Optional ByVal SrchCond As String = "")
        Try
            ...
            If Session("compid") = "1095" Then
                sql1 = " Exec SP_RefferalIncome '" & Val(formno) & "','" & Request("Sessid") & "'"
            Else
                sql1 = " Exec Sp_GetLevelIncomeReporttt '" & Val(formno) & "','" & Request("Sessid") & "'"
            End If
            dtData = New DataTable
            dtData = objDAL.GetData(sql1)
            GvData.DataSource = dtData
            GvData.DataBind()
            Session("LevelIncomeData") = dtData
    ...
    Protected Sub GvData_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles GvData.PageIndexChanging
        ...
        GvData.DataSource = Session("LevelIncomeData")
        GvData.DataBind()
    End Sub
