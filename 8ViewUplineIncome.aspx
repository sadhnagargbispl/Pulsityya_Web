<%@ Page Language="VB" AutoEventWireup="false" CodeFile="8ViewUplineIncome.aspx.vb" Inherits="ViewUplineIncome" %>
    ...
    <div style="margin-bottom: 10px; padding-right: 20px; padding-top: 20px">
        <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="5px"
            ...
            <Columns>
             ...
             <asp:BoundField DataField="TotalBonus" HeaderText="Total Bonus"></asp:BoundField>
                <asp:BoundField DataField="TotalActiveMember" HeaderText="Total Active Member"></asp:BoundField>
