<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="Newdailyincome.aspx.vb" Inherits="App_UI_Application_Pages_Newdailyincome"
    Title="" %>
                                            ...
                                            <div style="padding: 10px 10px 20px 10px">
                                                ...
                                                OnSorting="GrdTotal_Sorting">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="First Purchase Bonus" SortExpression="BinaryIncome">
                                                            <ItemTemplate>
                                                                <asp:Label ID="LblMhing" runat="server" Text='<%# Eval("BinaryIncome") %>'></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        
                                                           <asp:TemplateField HeaderText="Sponsor Matching Bonus" SortExpression="SpillIncome">
                                                            <ItemTemplate>
                                                                <asp:Label ID="LblMatching" runat="server" Text='<%# Eval("SpillIncome") %>'></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        
                                                           <asp:TemplateField HeaderText="Upliner Bonus" SortExpression="MagicBinary">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Lblg" runat="server" Text='<%# Eval("MagicBinary") %>'></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Leadership Bonus" SortExpression="SLIIncome">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Lbtching" runat="server" Text='<%# Eval("SLIIncome") %>'></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="TDS Amount" SortExpression="TDSAmount">
                                                            <ItemTemplate>
                                                                <asp:Label ID="LblMatchPair" runat="server" Text='<%# Eval("TDSAmount") %>'></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Admin Charge" SortExpression="Admincharge">
                                                            <ItemTemplate>
                                                                <asp:Label ID="LblMatchPair" runat="server" Text='<%# Eval("Admincharge") %>'></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Repurchase Deduction" SortExpression="CouponsAmt">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Lblcoupon" runat="server" Text='<%# Eval("CouponsAmt") %>'></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                
                                                         <asp:TemplateField HeaderText="Total Deduction" SortExpression="Deduction">
                                                            <ItemTemplate>
                                                                <asp:Label ID="LblMatchPair" runat="server" Text='<%# Eval("Deduction") %>'></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                       
                                                       <%-- <asp:TemplateField HeaderText="Net Income " SortExpression="ChqAmt">
                                                            <ItemTemplate>
                                                                <asp:Label ID="LblTotalClosing" runat="server" Text='<%# Eval("ChqAmt") %>'></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>--%>
                                                         <asp:TemplateField HeaderText="Main Wallet" SortExpression="Mainwallet">
                                                            <ItemTemplate>
                                                                <asp:Label ID="LblMacng" runat="server" Text='<%# Eval("Mainwallet") %>'></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        
                                                         <asp:TemplateField HeaderText="Upgrade Wallet" SortExpression="upgrdwallet">
                                                            <ItemTemplate>
                                                                <asp:Label ID="LblMacngsdff" runat="server" Text='<%# Eval("upgrdwallet") %>'></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                          <asp:TemplateField HeaderText="Repurch Wallet" SortExpression="Repurchwallet">
                                                            <ItemTemplate>
                                                                <asp:Label ID="LblRepurch" runat="server" Text='<%# Eval("Repurchwallet") %>'></asp:Label><br />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
