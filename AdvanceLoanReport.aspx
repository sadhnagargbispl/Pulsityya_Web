<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="AdvanceLoanReport.aspx.vb" Inherits="App_UI_Application_Pages_WalletTransactionReport"
                            ...
                            <div class="table-responsive makeitresponsivegrid" style="min-height: 500px;">
                                <div align="center">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <a href="loanTransfer.aspx" onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 470,marginTop : 0 } )">
                                                    <asp:Button ID="BtnAddNew" runat="server" CssClass="btn btn-primary " Text="Add New Loan" /></a>
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="S.No">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="lBlRefNo" runat="server" Text='<%# Eval("RefNo") %>' Visible="false"></asp:Label></ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="IdNo" HeaderText="Idno" />
                                                <asp:BoundField DataField="MemberName" HeaderText="Member Name" />
                                                <asp:BoundField DataField="City" HeaderText="City"></asp:BoundField>
                                                <asp:BoundField DataField="State" HeaderText="State"></asp:BoundField>
                                                <asp:BoundField DataField="LoanDate" HeaderText="Loan Date"></asp:BoundField>
                                                <asp:BoundField DataField="LoanAmount" HeaderText="Loan Amount" />
                                                <asp:BoundField DataField="RecoverAmount" HeaderText="Recover Amount"></asp:BoundField>
                                                <asp:BoundField DataField="DueAmount" HeaderText="Due Amount"></asp:BoundField>
                                                <asp:BoundField DataField="LoanDescription" HeaderText="Loan Description" />
                                                ...
                                                <asp:TemplateField HeaderText="Modify" HeaderStyle-Width="55px" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:Panel ID="PanlModify" runat="server" BackColor="Transparent">
                                                            <a class="btn btn-primary" href='<%# "loanTransfer.aspx?key=" & Eval("Formno") &"&LoanNo="&Eval("RefNo")  %>'
