<%@ Page Language="VB" AutoEventWireup="false" CodeFile="loanTransfer.aspx.vb" Inherits="App_UI_Application_Pages_FundTransfer"
     %>
                        ...
                        <div class="x_panel">
                            ...
                            <ContentTemplate>
                                ...
                                <div class="col-md-12" style="padding-top: 3%">
                                    ...
                                    <div class="col-md-6">
                                        <asp:RadioButtonList ID="RntLoan" runat="server" RepeatColumns="2" RepeatDirection="Horizontal"
                                            AutoPostBack="true">
                                ...
                                <div class="col-md-12" style="padding-top: 3%" id="PLoanPercent" runat="server" >
                                    <div class="col-md-4">
                                        Loan Percent%:
                                        </div>
                                        <div class="col-md-6">
                                            <asp:TextBox ID="Txtloan" runat="server" CssClass="form-control" onkeypress="return isNumberKey1(event);"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="* Enter Loan Recovery %."
                                                ControlToValidate="Txtloan" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="col-md-2">
                                        </div>
                                    </div>
                                    <div class="col-md-12" style="padding-top: 3%">
                                        ...
                                        <div class="col-md-12" style="padding-top: 3%">
                                            <asp:Button ID="BtnFundTransfer" runat="server" Text="Loan Transfer" OnClientClick="return confirmation();"
