<%@ Page Title="" Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false" CodeFile="payoutsum.aspx.vb" Inherits="App_UI_Application_Pages_payoutsum" %>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-2">
                            <asp:DropDownList ID="ddlSession1" runat="server" class="form-control" Style="text-indent: 1px;">
                            </asp:DropDownList>
                        ...
                        <div style="padding: 10px 10px 20px 10px;overflow:scroll" id="divDetail" runat="server" visible="false" >
                            <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="false" GridLines="Both"
                                ...
                                <Columns >
                                   <asp:TemplateField>
                                                            <ItemTemplate>
                                                               <%-- <a href='MonthlyStatement.aspx?formno=<%# Eval("idno") %>&PayoutNo=<%# Eval("PayoutNo")%>' target="_blank" style="color: Blue;">
                                                                    Statement</a>--%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                              </Columns>
                                <%--<Columns>
                                    ...
                                    <asp:TemplateField HeaderText="SNo" Visible="false">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="StartDate" runat="server" Text='<%# Eval("PayoutDate") %>' Visible="false"></asp:Label>
                                    ...
                                    <asp:BoundField DataField="PayoutDate" HeaderText="PayoutDate" SortExpression="PayoutDate" />
                                    <asp:TemplateField HeaderText="Member Id" SortExpression="IdNo">
                                        <ItemTemplate>
                                            <asp:Label ID="LblMemId" runat="server" Text='<%# Eval("IDNo") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Member Name" SortExpression="MemName">
                                        <ItemTemplate>
                                            <asp:Label ID="LblFullName" runat="server" Text='<%# Eval("MemName") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="MobileNo" SortExpression="Mobl">
                                        <ItemTemplate>
                                            <asp:Label ID="LblMobl" runat="server" Text='<%# Eval("Mobl") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            
                                     <asp:BoundField DataField="MagicIncome" HeaderText="Royalty" SortExpression="MagicIncome" />
                    
                                           
                                    <asp:BoundField DataField="NetIncome" HeaderText="Gross Income" SortExpression="NetIncome" />
                                    ...
                                    <asp:TemplateField HeaderText="Admin charge" SortExpression="admincharge">
                                        <ItemTemplate>
                                            <asp:Label ID="Lbladminchrg" runat="server" Text='<%# Eval("admincharge") %>'></asp:Label><br />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                      <asp:TemplateField HeaderText="Repurchase Deduction" SortExpression="CouponsAmt">
                                        <ItemTemplate>
                                            <asp:Label ID="LblNetIncome" runat="server" Text='<%# Eval("CouponsAmt") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Total Deduction" SortExpression="Deduction">
                                        <ItemTemplate>
                                            <asp:Label ID="Lbldeduction" runat="server" Text='<%# Eval("Deduction") %>'></asp:Label><br />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Previous" SortExpression="PrevBal">
                                        <ItemTemplate>
                                            <asp:Label ID="LblPrevious" runat="server" Text='<%# Eval("PrevBal") %>'></asp:Label><br />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Net Amount" SortExpression="ChqAmt">
                                        <ItemTemplate>
                                            <asp:Label ID="LblNet" runat="server" Text='<%# Eval("ChqAmt") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    
                                    <asp:TemplateField HeaderText="Closing" SortExpression="ClsBal">
                                        <ItemTemplate>
