...
{
    public class R_CouponReport : I_CouponReport
    {
        public IEnumerable<E_CouponDetail> GetCoupondetail(string UserId, string FormNo)
        ...
        public IEnumerable<E_OrderReport> GetGrdOrderNoDetail(string OrderId, string userid)
        {
            ...
            dt = blldb.GetDataTable("Sp_GetOrderHistory", CommandType.StoredProcedure, hst);
