...
Imports System.IO
Imports System.Net
Partial Class RepurchaseVoucher
    ...
    Protected Sub ApproveData(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            sql = "Update Repurchasevoucher Set Isused='Y' ,UsedDate=Getdate(),Remark='" & Remark & "',Userid='" & Session("UserId") & "' where formno='" & formno & "' and VoucherNo='" & VoucherNo & "' and Isused='N'"
            Dim i As Integer = 0
    ...
    Private Sub FillDetail()
        ...
        'sql = " exec sp_GetVoucher '" & Idno & "','" & VoucherNo & "','" & RbtStatus.SelectedValue & "','" & Convert.ToDateTime(startDate) & "','" & Convert.ToDateTime(endDate) & "','1',10,'N',1"
        dtData = New DataTable

        dtData = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetVoucher", prms).Tables(0)
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Try
            ...
            ExportToExcel("RepurchaseVoucher.xls", dg)
