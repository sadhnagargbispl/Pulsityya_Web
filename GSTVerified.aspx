<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="GSTVerified.aspx.vb" Inherits="GSTVerified" EnableEventValidation="true" %>
                                ...
                                <div class="col-md-12" style="overflow: scroll">
                                    ...
                                    <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="GST Certificate" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <%#Eval("Link")%>
                                                    <br />
