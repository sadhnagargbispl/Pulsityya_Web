<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="RewardAchieverReport.aspx.vb" Inherits="App_UI_Application_Pages_RewardAchieverReport"
                        ...
                        <div align="center">
                            ...
                            <div class="table-responsive makeitresponsivegrid" style="min-height: 500px;">
                                <div align="center">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-2" runat="server" id="RbReqStatusid">
                                                <asp:Label ID="Label5" runat="server" Text="Rank "></asp:Label>
                                                <asp:RadioButtonList ID="RbReqStatus" runat="server" RepeatDirection="Horizontal"
                                                    RepeatLayout="Table" AutoPostBack="true">
                                                    <asp:ListItem Text="All Rank" Value="A" Selected="True"></asp:ListItem>
                                                    <asp:ListItem Text="New Rank" Value="N"></asp:ListItem>
                                                </asp:RadioButtonList>
                                            </div>
                                            <div class="col-md-2">
                                                <asp:Label ID="Label2" runat="server" Text="Rank\Reward "></asp:Label>
                                            ...
                                            <div class="col-md-3" runat="server" id="sessiddate">
                                                <asp:Label ID="Label6" runat="server" Text="From To Todate"></asp:Label>
                                                <asp:DropDownList ID="ddlSession" runat="server" class="form-control" Style="text-indent: 1px;">
                                                </asp:DropDownList>
                                            </div>
                                            <div runat="server" id="noramldate">
                                                <div class="col-md-2">
                                    ...
                                    <div class="col-md-12">
                                        <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="True" PageSize="20"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="SNo.">
                                                 ...
                                                 <asp:TemplateField HeaderText="Achiever Date">
                                                    <ItemTemplate>
                                                        <%#Eval("Date")%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                        ...
                                        <asp:GridView ID="GridView2" Width="100%" runat="server" AllowPaging="True" PageSize="20"
                                            ...
                                            <Columns>
                                                ...
                                                <%--  <asp:TemplateField HeaderText="Member IDNo">
                                                    <ItemTemplate>
                                                        <%#Eval("[IDNo]")%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                  ...
                                                  <asp:TemplateField HeaderText="Sponser IDNo">
                                                    <ItemTemplate>
                                                        <%#Eval("[Sponser IDNo]")%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                        ...
                                        <asp:GridView ID="GridView1" Width="100%" runat="server" AllowPaging="True" PageSize="20"
                                            AutoGenerateColumns="false" ForeColor="Black" class="table table-bordered" HeaderStyle-CssClass="bg-primary"
                                            EmptyDataText="No data to display." GridLines="None">
                                            <Columns>
                                                <asp:TemplateField HeaderText="SNo.">
                                        ...
                                        <asp:GridView ID="GridView3" Width="100%" runat="server" AllowPaging="True" PageSize="20"
                                            AutoGenerateColumns="True" ForeColor="Black" class="table table-bordered" HeaderStyle-CssClass="bg-primary"
                                            EmptyDataText="No data to display." GridLines="None">
                                            <Columns>
                                                <asp:TemplateField HeaderText="SNo.">
