...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:FileUpload ID="Fuidentity" runat="server"
                                                    ...
                                                    onchange="if(validatePdfUpload(this)){previewFile(this,'Fssai');}else{removePrev('Fssai');}" />
                                                <asp:Label ID="lblimage" runat="server" Visible="false"></asp:Label>

                                                <!-- Upload preview (PDF icon + name + size + view) -->
                                                <div class="kyc-prev" id="prevFssai" style="display:none; margin-top:10px; border:1.5px solid #4CAF50; border-radius:10px; padding:10px 12px; background:#f6fff6; align-items:center; gap:12px;">
                                                    <div style="position:relative; flex-shrink:0; cursor:pointer;" onclick="openBig('Fssai')">
                                                        <img id="thFssai" src="" alt="thumb" style="width:72px; height:72px; object-fit:cover; border-radius:8px; border:1px solid #c8e6c9; display:block;">
                                                    ...
                                                    <div style="flex:1; min-width:0;">
                                                        <span id="nmFssai" style="display:block; color:#2e7d32; font-weight:600; font-size:13px; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;"></span>
                                                        <span id="szFssai" style="display:block; color:#888; font-size:11px; margin-top:2px;"></span>
                                                    </div>
                                                    <button type="button" onclick="openBig('Fssai')" style="background:#4CAF50; color:white; border:none; border-radius:6px; padding:6px 14px; font-size:12px; cursor:pointer;">View PDF</button>
                                                    <button type="button" onclick="removePrev('Fssai','<%=Fuidentity.ClientID%>')" style="background:#e53935; color:white; border:none; border-radius:50%; width:26px; height:26px; cursor:pointer; font-size:15px;">&#x2715;</button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div id="divAttach" runat="server" visible="false">
                                                ...
                                                <div style="margin-top:10px;">
                                                    ...
                                                    <a id="aViewFssai" runat="server" target="_blank" style="margin-left:8px; font-size:12px; vertical-align:top;">View PDF</a>
                                                    <%-- legacy (hidden) --%>
    ...
    <script type="text/javascript">
        ...
        function SaveButton() {
            var fssai = document.getElementById('<%=txtpan.ClientID%>').value.trim();
            if (fssai === "") { alert("Please enter FSSAI Number"); document.getElementById('<%=txtpan.ClientID%>').focus(); return false; }
            if (fssai.length !== 14) { alert("FSSAI Number must be exactly 14 characters."); document.getElementById('<%=txtpan.ClientID%>').focus(); return false; }
