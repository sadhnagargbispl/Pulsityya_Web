<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="RewardUCM.aspx.vb" Inherits="RewardUCM" Title="" EnableEventValidation="true" %>
                    ...
                    <div style="padding: 10px 10px 20px 10px" id="divDetail" runat="server">
                        <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="true" GridLines="Both"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Reward" HeaderText="Reward Name" />
                                <asp:BoundField DataField="Date" HeaderText="Achieve Date" />
                                <%--<asp:BoundField DataField="AchievedReward" HeaderText="Reward Type" />--%>
                                <%-- <asp:BoundField DataField="RedeemStatus" HeaderText="Redeem Status" />
                            <asp:BoundField DataField="ReedemDate" HeaderText="ReedemDate" />--%>
                            </Columns>
                        </asp:GridView>
                    </div>
                </div>
