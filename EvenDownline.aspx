<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="EvenDownline.aspx.vb" Inherits="EvenDownline" %>
                                                ...
                                                <td>
                                                    <table class="Table-lblNew" cellspacing="2" cellpadding="2" width="700">
                                                        <tbody>
                                                            ...
                                                            <tr valign="top">
                                                                <td class="box-body1-clear" align="center" colspan="6" style="width: 40%;">
                                                                </td>
                                                            </tr>
                                                            <tr valign="top">
                                                            ...
                                                            <tr valign="top">
                                                                ...
                                                                <td align="center" style="padding: 10px; border: 1px solid black; border-bottom: 0;
                                                                    border-top: 0">
                                                                    <span id="LblLeftPV" runat="server">0</span>
                                                                </td>
                                                                <td align="center" style="padding: 10px; border: 1px solid black; border-bottom: 0;
                                                                    border-top: 0">
                                                                    <span id="LBLRightPV" runat="server">0</span>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
