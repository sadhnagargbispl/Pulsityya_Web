...
Partial Class VendorReport
    ...
    Public Sub BindData(Optional ByVal Condition As String = "")
        ...
        url = url.ToLower
        Dim sql As String
        sql = "Select * from V#VendorReport where 1 = 1 " & Condition & " order by RedistartionDate desc  "
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        Try
            ...
            sql &= "Commission as Bonus,Cashback,ActiveStatus as [Status],Astatus as [Approve Status],Approvedate as [Approve Date] from "
            sql &= "V#VendorReport where 1 = 1 " & Condition & " order by RedistartionDate desc  "
