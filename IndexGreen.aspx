<%@ Page Title="" Language="C#" MasterPageFile="~/SitePage.master" AutoEventWireup="true" CodeFile="IndexGreen.aspx.cs" Inherits="IndexGreen" %>
                            ...
                            <table id="table" class="table table-hover table-mc-light-blue table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td id="Td1" runat="server" style="text-align: right">0</td>
                                    ...
                                    <tr class="backclr">
                                        ...
                                        <td id="Td2" runat="server" style="text-align: right">0</td>
                                    ...
                                    <tr class="backclr">
                                        ...
                                        <td id="Td3" runat="server" style="text-align: right">0</td>
                                    ...
                                    <tr>
                                        ...
                                        <td id="Td4" runat="server" style="text-align: right">0</td>
                                    ...
                                    <tr class="backclr" id="trdirectactive" runat="server">
                                        ...
                                        <td id="Td5" runat="server" style="text-align: right">0</td>
