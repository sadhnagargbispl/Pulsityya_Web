<%@ Page Title="" Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false" CodeFile="amontRecivedbyincome.aspx.vb" Inherits="amontRecivedbyincome" %>
...
<script type="text/javascript" language="javascript">
        ...
        <div class="row">
            ...
            <div class="x_title">
                        <h2>
                      Amount Received By Parcial Payment Remaining By Income
                        </h2>
                        <div class="clearfix">
                        </div>
