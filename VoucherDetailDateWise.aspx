<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="VoucherDetailDateWise.aspx.vb" Inherits="App_UI_Application_Pages_FundWithdrawDateWise" %>
                                ...
                                <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="True" PageSize="200"
                                    ...
                                    <asp:Label ID="LblTodate" runat="server" Text='<%# Eval("ToDate") %>' Visible="false"></asp:Label>--%>
                                      ...
                                      <asp:TemplateField HeaderText="Amount">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="LblTdsAmoun" runat="server" Text='<%# Eval("TdsAmount") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        
                                         <asp:TemplateField HeaderText="withdrawlAmount">
                                            <ItemTemplate>
                                       ...
                                       <%-- <asp:TemplateField HeaderText="withdrawl Amount">
                                            <ItemTemplate>
                                                <asp:Label ID="LblwithdrawlAmount" runat="server" Text='<%# Eval("withdrawl Amount") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
                                ...
                                <asp:GridView ID="GridView1" Width="100%" runat="server" AllowPaging="True" PageSize="200"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Request Amount">
                                            <ItemTemplate>
                                                <asp:Label ID="LblRequestAmount" runat="server" Text='<%# Eval("Amount") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Net Withdrawal">
                                            <ItemTemplate>
                                                <asp:Label ID="Lblnetamount" runat="server" Text='<%# Eval("Netamount") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
