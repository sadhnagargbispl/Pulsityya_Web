<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="IncentiveDetailReportTB.aspx.vb" Inherits="App_UI_Application_Pages_IncentiveDetailReportTB"
                        ...
                        <div style="padding: 10px 10px 20px 10px; overflow: scroll" id="divDetail" runat="server"
                            ...
                            <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="false" GridLines="Both"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Direct Income" SortExpression="SpillIncome">
                                        <ItemTemplate>
                                            <asp:Label ID="LblDirectBonus" runat="server" Text='<%# Eval("SpillIncome") %>'></asp:Label><br />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Binary Income" SortExpression="BinaryIncome">
                                        <ItemTemplate>
                                            <asp:Label ID="LblDirectMatching" runat="server" Text='<%# Eval("BinaryIncome") %>'></asp:Label><br />
                                        </ItemTemplate>
                                    </asp:TemplateField>
