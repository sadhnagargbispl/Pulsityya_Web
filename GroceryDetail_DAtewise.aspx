<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="GroceryDetail_DAtewise.aspx.vb" Inherits="GroceryDetail_DAtewise" Title=""
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3" style="padding-top: 9Px" id="Div1" runat="server">
                            Search Type
                            <asp:DropDownList ID="ddlsearchtype" CssClass="form-control" runat="server" AutoPostBack="true">
                                ...
                                <asp:ListItem Value="T" Text="Team"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    ...
                    <div style="padding: 10px 10px 20px 10px" id="divDetail" runat="server">
                        <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="true" GridLines="Both"
                            ...
                            EmptyDataText="No data to display." AutoGenerateColumns="true" PageSize="50"
