...
Partial Class App_UI_Application_Pages_DailyIncentiveDetailReportBS
    ...
    Public Sub BindData(ByVal PageIndex As Integer)
        ...
        Try
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetDailyPayoutDetailBS", prms)
