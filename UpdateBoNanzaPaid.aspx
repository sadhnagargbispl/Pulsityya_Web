<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UpdateBoNanzaPaid.aspx.vb"
    Inherits="UpdateBoNanzaPaid" %>
                        ...
                        <div class="x_panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12" style="padding-top: 5%">
                                    ...
                                    <div class="col-md-6">
                                        <asp:Button ID="BtnSave" class="btn btn-primary" runat="server" Text="Modify" ValidationGroup="Save"
