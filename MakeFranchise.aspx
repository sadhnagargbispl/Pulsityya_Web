<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="MakeFranchise.aspx.vb" Inherits="MakeFranchise" %>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <asp:Label ID="lblMemberName" runat="server" Text="" ForeColor="Red"></asp:Label>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" Display="Dynamic" ControlToValidate="ddlstate"
                                                                runat="server" ValidationGroup="Save" InitialValue="0">Please  Select State.!!</asp:RequiredFieldValidator>
                                                        </div>
                                                    </div>
                                                </div>
                                                <br />
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:Button ID="btncencal" runat="server" Text="Cencal" class="btn btn-danger" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </ContentTemplate>
