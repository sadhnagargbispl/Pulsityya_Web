<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="ApproveSeminarReqs.aspx.vb" Inherits="ApproveSeminarReqs" %>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <asp:RadioButtonList ID="RbReqStatus" runat="server" class="form-control" RepeatDirection="Horizontal"
                                                RepeatLayout="Table">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlSeminar" runat="server" class="form-control">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div align="center" class="col-md-12">
                                    ...
                                    <div style="margin-top: 15px; overflow: scroll;">
                                        <div align="left" class="col-md-12">
                                            ...
                                            <b>Total Person :-
                                                <asp:Label ID="lblTotalPerson" runat="server" Text="0.00"></asp:Label></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <b>Total Verify Person :-
                                                <asp:Label ID="lblTotalApPerson" runat="server" Text="0.00"></asp:Label></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <b>Total Pending Person :-
                                                <asp:Label ID="lblTotalPePerson" runat="server" Text="0.00"></asp:Label></b>
                                        </div>
                                        <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="program" HeaderText="Seminar" />
                                                <asp:BoundField DataField="groupname" HeaderText="Group Name" />
                                                <asp:TemplateField HeaderText="No. Of Person">
                                                    <ItemTemplate>
                                                        <a href='<%# "SemimarMemberDetail.aspx?reqno="& Eval("ReqNo")  %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 620,height: 450,marginTop : 0 } )">
                                                            <b>
                                                                <asp:Label ID="Label1" runat="server" ForeColor="Blue" Text='<%# Eval("Person") %>'
                                                                    CssClass="btn btn-outline-success"></asp:Label></b> </a>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <a href='<%# "Img.aspx?&type=seminar&ID=" & Eval("Reqno") %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 785,height: 580,marginTop : 0 } )">
