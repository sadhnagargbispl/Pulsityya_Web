...
Partial Class DiscountMartLeftRight
    ...
    Public Sub BindData(ByVal PageIndex As Integer)
        Try
            ...
            'Else
            If txtAmountLeft.Text <> "" Then
                Amount = txtAmountLeft.Text.Trim
            Else
                Amount = "0"
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "Sp_DiscountMartLeftRight", prms)
    ...
    Private Sub ExportExcel()
        ...
        Using wb As New XLWorkbook()
            wb.Worksheets.Add(dt, "RepurchaseLeftRightBV")
            Response.Clear()
            Response.Buffer = True
            Response.Charset = ""
            Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
            Response.AddHeader("content-disposition", "attachment;filename=RepurchaseLeftRightBV.xlsx")
