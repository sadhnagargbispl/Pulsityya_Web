<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="PaymentSummary.aspx.vb" Inherits="App_UI_Application_Pages_PaymentSummary"
    Title="" %>
                            ...
                            <div align="center">
                                <div class="col-md-12" style="min-height: 500px;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <asp:TextBox ID="txtMaxAmt" runat="server" class="form-control" Text="0" Style="display: inline"
                                                MaxLength="10"></asp:TextBox>
                                            <ajax:FilteredTextBoxExtender ID="fttxtMaxAmt" runat="server" TargetControlID="txtMaxAmt"
