<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="MyDirectsRef.aspx.vb" Inherits="App_UI_Application_Pages_MyDirectsRef"
                            ...
                            <table class="table-responsive">
                                <div class="col-md-3">
                                   ...
                                   MemberId :
                                    <asp:TextBox ID="txtMember" runat="server" AutoPostBack="true" class="form-control"></asp:TextBox>
                                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" ControlToValidate="txtMember" runat="server" ValidationGroup="Save" >*</asp:RequiredFieldValidator>
                                ...
                                <div class="col-md-3" style="display:none;">
                                    ...
                                    <asp:DropDownList ID="rbtnsearch" AutoPostBack="true" runat="server" class="form-control">
                                        <asp:ListItem Text="Level Wise" Selected="True" Value="0"></asp:ListItem>
                                ...
                                <%--<div class="col-md-3">
                                    ...
                                    <asp:Button ID="BtnSubmit" runat="server" Text="Search" TabIndex="3" ValidationGroup="Save" class="btn btn-primary"
                                         />
                                </div>
                            ...
                            <div id="DivSideA" runat="server">
                                ...
                                <div class="table-responsive">
                                    <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                        <ContentTemplate> <asp:Label ID="Label1" runat="server" Text="Total Records"></asp:Label>
                                <asp:Label ID="lbltotal" runat="server"></asp:Label>
                                            <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                                GridLines="Both" AllowPaging="true" class="table table-bordered" HeaderStyle-CssClass="bg-primary"
                                                ShowHeader="true" AllowSorting="true" PageSize="40"
                                                        EmptyDataText="No data to display." ForeColor="Black"> 
