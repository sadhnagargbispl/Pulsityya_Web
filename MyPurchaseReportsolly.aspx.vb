...
Partial Class MyPurchaseReportsolly
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End Try
    End Sub
    Public Sub FillReport(ByVal PageIndex As Integer)
        ...
        End If
        Dim sql As String = ""
        sql = "exec sp_GetPurchaseReport '" & TransactionID & "','" & startDate & "','" & endDate & "','" & PageIndex & "','" & ddlPageSize.SelectedValue & "'"
        ...
        Dim recordCount As Integer = dtData.Rows.Count
        If dtData.Rows.Count > 0 Then
            'lblCount.Text = dtData.Rows.Count
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Else
            endDate = txtEndDate.Text
        End If
        Dim sql As String = "exec sp_GetPurchaseReport '" & TransactionID & "','" & startDate & "','" & endDate & "','1','" & ddlPageSize.SelectedValue & "'"
        dtData = New DataTable
        dtData = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), CommandType.Text, sql).tables(0)
