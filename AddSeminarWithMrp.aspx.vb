...
Partial Class App_UI_Application_Pages_AddSeminarWithMrp
    ...
    Private Sub FillDetail()
        ...
        If Dt.Rows.Count > 0 Then
            ...
            txtPerson.Text = Dt.Rows(0)("Person")
    ...
    "ContactPerson=@ContactPerson,Remarks=@Remarks,Program=@Program,ActiveStatus='" & RbStatus.SelectedValue & "', " & _
    "MRP='" & txtMrp.Text & "',PerSon='" & txtPerson.Text & "'" & _
    "WHERE MeetingID='" & Val(TxtMeetingID.Text) & "'"
            Else
                strQuery = "INSERT INTO M_MeetingMaster (MeetingID,Speaker,MeetingTime,CityCode,CityName,DistrictCode,DistrictName,StateCode,Address,ContactNo,ContactPerson,Remarks,ActiveStatus,UserType,UserID,Program,MRP,Person)" & _
          ...
          "'" & CityCode & "',@CityName,'" & DistCode & "',@DistName,'" & Val(CmbState.SelectedValue) & "',@Address,@ContactNo,@ContactPerson,@Remarks,'" & RbStatus.SelectedValue & "','A','" & Val(Session("UserID")) & "',@Program,'" & txtMrp.Text & "','" & txtPerson.Text & "' FROM M_MeetingMaster;"
            End If
