...
Partial Class App_UI_Application_Pages_PromotionalBonus
    ...
    Protected Sub BtnShow_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnShow.Click
        ...
        sql = "Exec Sp_promobonus '" & txtMemberId.Text & "' ,'" & ddlAction.SelectedValue & "'   "
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Try
            Dim strQuery As String = "Exec Sp_promobonus '" & txtMemberId.Text & "' ,'" & ddlAction.SelectedValue & "'"
            ...
            ExportToExcel("promobonus.xls", dg)
