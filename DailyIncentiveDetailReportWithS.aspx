<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="DailyIncentiveDetailReportWithS.aspx.vb" Inherits="App_UI_Application_Pages_DailyIncentiveDetailReportWithS"
    Title="" %>
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <div style="padding: 10px 10px 20px 10px">
                                                <asp:GridView ID="GrdTotal" Width="100%" runat="server" AllowPaging="false" PageSize="200"
                                                    ...
                                                    <Columns>
                                                        <%--    <asp:TemplateField HeaderText="Statement" ItemStyle-CssClass="text-center">
                                                            <ItemTemplate>
                                                                <asp:HyperLink ID="StatementLink" runat="server" Target="_blank" Text="Statement"
                                                                    ForeColor="Blue"></asp:HyperLink>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>--%>
                                                        <asp:TemplateField HeaderText="Statement" ItemStyle-CssClass="text-center">
                                                            <ItemTemplate>
                                                                <a href='StatementDaily.aspx?PayoutNo=<%#Eval("Sessid")%>&Formno=<%#Eval("formno") %>'
                                                                    target="_blank" style="color: Blue;">Statement</a>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
                                                <asp:GridView ID="GridView1" Width="100%" runat="server" AllowPaging="false" PageSize="200"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Statement" ItemStyle-CssClass="text-center">
                                                            <ItemTemplate>
                                                                <a href='StatementDailyPB.aspx?PayoutNo=<%#Eval("Sessid")%>&Formno=<%#Eval("formno") %>'
                                                                    target="_blank" style="color: Blue;">Statement</a>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="sno" HeaderText="SNo" />
                                                        <asp:TemplateField HeaderText="Session" ItemStyle-CssClass="text-center" Visible="false">
                                                            <ItemTemplate>
                                                                <%#Eval("Session")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:BoundField DataField="Team Performance Incentive" HeaderText="Team Performance Incentive" />
                                                        <asp:BoundField DataField="Direct Referral Incentive" HeaderText="Direct Referral Incentive" />
                                                        <%--<asp:BoundField DataField="Daily Performance Incentive" HeaderText="Daily Performance Incentive" />--%>
                                                        <asp:BoundField DataField="Leadership Rank Incentive" HeaderText="Leadership Rank Incentive" />
                                                        <asp:BoundField DataField="Solar Connection Incentive" HeaderText="Solar Connection Incentive" />
                                                        <asp:BoundField DataField="Gross Income" HeaderText="Gross Income" />
                                                        <asp:BoundField DataField="Repurchase Deduction" HeaderText="Repurchase Deduction" />
                                                        <asp:BoundField DataField="TDS Amount" HeaderText="TDS Amount" />
                                                        <asp:BoundField DataField="Admin Charge" HeaderText="Admin Charge" />
                                                        <asp:BoundField DataField="Total Deduction" HeaderText="Total Deduction" />
                                                        <asp:BoundField DataField="Net Income" HeaderText="Net Income" />
                                                        <asp:BoundField DataField="Closing Bal" HeaderText="Closing Bal" />
                                                    </Columns>
                                                </asp:GridView>
