...
Partial Class App_UI_Application_Pages_KitProductMasterDP
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not Page.IsPostBack Then
                ...
                Dim qry1 As String = "select * from M_kitMaster where ActiveStatus='Y' and RowStatus='Y' And AllowTopUp='Y' "
                objModuleFun.FillCombo(qry1, ddlGroup, "KitName", "KitId")

                'Fill grid with data
                BindData()
                Session("KitId") = ddlGroup.SelectedValue.ToString()
                Session("KitName") = ddlGroup.SelectedItem.Text
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If GvData.Rows.Count > 0 Then
            For Each Gvr As GridViewRow In GvData.Rows
                ...
                DP = DirectCast(Gvr.FindControl("LblRate"), Label).Text
                MRP = DirectCast(Gvr.FindControl("lblMrp"), Label).Text
                ...
                If Chk.Checked = True Then
                    ...
                    ElseIf MRP = "" Then
                        ...
                        '    Exit Sub
                    Else
                        qry1 = qry1 & " insert into M_KitProductDetail (KPId,KitId,ProdId,ActiveStatus,RectimeStatus,RowStatus,LastModified,UserId,Qty,BarCode,MRP,DiscAmt,Tax,DP)" & _
                        "Select Case When Max(KPId) Is Null Then '1' Else Max(KPId)+1 END as KPId ,'" & Val(ddlGroup.SelectedValue.ToString()) & "','" & Val(LblProd.Text) & "','Y',GetDate(),'Y','','" & Session("UserId") & "','" & Qty & "','" & Barcode & "','" & MRP & "','" & Discount & "','0','" & DP & "' from M_KitProductDetail;"
    ...
    Private Sub SetCheckBoxValue()
        ...
        ' Dim i As String
        Dim qry2 As String = "Select 'false' as status, b.ProdId as ProdId,b.Qty,b.Barcode,b.DP as DP,(b.DP*b.Qty) as TotalAmt,"
                ...
                For Each Gvr As GridViewRow In GvData.Rows
                    ...
                    If j < i Then
                        ...
                        If Lbl.Text = dtPermission.Rows(j)("ProdId").ToString Then
                            ...
                            DirectCast(Gvr.FindControl("LblRate"), Label).Text = dtPermission(j)("DP").ToString
