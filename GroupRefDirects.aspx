<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="GroupRefDirects.aspx.vb" Inherits="GroupRefDirects"
                ...
                <div class="x_panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                                ...
                                <div id="divooloPinLevel" runat="server" class="col-md-3">
                                                            Pin Level
                                                            <asp:DropDownList ID="ddlpinLevel" CssClass="form-control" TabIndex="2" runat="server">                                                                
                                                            </asp:DropDownList>
                                                        </div>
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                                ...
                                                --%>    <asp:BoundField DataField="PackageName" HeaderText="Package Name" />
                                                    ...
                                                    <asp:BoundField DataField ="PinLevel" HeaderText="Pin Level" />
                                                </Columns>
                                            </asp:GridView>
                                            </div>
                                        </ContentTemplate>
