...
Partial Class App_UI_Application_Pages_MembershipMaster
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Session("AStatus") = "OK" Then
            ...
            Session("PageName") = "Master / Membership Master"
        Else
    ...
    Public Sub BindData()
        ...
        sql = "Select * From MembershipPlans Order by Id"
        ...
        Session("GmembershipData") = dtData
    ...
    Protected Sub GvData_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles GvData.PageIndexChanging
        ...
        GvData.DataSource = Session("GmembershipData")
        GvData.DataBind()
    End Sub
    ...
    Protected Sub btnExport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExport.Click
        ...
        Response.AddHeader("content-disposition", String.Format("attachment; filename={0}", "MembershipData.xls"))
        ...
        dtData = New DataTable
        dtData = Session("GmembershipData")
        GvData.DataSource = dtData
        GvData.DataBind()
        'BindGridview()
