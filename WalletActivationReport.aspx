<%@ Page Title="" Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="WalletActivationReport.aspx.vb" Inherits="WalletActivationReport" EnableEventValidation="false" %>
                        ...
                        <div>
                            <div align="center">
                                ...
                                <div class="col-md-2">Search By</div>
                                    ...
                                    <div class="col-md-3">
                                        <asp:TextBox class="form-control" ID="txtMemberId" runat="server" placeholder="Memberid"></asp:TextBox>
