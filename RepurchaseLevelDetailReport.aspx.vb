...
Partial Class App_UI_Application_Pages_RepurchaseLevelDetailReport
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        Try
            If Session("AStatus") = "OK" Then
                Session("PageName") = "Report / Repurchase Level Incentive Report"
            Else
    ...
    Public Sub BindFromDate()
        ...
        Try
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetRepurchaseSessionDetail ")
    ...
    Public Sub BindData(ByVal PageIndex As Integer)
        ...
        Try
            ...
            'Ds = SqlHelper.ExecuteDataset(constr, "sp_GetDailyPayoutDetail", prms)
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetRepurchaselevelPayoutDetail", prms)
    ...
    Private Sub ExportExcel()
        Dim dt As DataTable = Session("LevelData")
        Using wb As New XLWorkbook()
            wb.Worksheets.Add(dt, "Repurchaselevelpayout")
            Response.Clear()
            Response.Buffer = True
            Response.Charset = ""
            Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
            Response.AddHeader("content-disposition", "attachment;filename=Repurchaselevelpayout.xlsx")
