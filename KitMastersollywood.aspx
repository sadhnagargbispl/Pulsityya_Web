<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false"
    CodeFile="KitMastersollywood.aspx.vb" Inherits="App_UI_Application_Pages_KitMastersollywood" Title=""
                        ...
                        <div class="table-responsive makeitresponsivegrid">
                            <div align="center">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <a href="AddKitsollywood.aspx" onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 600,height: 450,marginTop : 0 } )">
                            ...
                            PagerStyle-CssClass="PagerStyle">
                                   <%-- <asp:GridView ID="GvData" runat="server" AutoGenerateColumns="False" RowStyle-Height="25px"
                                        ...
                                        <asp:TemplateField HeaderText="S.No.">
                                            ...
                                            <asp:BoundField DataField="PurchaseName" HeaderText="Voucher Category" />
                                            <asp:TemplateField HeaderText="Modify" HeaderStyle-Width="55px" ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <a href='<%# "AddKitsollywood.aspx?KitId=" & Eval("VKitId")  %>' onclick="return hs.htmlExpand(this, { objectType: 'iframe',width: 470,height: 450,marginTop : 0 } )">
