<%@ Page Language="VB" MasterPageFile="MasteMain.master" AutoEventWireup="false"
    CodeFile="AdminHomeGH.aspx.vb" Inherits="App_UI_Application_Pages_AdminHomeGH" %>
                            ...
                            <div style="overflow: scroll" class="table table-bordered">
                                <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="True" PageSize="20"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Join Type" SortExpression="JoinType" HeaderStyle-ForeColor="White">
                                            <ItemTemplate>
                                                <asp:Label ID="lblJoinType" runat="server" Text='<%# Eval("JoinType") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <%--<asp:TemplateField HeaderText="Placement ID">
                                            <ItemTemplate>
                                                <asp:Label ID="UplinerId" runat="server" Text='<%# Eval("UplinerIdNo") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
                                        <%--<asp:TemplateField HeaderText="Placement Name">
                                            <ItemTemplate>
                                                <asp:Label ID="UplinerName" runat="server" Text='<%# Eval("UplinerName") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
                                ...
                                <asp:Image runat="server" ID="BtnMenus" ImageUrl="../Resources/images/moreopt.jpg" AlternateText=""  />
                                        ...
                                        <asp:TemplateField HeaderText="Package" SortExpression="KitName" HeaderStyle-ForeColor="White">
                                            <ItemTemplate>
                                                <asp:Label ID="Package" runat="server" Text='<%# Eval("KitName") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Package Amount" SortExpression="KitAmount" HeaderStyle-ForeColor="White">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Activ.Date" SortExpression="UpgrdDate" HeaderStyle-ForeColor="White">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Transaction No" SortExpression="TxnNo" HeaderStyle-ForeColor="White">
                                            <ItemTemplate>
                                                <asp:Label ID="TxnNo" runat="server" Text='<%# Eval("TxnNo") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Currency Type" SortExpression="CurType" HeaderStyle-ForeColor="White">
                                            <ItemTemplate>
                                                <asp:Label ID="Curtype" runat="server" Text='<%# Eval("CurType") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        
                                        <asp:TemplateField HeaderText="Currency Amount" SortExpression="CAMount" HeaderStyle-ForeColor="White">
                                            <ItemTemplate>
                                                <asp:Label ID="CAmount" runat="server" Text='<%# Eval("CAmount") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
