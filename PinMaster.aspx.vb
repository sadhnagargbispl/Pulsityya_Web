...
Partial Class App_UI_Application_Pages_PinMaster
    ...
    Public Sub BindData()
        Try
            ...
            Dim sql As String = "Select StateCode,Cast(StateCode as varchar) as VStateCode,statename,remarks,CASE WHEN ActiveStatus='Y' Then 'Active' ELSE 'DeActive' END AS Status," & _
            " Case when ActiveStatus='N' then 'label label-danger' else 'label label-success' end as StatusClass From " + objDAL.tblStateMaster + " Where " + objDAL.activeCondition + " Order by StateName"
