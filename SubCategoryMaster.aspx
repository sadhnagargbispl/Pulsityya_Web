<%@ Page Language="VB" MasterPageFile="~/MasteMain.master" AutoEventWireup="false"
    CodeFile="SubCategoryMaster.aspx.vb" Inherits="SubCategoryMaster" Title="" %>
                            ...
                            <div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <asp:Button ID="btnExport" runat="server" class="btn btn-primary" Text="Export To Excel"
                                        Visible="false" />
                                    <asp:Button ID="BtnAddNew" runat="server" class="btn btn-primary" Text="Create Sub Category" />
                                    ...
                                    <asp:GridView ID="GvData" Width="100%" runat="server" AllowPaging="true" GridLines="Both"
                                        ...
                                        <Columns>
                                            <asp:TemplateField HeaderText="KitId" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="LblGrpID" runat="server" Text='<%# Eval("SubCatID") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:BoundField DataField="cattname" HeaderText="CATEGORY NAME" />
                                            <asp:BoundField DataField="CatName" HeaderText="SUB CATEGORY NAME" />
                                            ...
                                            <asp:TemplateField HeaderText="MODIFY" HeaderStyle-Width="55px" ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <a href='<%# "AddSubCat.aspx?catid=" & Eval("VKitId")  %>'><i class="fa fa-edit"
