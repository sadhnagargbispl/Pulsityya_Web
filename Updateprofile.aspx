                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-2">
                                                        State:</div>
                                                    <div class="col-md-4">
                                                        <asp:DropDownList ID="ddlStateName" runat="server" CssClass="form-control " TabIndex="16"
                                                            autocomplete="off">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-1">
                                                        <asp:TextBox ID="txtstdcode" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox></div>
                                                    <div class="col-md-3">
