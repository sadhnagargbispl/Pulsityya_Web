<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddDistrict.aspx.vb" Inherits="AddDistrict" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12" style="padding-top: 1%">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <asp:TextBox ID="txtDistrictName" class="form-control" runat="server" AutoPostBack ="true" ></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" ControlToValidate="txtDistrictName"
