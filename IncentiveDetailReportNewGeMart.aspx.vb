...
Partial Class IncentiveDetailReportNewGeMart
    ...
    Public Sub BindData(ByVal PageIndex As Integer)
        ...
        Try
            ...
            Ds = SqlHelper.ExecuteDataset(HttpContext.Current.Session("MlmDatabase" & Session("CompID")), "sp_GetDailyPayoutDetail", prms)
            If Session("CompID") = 1091 Then
                Grdsolfit.DataSource = Ds.Tables(0)
                Grdsolfit.DataBind()
                GrdTotal.Visible = False
            Else
            ...
            If Session("CompID") = 1091 Then
                If Ds.Tables(0).Rows.Count > 0 Then
                    For i As Integer = 0 To Grdsolfit.Columns.Count - 1
                        Dim tableCell As TableCell = Grdsolfit.HeaderRow.Cells(i)
    ...
    Protected Sub GrdTotal_Sorting(ByVal sender As Object, ByVal e As GridViewSortEventArgs)
        ...
        End Try
    End Sub
    Protected Sub Grdsolfit_Sorting(ByVal sender As Object, ByVal e As GridViewSortEventArgs)
        Try
    ...
    Protected Sub GrdTotal_PageIndexChanging(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewPageEventArgs) Handles GrdTotal.PageIndexChanging
        If Session("CompId") = 1091 Then
            Grdsolfit.PageIndex = e.NewPageIndex
            Grdsolfit.DataSource = Session("GData")
            Grdsolfit.DataBind()
        Else
